...
ForgePlugins.VideoControls.prototype =
{
    ...
    boot: function()
    {
        ...
        if(this.plugin.options.poster !== null)
        {
            ...
            this._poster.maximize(true);
            this.plugin.container.addChild(this._poster);
        }
        ...
        this._totalTime.fontFamily = "pfdintextprobold";
        ...
        this._currentTime.fontFamily = "pfdintextprolight";
