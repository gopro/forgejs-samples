...
ForgePlugins.GoogleMaps.prototype = {
    ...
    _gpxLoadComplete: function(file)
    {
        ...
        var markerImage = this.plugin.options.markerIcon;

        // Load the image of the marker if necessary
        if (typeof markerImage === "object" && markerImage !== null)
        {
            markerImage = {
                url: this.plugin.options.markerIcon.url,
                // This marker size
                size: new google.maps.Size(this.plugin.options.markerIcon.width, this.plugin.options.markerIcon.height),
                // The origin for this image is (0, 0)
                origin: new google.maps.Point(0, 0),
                // The anchor for this image
                anchor: new google.maps.Point(this.plugin.options.markerIcon.anchorX, this.plugin.options.markerIcon.anchorY)
            };
        }
        ...
        this._marker = new google.maps.Marker(
        {
            ...
            title: this.plugin.options.markerIcon.title || "Current position",
            icon: markerImage
        });
