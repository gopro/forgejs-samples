...
e.update=function(a){!0!==this.$&&(this.G.update(a),this.oa.update(),this.va.update(),this.F.update(),this.B.update(),this.ba.update(),this.H.update(),this.R.update(),null!==this.f&&"function"===typeof this.f.update&&this.f.update.call(),null!==this.f&&"function"===typeof this.f.rn&&this.f.rn.call(),null!==this.C&&this.C.render(),null!==this.f&&"function"===typeof this.f.qn&&this.f.qn.call())};e.pause=function(){this.$=!0;null!==this.m&&this.m.D()};e.resume=function(){this.$=!1;null!==this.u&&this.u.D()};
...
this.warn(a)}else this.warn("Tags: No uid or no tags on the object you try to register!"),this.warn(a)};a.prototype.eg=function(a,d){var b=[];if("string"===typeof a)b=this.jb[a];else if(Array.isArray(a)){var h=0;for(a=a.length;h<a;h++);}"string"===typeof d&&(b=p.ce(b,d));return b};a.prototype.get=function(a,d){if("string"===typeof a)return p.get(this.jb[a],d);if(Array.isArray(a)){var b=0;for(a=a.length;b<a;b++);return p.get([],d)}};a.prototype.Kn=function(a,d){if(!0===this.Va(a)){a=this.jb[a];for(var b=
...
a.prototype.constructor=a;a.prototype.cg=function(){var a="xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var b=16*Math.random()|0;return("x"==a?b:b&3|8).toString(16)});return!1===p.Va(a)?a:p.cg()};a.prototype.Dk=function(a){function b(a){var d,h;for(h in a)if("uid"===h)if(d=a[h],"string"===typeof d){if(p.Va(d))throw"UID configuration not valid, uid "+d+" already have an object binded to!";if(-1!==g.indexOf(d))throw"UID configuration not valid, uid "+d+" is in double in config file!";
...
e.load=function(a){this.log("$_Story.load();");"string"===typeof a?this.i.load.json("forge.story.config",a,this.pl,this):"object"===typeof a&&Aa(this,a)};e.ql=function(){return!!this.c.length};e.mc=function(){return!!this.o.length};e.rl=function(){var a=this.c.indexOf(this.m);this.md(a+1<this.c.length?this.c[a+1]:this.c[0])};e.sl=function(){var a=this.c.indexOf(this.m);this.md(0<=a-1?this.c[a-1]:this.c[this.c.length-1])};
e.pl=function(a){this.log("$_Story.loadComplete();");a=this.i.cache.get(A.JSON,a.key).data;Aa(this,a)};
...
e.load=function(a){this.log("$_Group.load();");if(null===this.c||!this.c.length)throw"Group.load() : can't load a group that have no children";var b="";"undefined"===typeof a||null===a?b="string"===typeof this.j&&""!==this.j?this.j:this.c[0]:"number"===typeof a&&0<=a&&a<this.c.length?b=this.c[a]:"string"===typeof a?b=a:"object"===typeof a&&!0===this.Ie(a)&&(b=a.uid);if(-1===this.c.indexOf(b))throw'Group.load() : uid "'+b+'" is not in children of the group!';if(!0===p.T(b,"Scene")||!0===p.T(b,"Group"))p.get(b).load();
else throw"Impossible to load group child with uid "+b+", it seems to be neither a scene or a group!";};e.Ie=function(a){return"string"===typeof a?-1!==this.c.indexOf(a):!0===B.T(a,"Scene")||!0===B.T(a,"Group")?this.Ie(a.uid):!1};e.Ec=function(a){return"string"===typeof a&&p.T(a,"Scene")?-1!==this.c.indexOf(a):!0===B.T(a,"Scene")?this.Ec(a.uid):!1};e.gd=function(a){return"string"===typeof a&&p.T(a,"Group")?-1!==this.c.indexOf(a):!0===B.T(a,"Group")?this.gd(a.uid):!1};e.Hn=function(){return!!this.c.length};
e.hg=function(a){for(var b,d=0,g=this.c.length;d<g;d++)if(b=this.c[d],p.T(b,a))return!0;return!1};e.Je=function(){return this.hg("Scene")};e.mc=function(){return this.hg("Group")};e.ed=function(a){if("string"!==typeof a)return this.c;for(var b=[],d=0,g=this.c.length;d<g;d++)p.T(this.c[d],a)&&b.push(this.c[d]);return b};e.ee=function(a){a=this.ed(a);return p.get(a)};
e.Nk=function(){if(!1===this.Je())this.warn("Can't do Group.nextScene() on this group that have no scenes!");else{var a=this.scenesUids,b=a.indexOf(this.i.story.sceneUid),d;-1===b&&(p.T(this.j,"Scene")?d=this.j:d=a[0]);b+1<a.length?d=a[b+1]:-1!==b&&(d=a[0]);this.load(d)}};
e.Ok=function(){if(!1===this.Je())this.warn("Can't do Group.previousScene() on this group that have no scenes!");else{var a=this.scenesUids,b=a.indexOf(this.i.story.sceneUid),d;-1===b&&(p.T(this.j,"Scene")?d=this.j:d=a[0]);0<=b-1?d=a[b-1]:-1!==b&&(d=a[a.length-1]);this.load(d)}};e.destroy=function(){this.c=this.i=null;this.o.destroy();this.o=null;this.u.destroy();this.u=null;this.m.destroy();this.m=null;l.prototype.destroy.call(this)};Object.defineProperty(D.prototype,"config",{get:function(){return this.f}});
...
G.Vn=function(a,b,d){return a*d+b*(1-d)};G.bo=function(a,b,d){a=G.X((a-b)/(d-b),0,1);return a*a*(3-2*a)};G.Bg=function(a){return{yaw:Math.atan2(-a.elements[2],a.elements[10]),pitch:Math.asin(-a.elements[6]),roll:Math.atan2(-a.elements[4],a.elements[5])}};
...
var H={Be:function(a){a=(new THREE.Euler).setFromQuaternion(a,"XYZ");return{yaw:a.x,pitch:-a.y,roll:a.z}},lc:function(a,b,d){"object"===typeof a&&(b=a.pitch,d=a.roll,a=a.yaw);return(new THREE.Quaternion).setFromEuler(new THREE.Euler(a,-b,d,"ZXY"))},xk:function(a){a=H.Be(a);return G.be(a.yaw,a.pitch,a.roll)},An:function(a){return H.lc(G.Bg(a))},cancelRoll:function(a){a=H.Be(a);return H.lc(a.yaw,a.pitch,0)},vn:function(a,b){return(new THREE.Quaternion).copy(a).inverse().multiply(b)},hj:function(a,b){a=
...
Object.defineProperty(Ha.prototype,"size",{get:function(){return new Ia(this.f,this.c)}});function Ia(a,b){this.f=a||0;this.c=b||0}Ia.prototype.constructor=Ia;Object.defineProperty(Ia.prototype,"width",{get:function(){return this.f}});Object.defineProperty(Ia.prototype,"height",{get:function(){return this.c}});Object.defineProperty(Ia.prototype,"ratio",{get:function(){return this.f/this.c}});var Ja={IMAGE:"image",VIDEO:"video"},Ka={Pc:"equi",xd:"cube",ci:"flat",Gl:"hotspot"};
...
function Va(a,b){b=Oa.Sc;var d=null,g=null;null!==a.c&&(null!==a.c.displayObject&&(d=a.c.displayObject),null!==a.c.renderTarget&&(g=a.c.renderTarget));Ua(a);b===Oa.Gd?(a.c=new Xa(a.i,g),g=a.H.getSize(),Ta(a,new Ia(g.width,g.height))):b===Oa.Sc&&(b={order:a.j.media.source.order||"RLUDFB",tile:a.j.media.source.tile},b.Tn=a.j.media.source.format,a.c=new Ya(a.i,g,b));null!==d&&(a.c.displayObject=d);a.N=!0;null!==a.K&&a.K.D()}function Ua(a){null!==a.c&&(a.c.destroy(),a.c=null);a.N=!1}
...
e.worldToScreen=function(a,b){return this.C.worldToScreen(a,b||0)};e.nl=function(a){this.f.presentingVR!==a&&(this.f.Hh(a),a?(this.V=this.C.type,this.oc(Na.ob)):this.oc(this.V),this.j.media.source.format===Ka.Pc&&(this.P=!0===a?Oa.Sc:Oa.Gd,Va(this,this.P)))};
e.oc=function(a){this.log("setView");this.M=!1;null!==this.C&&(this.log("Destroy previous view"),this.C.destroy(),this.C=null);if(a===Na.ob)this.C=new Za(this.i,this.B);else if(a===Na.gc)this.C=new $a(this.i,this.B);else throw"View type not supported "+a;null!==this.c&&this.c.fc();this.M=!0;this.A.Ck(a);a===Na.ob?this.o.ag(!1):this.o.ag(!0,this.A.material,this.A.renderTarget);this.onViewReady.D()};
...
function ab(a,b,d,g){this.i=a;this.j=b;this.m=d;this.o=g;this.f=this.c=null;l.call(this,"RenderScene");this.c=new bb(cb.Sb,this.i.renderer.webGLRenderer);a=new db(this.j,this.m);a.position=eb.Sb;this.c.addPass(a);a=this.i.postProcessing.ve(this.o);b=0;for(d=a.length;b<d;b++)g=a[b],g.renderToScreen=!1,g.position=eb.Sb,this.c.addPass(g);this.f=new bb(cb.rf,this.i.renderer.webGLRenderer);a=new db(this.j,this.m);a.position=eb.Sb;this.f.addPass(a)}ab.prototype=Object.create(l.prototype);
...
function lb(a){var b=a.c.passes,d=[];b.filter(function(a,b){a.position===eb.ud&&d.push(b)});if(0<d.length&&0<d[0]){for(var g=[],h=d.length-1;0<=h;h--){var k=b.splice(d[h],1)[0];g.push(k)}h=0;for(k=g.length;h<k;h++)a.c.insertPass(g[h],0)}var n=[];b.filter(function(a,b){a.position===eb.cf&&n.push(b)});if(0<n.length&&n[n.length-1]<b.length-1){g=[];h=0;for(k=n.length;h<k;h++){var v=b.splice(n[h],1)[0];g.push(v)}h=0;for(k=g.length;h<k;h++)a.c.addPass(g[h])}g=0;for(h=a.f.length;g<h;g++){var k=a.f[g],v=
!1,x,E=a.f.length;for(x=0;x<E;x++)if(x!==g&&k.readBuffer===a.f[x].readBuffer){v=!0;break}v=v&&g>x;x=0;for(E=k.passes.length;x<E;x++)k.passes[x].clear=!0===v?!1:!x}g=!1;for(h=b.length-1;0<=h;h--)k=b[h],!0===g?k.renderToScreen=!1:!0===k.enabled&&(g=k.renderToScreen=!0);ib(a)}e.ag=function(a,b,d){for(var g=0,h=this.f.length;g<h;g++){var k=this.f[g];k.type===cb.rf&&(k.enabled=a,"undefined"!==typeof b&&(k.passes[0].overrideMaterial=b),"undefined"!==typeof d&&(k.renderTarget=d))}};
e.bj=function(a,b){if("undefined"!==typeof b&&null!==b&&0<b.length){b=this.i.postProcessing.ve(b);for(var d=0,g=b.length;d<g;d++)b[d].position=eb.ud;mb(this.c,b,0)}a=new fb(a);a.position=eb.ud;this.c.insertPass(a,0);lb(this)};e.dj=function(a){for(var b=0,d=a.length;b<d;b++)jb(this,a[b].sceneComposer,!1),jb(this,a[b].pickingComposer,!0);lb(this)};e.cj=function(a){a=this.i.postProcessing.ve(a);for(var b=0,d=a.length;b<d;b++)a[b].position=eb.cf;mb(this.c,a);lb(this)};
e.Fn=function(a){if(null!==this.c)for(var b=0,d=this.c.passes.length;b<d;b++){var g=this.c.passes[b];if(g.uid===a)return g}if(null!==this.f)for(b=0,d=this.f.length;b<d;b++)for(var g=this.f[b],h=0,k=g.passes.length;h<k;h++){var n=g.passes[h];if(n.uid===a)return n}return null};
...
e.Ve=function(){if(null!==this.c){this.c.readBuffer.dispose();this.c.writeBuffer.dispose();for(var a=0,b=this.c.passes.length;a<b;a++){var d=this.c.passes[a];d instanceof hb&&d.uniforms.hasOwnProperty("tAdd")&&(d.uniforms.tAdd.value=null)}this.c.passes=[]}this.f=[]};
e.destroy=function(){this.Ve();this.G=null;for(var a=this.f.length-1;0<a;a--){for(var b=this.f[a],d=0,g=b.passes.length;d<g;d++){var h=b.passes[d];"function"===typeof h.destroy&&h.destroy()}b.passes.length=0}this.f=null;d=0;for(g=this.c.passes.length;d<g;d++)h=this.c.passes[d],"function"===typeof h.destroy&&h.destroy();this.c.passes.length=0;this.i=this.c=null};
...
function nb(a){var b=a.i.renderer.webGLRenderer;a.H=b.getPixelRatio();b=b.getSize();a.u=new Ia(b.width,b.height);a.f=a.u;a.j=[0,0,.5,1];a.m=[.5,0,.5,1];"VRFrameData"in window&&(a.A=new VRFrameData);!0===N.Rg?(navigator.getVRDisplays().then(function(b){a.G=0<b.length;for(var d=0,h=b.length;d<h;d++)if("VRDisplay"in window&&b[d]instanceof VRDisplay){a.c=b[d];break}}),ob(a)):a.warn("missing api navigator.getVRDisplays")}
...
var Oa={Tc:"undefined",Gd:"shader",Sc:"mesh"};function Ya(a,b,d){this.C=this.u=this.f=this.L=null;this.I=d.order||"RLUDFB";this.m=new THREE.Vector2(0,0);this.K=d.tile||512;this.F=d.Tn||Ka.xd;this.o=this.G=0;this.B=1;rb.call(this,a,b,"BackgroundMeshRenderer")}Ya.prototype=Object.create(rb.prototype);e=Ya.prototype;e.constructor=Ya;
...
e.Hk=function(){"undefined"!==typeof this.c.material.uniforms&&(this.c.material.uniforms.hasOwnProperty("tTexture")&&(this.c.material.uniforms.tTexture.value=this.f),this.c.material.uniforms.hasOwnProperty("tOpacity")&&(this.c.material.uniforms.tOpacity.value=1))};
function sb(a){function b(a,b,h,Ec,hc){if(-1===a)throw"Unknown face for cube mapping.";var E,Bb=a%b/b;a=1-(1+parseInt(a/b,10))/h;if(hc)for(hc=0,h=Ec;hc<=h;hc++)for(b=0,E=Ec;b<=E;b++)d[g.next().value]=v+k*b+Bb,d[g.next().value]=x+n*hc+a;else for(hc=0,h=Ec;hc<=h;h--)for(b=0,E=Ec;b<=E;E--)d[g.next().value]=v+k*E+Bb,d[g.next().value]=x+n*h+a}var d=new Float32Array((a.o+1)*(a.o+1)*12),g=d.keys(),h=a.I.split(""),k=1/1.01*(1/a.m.x/a.o),n=1/1.01*(1/a.m.y/a.o),v=1/a.m.x*.005,x=1/a.m.y*.005;b(h.indexOf("R"),
...
Object.defineProperty(bb.prototype,"enabled",{get:function(){return this.c},set:function(a){this.c=a}});Object.defineProperty(bb.prototype,"name",{get:function(){return this.f}});var eb={Kd:"",ud:"background",Sb:"render",cf:"global"};function fb(a,b){this.c="";THREE.TexturePass.call(this,a,b)}fb.prototype=Object.create(THREE.TexturePass.prototype);fb.prototype.constructor=fb;Object.defineProperty(fb.prototype,"position",{get:function(){return this.c},set:function(a){this.c=a}});
...
function zb(a,b){this.i=a;this.ja=b||null;this.u=this.B=this.m=this.Ia=null;this.I=this.F=0;this.R=!1;this.f=null;this.N=0;this.U=!1;this.A=this.G=this.H=this.C=this.ba=this.S=null;l.call(this,"Animation");this.Fe()}zb.prototype=Object.create(l.prototype);e=zb.prototype;e.constructor=zb;e.Fe=function(){this.f=new Ab(this.i,this);this.f.onStart.add(this.Zm,this);this.f.onStop.add(this.$m,this);this.f.onProgress.add(this.Gk,this);this.f.onComplete.add(this.Ym,this);this.i.tween.add(this.f);this.m=new xb};
...
a.u.time-a.B.time;a.f.Ye({tweenTime:1},a.I);a.N=0;a.f.start();return!0}e.Zm=function(){!0!==this.R&&(null!==this.C&&this.C.D(),this.R=!0)};e.$m=function(){this.R=!1;null!==this.H&&this.H.D()};
e.Gk=function(){var a=this.N;if(null!==this.u){this.F=a*this.I+this.B.time;var b=[],d,g,h;Array.isArray(this.Ia.prop)||(this.Ia.prop=[this.Ia.prop]);h=this.Ia.prop.length;for(g=0;g<h;g++)b.push(Cb(this.Ia.prop[g],this.ja));if(!0===this.Ia.smooth&&"quaternion"===this.Ia.prop[0])d=b[0],d[0].quaternion=H.vk(this.B.data.quaternion,this.S,this.ba,this.u.data.quaternion,a);else if("quaternion"===this.Ia.prop[0])d=b[0],d[0].quaternion=H.slerp(this.B.data.quaternion,this.u.data.quaternion,a);else{var k=this.f.easing(a),
n,v,x=0;for(g=0;g<h;g++){n=Cb(this.Ia.prop[g],this.B.data);v=Cb(this.Ia.prop[g],this.u.data);d=b[g];n=n[0][n[1]];v=v[0][v[1]];if(this.Ia.Wa&&this.Ia.Wa[g]){var E=this.Ia.Wa[g][0],Bb=this.Ia.Wa[g][1],x=Math.abs(E-Bb)/2;Math.abs(n-v)>x?(n=G.Wa(n+x,E,Bb),v=G.Wa(v+x,E,Bb)):x=0}d[0][d[1]]=(1-k)*n+k*v-x}}"function"===typeof this.Ia.Cj&&this.Ia.Cj.call(this,a)}null!==this.G&&this.G.D({progress:this.F/this.I})};e.Ym=function(){Db(this)||null!==this.A&&this.A.D()};
...
function Ib(a,b){this.i=a;this.c=null;this.W="";this.P=this.K=!0;this.o=null;this.R=this.M=!1;this.H=this.C=this.G=this.B=null;l.call(this,b||"Object3D");this.Qe()}Ib.prototype=Object.create(l.prototype);e=Ib.prototype;e.constructor=Ib;e.Qe=function(){this.o={};this.c=new THREE.Mesh;this.i.renderer.objects.register(this)};e.click=function(){this.log("click "+this.c.id);!0===B.T(this.o.onClick,"ActionEventDispatcher")&&this.o.onClick.D();null!==this.B&&this.B.D()};
e.Re=function(){this.log("over "+this.c.id);!0===B.T(this.o.onOver,"ActionEventDispatcher")&&this.o.onOver.D();null!==this.G&&this.G.D()};e.rd=function(){this.log("out "+this.c.id);!0===B.T(this.o.onOut,"ActionEventDispatcher")&&this.o.onOut.D();null!==this.C&&this.C.D()};
...
e.Fj=function(a){for(var b=0,d=this.Z.length;b<d;b++)if(this.Z[b].mesh===a)return this.Z[b];return null};e.Se=function(){for(var a=this.c.length;a--;)this.c.pop().destroy()};e.destroy=function(){this.Se();this.i=this.c=null;l.prototype.destroy.call(this)};Object.defineProperty(Ra.prototype,"all",{get:function(){return this.Z}});Object.defineProperty(Ra.prototype,"renderScenes",{get:function(){return this.c}});function Mb(a){this.i=a;this.c=this.f=null;l.call(this,"Raycaster")}Mb.prototype=Object.create(l.prototype);
...
e.Qk=function(){var a=this.i.story.scene;a.onUnloadStart.ca(this.fn,this);"undefined"!==typeof a.config.hotspots&&this.ha(a.config.hotspots)};e.fn=function(){this.Le()};e.boot=function(){this.i.story.onSceneLoadStart.add(this.Qk,this)};e.Cn=function(a){return this.c.filter(function(b){return b.type===a})};e.ha=function(a){for(var b=0,d=a.length;b<d;b++){var g=a[b],h=null;switch(g.type||Tb.Df){case Tb.Df:h=new Ub(this.i,g)}null!==h&&this.c.push(h)}};
e.ej=function(a){if(null!==a.tracks&&"undefined"!==typeof a.tracks){a=a.tracks;for(var b=0,d=a.length;b<d;b++)new Vb(a[b])}};e.update=function(){for(var a=0,b=this.c.length;a<b;a++)this.c[a].update()};e.Le=function(){for(var a=this.c.length;a--;)this.c.pop().destroy()};e.destroy=function(){this.Le();this.c=this.i=null;l.prototype.destroy.call(this)};Object.defineProperty(qa.prototype,"all",{get:function(){return this.c}});Object.defineProperty(qa.prototype,"count",{get:function(){return this.c}});
...
e.Qe=function(){Ib.prototype.Qe.call(this);this.f=new Wb;this.u=new Xb(this.i,this.f);this.m=new Yb(this.i);if("undefined"!==typeof this.A&&null!==this.A){var a=this.A;this.O=a.uid;this.Ya=a.tags;ba(this);this.j=a.type;this.N=a.name;this.K=a.visible;this.U=a.facingCenter||!1;"undefined"!==typeof a.transform&&this.f.load(a.transform);"undefined"!==typeof a.animation&&(this.u.load(a.animation),this.u.onProgress.add(this.Yi,this));this.m.onReady.add(this.Ci,this);var b;"undefined"!==typeof a.material?
b=a.material:b=Zb.pi;!0===this.Xc&&(b=B.ab(b,Zb.$h));this.m.load(b);"undefined"!==typeof a.sound&&(this.F=new $b(this.i),this.F.load(a.sound,a.transform));"string"===typeof a.fx&&(this.W=a.fx);if("object"===typeof a.events){var a=a.events,d;for(d in a)b=new ac(this.i),b.c(a[d]),this.o[d]=b}}this.J=this.Pk.bind(this);this.I=this.xm.bind(this)};
e.Pk=function(a,b,d,g,h,k){this.log(k);a=this.i.renderer.webGLRenderer.getContext();this.i.renderer.view.pc(h.uniforms);"HotspotMaterial"===h.name?this.m.type===bc.Cd?h.uniforms.tColor.value=new THREE.Color(this.m.color):h.uniforms.tTexture.value=this.m.c:"PickingMaterial"===h.name&&h.program&&(b=this.ba,a.useProgram(h.program.program),h.program.getUniforms().map.tColor.setValue(a,b),h.uniforms.tColor.value=b)};e.xm=function(){};
e.Ci=function(){this.c.material=this.m.material;if("undefined"!==typeof this.A.geometry&&"string"===typeof this.A.geometry.type){var a=this.A.geometry.options;switch(this.A.geometry.type){case cc.Yh:var b=this.c,a=a||{},a=new THREE.BoxBufferGeometry(a.width||100,a.height||100,a.depth||100,a.Fk||8,a.ig||8,a.ro||8);b.geometry=a;break;case cc.mi:b=this.c;a=a||{};a=new THREE.SphereBufferGeometry(a.radius||10,a.Fk||64,a.ig||64,a.wo||0,a.vo||2*Math.PI,a.jo||0,a.io||2*Math.PI);b.geometry=a;break;case cc.Zh:b=
this.c;a=a||{};a=new THREE.CylinderBufferGeometry(a.zo||10,a.xo||10,a.height||20,a.yo||32,a.ig||1,a.uo||!1,a.jo||0,a.io||2*Math.PI);b.geometry=a;break;case cc.ji:this.c.geometry=dc(a);break;default:this.c.geometry=dc()}}else this.c.geometry=dc();this.c.geometry.scale(this.f.scale.x,this.f.scale.y,this.f.scale.z);this.c.material=this.m.material;this.c.c=this.A;this.c.f=this.i.renderer.view instanceof Za;this.Yi();this.R=!0;null!==this.H&&this.H.D();this.ba=Rb(this.c);this.c.onBeforeRender=this.J;this.c.onAfterRender=
this.I;!0===this.u.autoPlay&&this.u.play()};
...
e.km=function(a){a=a.emitter;this.log("Texture load complete (Image) : "+a.element.src);this.L=a;this.c=new THREE.Texture(a.element);this.c.image.crossOrigin="anonymous";this.c.wrapS=THREE.ClampToEdgeWrapping;this.c.wrapT=THREE.ClampToEdgeWrapping;this.c.minFilter=THREE.LinearFilter;this.c.magFilter=THREE.LinearFilter;this.c.needsUpdate=!0;this.log("Map new texture from image");ec(this)};
e.Ki=function(a){a=a.data;a.uid===this.u.plugin&&(this.i.plugins.onInstanceCreate.remove(this.Ki,this),fc(this,a))};function fc(a,b){!0===b.instanceReady?gc(a,b):b.onInstanceReady.ca(a.bn,a)}e.bn=function(a){a=a.emitter;if(null===a.instance||!1===a.instanceReady)throw Error("Plugin instance not available");gc(this,a)};
...
g.instruction.smooth=a.smooth;g.onComplete.add(this.Ub,this);g.onProgress.add(this.Ke,this);v=0;for(x=a.keyframes.length;v<x;v++)b=a.keyframes[v].time+d,h=a.keyframes[v].data.position,"undefined"!==typeof h&&null!==h&&("number"===typeof h.x||"number"===typeof h.y||"number"===typeof h.z||"number"!==typeof h.radius&&"number"!==typeof h.theta&&"number"!==typeof h.phi?(k="undefined"!==typeof h.x&&null!==h.x?h.x:Fb(this,b,a.keyframes,"x",g.tween.easing,"position"),n="undefined"!==typeof h.y&&null!==h.y?
h.y:Fb(this,b,a.keyframes,"y",g.tween.easing,"position"),h="undefined"!==typeof h.z&&null!==h.z?h.z:Fb(this,b,a.keyframes,"z",g.tween.easing,"position")):(k="number"===typeof h.radius?h.radius:200,n="number"===typeof h.theta?G.da(h.theta):0,h="number"===typeof h.phi?G.da(h.phi):0,n=G.Wa(Math.PI-n,-Math.PI,Math.PI),h=(new THREE.Vector3).setFromSpherical(B.Ce(k,n,h)),k=h.x,n=h.y,h=h.z),b=new yb(b+d,{position:{x:k,y:n,z:h}}),g.timeline.lb(b));if(0<g.timeline.keyframes.length&&0<g.timeline.keyframes[0].time||
0<d)v={position:B.clone(this.ja.position)},b=new yb(0,v),g.timeline.lb(b);this.c.push(g);g=new zb(this.i,this.ja);g.tween.easing=a.easing;g.instruction=this.j[2];g.instruction.smooth=a.smooth;g.onComplete.add(this.Ub,this);g.onProgress.add(this.Ke,this);v=0;for(x=a.keyframes.length;v<x;v++)b=a.keyframes[v].time+d,h=a.keyframes[v].data.scale,"undefined"!==typeof h&&null!==h&&(k="undefined"!==typeof h.x&&null!==h.x?h.x:Fb(this,b,a.keyframes,"x",g.tween.easing,"scale"),n="undefined"!==typeof h.y&&null!==
h.y?h.y:Fb(this,b,a.keyframes,"y",g.tween.easing,"scale"),h="undefined"!==typeof h.z&&null!==h.z?h.z:Fb(this,b,a.keyframes,"z",g.tween.easing,"scale"),b=new yb(b+d,{scale:{x:k,y:n,z:h}}),g.timeline.lb(b));if(0<g.timeline.keyframes.length&&0<g.timeline.keyframes[0].time||0<d)v={scale:B.clone(this.ja.scale)},b=new yb(0,v),g.timeline.lb(b);this.c.push(g);this.c[0].play();this.c[1].play();this.c[2].play()};Object.defineProperty(Xb.prototype,"autoPlay",{get:function(){return this.G}});
Object.defineProperty(Xb.prototype,"onProgress",{get:function(){null===this.m&&(this.m=new q(this));return this.m}});function Vb(a){Hb.call(this,"HotspotAnimationTrack");this.j(a)}Vb.prototype=Object.create(Hb.prototype);Vb.prototype.constructor=Vb;var Tb={Df:"3d"};
...
e.Zg=function(a){!1!==this.i.controllers.enabled&&(this.i.canvas.pointer.onPanMove.add(this.Ge,this),this.log("_panStartHandler ("+a.data.velocityX.toFixed(2)+", "+a.data.velocityY.toFixed(2)+")"),this.C=!0,this.o=new THREE.Vector2(a.data.center.x,a.data.center.y),this.G.copy(this.o),this.m.set(0,0),null!==this.j&&this.j.D(),this.i.controllers.se(this))};e.Ge=function(a){!1!==this.i.controllers.enabled&&this.G.set(a.data.center.x,a.data.center.y)};
e.Yg=function(){this.i.canvas.pointer.onPanMove.remove(this.Ge,this);this.log("_panEndHandler");this.C=!1;this.m.set(0,0);this.o.set(0,0);this.G.copy(this.o);null!==this.f&&this.f.D();this.i.controllers.re(this)};e.ah=function(a){!1!==this.i.controllers.enabled&&(this.i.canvas.pointer.onPinchMove.add(this.$g,this),this.log("_pinchStartHandler "+a))};e.$g=function(a){!1!==this.i.controllers.enabled&&this.log("_pinchMoveHandler "+a.data.pinch)};
e.He=function(a){this.i.canvas.pointer.onPinchMove.remove(this.$g,this);this.log("_pinchEndHandler "+a)};e.bh=function(a){if(!1!==this.i.controllers.enabled){a.data.preventDefault();var b=(this.B.invert?1:-1)/this.B.hardness,d=1;if(a.data.deltaMode)switch(a.data.deltaMode){case 1:d=33.3;break;case 2:d=self.innerHeight;break;default:d=1}a.data.deltaY&&(b*=a.data.deltaY*d/5);this.c.fov=this.c.fov-b;this.log("_wheelHandler (fov:"+this.c.fov+")")}};
e.enable=function(){Gc.prototype.enable.call(this);this.i.canvas.pointer.onPanStart.add(this.Zg,this);this.i.canvas.pointer.onPanEnd.add(this.Yg,this);this.i.canvas.pointer.onPinchStart.add(this.ah,this);this.i.canvas.pointer.onPinchEnd.add(this.He,this);this.i.canvas.pointer.onWheel.add(this.bh,this)};
e.Gb=function(){Gc.prototype.Gb.call(this);this.i.canvas.pointer.onPanStart.remove(this.Zg,this);this.i.canvas.pointer.onPanMove.remove(this.Ge,this);this.i.canvas.pointer.onPanEnd.remove(this.Yg,this);this.i.canvas.pointer.onPinchStart.remove(this.ah,this);this.i.canvas.pointer.onPinchMove.remove(this.He,this);this.i.canvas.pointer.onPinchEnd.remove(this.He,this);this.i.canvas.pointer.onWheel.remove(this.bh,this)};
...
function Oc(a,b){if(null===a.c)return-1;for(var d,g=0,h=a.c.length;g<h;g++)if(d=a.c[g],d===b)return g;return-1}e.Sf=function(){if(null!==this.f&&"undefined"!==typeof this.f.suspend&&!0===this.m&&"running"===this.f.state){for(var a=!0,b=0,d=this.c.length;b<d;b++)if(!0===this.c[b].playing||!0===this.c[b].paused){a=!1;break}!0===a&&this.f.suspend()}};
e.Rf=function(){if(null!==this.f&&"undefined"!==typeof this.f.resume&&!0===this.m&&"suspended"===this.f.state)for(var a=0,b=this.c.length;a<b;a++)if(!0===this.c[a].playing||!0===this.c[a].paused){this.f.resume();break}};e.bb=function(){!0!==this.B&&(this.B=!0,this.R=this.j,this.j=0,!0===this.m&&(this.R=this.o.gain.value),Nc(this),null!==this.C&&this.C.D())};e.Mh=function(){!1!==this.B&&(this.B=!1,this.j=this.R,Nc(this),null!==this.G&&this.G.D())};
function Nc(a){if(!0===a.m)a.o.gain.value=a.j;else if(!0===a.I)for(var b=0;b<a.c.length;b++)a.c[b].c.data.volume=G.X(a.c[b].C,0,1)*a.j;a.W=!0;null!==a.H&&a.H.D()}
...
Object.defineProperty(u.prototype,"useAudioTag",{get:function(){return this.I},set:function(a){"boolean"===typeof a&&(this.I=a,this.m=!a)}});Object.defineProperty(u.prototype,"enabled",{get:function(){return this.N}});Object.defineProperty(u.prototype,"muted",{get:function(){return this.B},set:function(a){"boolean"===typeof a&&(!0===a?this.bb():this.Mh())}});
...
e.Oh=function(a){this.I=a;this.fa=!0;null!==this.P&&this.P.D();!0===this.i.audio.useWebAudio?(a=this.I)&&!1===this.wa&&(this.ra=this.ti.bind(this),this.sa=this.em.bind(this),!0===Pc(this)?(this.ma=Omnitone.createFOADecoder(this.f,a.data,{channelMap:this.Fa}),this.ma.initialize().then(this.ra,this.sa)):this.f.decodeAudioData(a.data,this.ra,this.sa)):(Qc(this),this.ti(null))};e.em=function(){null!==this.I&&(this.I.data=null,this.wa=!1)};
function Qc(a){null!==a.xa&&a.xa.D();null!==a.R&&a.R.D();null!==a.U&&a.U.D()}e.ti=function(a){if(null!==this.I){a&&(this.I.data=a);this.wa=!0;Qc(this);if(!0===this.i.audio.useAudioTag||!0===Pc(this))this.c=this.i.cache.get(A.pb,this.ga),Rc(this),this.o=0,this.c.data.duration&&(this.o=this.c.data.duration,this.K=Math.ceil(1E3*this.o));!0===this.ya&&this.play(this.A,this.N,!0)}};e.Ph=function(){Rc(this)};
...
e.play=function(a,b,d){if(!1===this.i.audio.enabled||!1===this.J)this.B=this.u=!1;else{this.N=b||this.N;if(!0===this.u)if(!0===d)this.stop();else return;if(!1===this.fa)this.ya=!0;else if(!0===this.i.audio.useWebAudio&&!1===Pc(this))!0===this.wa?(null===this.ia&&(this.ia=this.I.data),this.c=this.f.createBufferSource(),this.c.buffer=this.ia,!0===this.$?Tc(this,!0):this.c.connect(this.H),this.o=this.c.buffer.duration,this.K=Math.ceil(1E3*this.o),!isNaN(a)&&a<this.K?this.F=this.i.clock.time-a:(a=0,this.F=
this.i.clock.time),b=G.pd(a/1E3),"undefined"===typeof this.c.start?this.c.noteGrainOn(0,b%this.o,this.o):this.c.start(0,b%this.o,this.o),this.u=!0,this.A=a,this.Aa++,null!==this.G&&this.G.D(),this.i.audio.Rf()):(this.log("Sound is not decoded yet"),this.ya=!0);else if(!0===this.i.audio.useAudioTag||!0===Pc(this))this.o?Infinity===this.o&&(this.c.data.loop=!0):(this.o=this.c.data.duration,this.K=Math.ceil(1E3*this.o)),!isNaN(a)&&this.K&&a<this.K?(this.c.data.currentTime=G.pd(a/1E3),this.F=this.i.clock.time-
a):(a=0,this.c.data.currentTime=a,this.F=this.i.clock.time),this.c.data.play(),this.u=!0,this.A=a,this.Aa++,null!==this.G&&this.G.D()}};e.stop=function(a){null!==this.c?(Uc(this,!0),this.F=this.za=this.i.clock.time,this.B=this.u=this.ya=!1,null!==this.oa&&!0===a&&this.oa.D(),this.i.audio.Sf()):!1!==this.fa&&!0===this.wa||Sc(this)};
function Uc(a,b){if(!0===a.i.audio.useWebAudio&&!1===Pc(a)){if("undefined"===typeof a.c.stop)a.c.noteOff(0);else try{a.c.stop(0)}catch(d){}a.c.disconnect(0);!0===b&&(a.A=0)}else if(!0===a.i.audio.useAudioTag||!0===Pc(a))a.c.data.pause(),!0===b&&(a.A=0,a.c.data.currentTime=0)}e.pause=function(){!0===this.u&&null!==this.c?(Uc(this,!1),this.B=!0,this.za=this.i.clock.time,this.u=this.ya=!1,null!==this.S&&this.S.D(),this.i.audio.Sf()):!1!==this.fa&&!0===this.wa||Sc(this)};
...
a%this.o,b)}else if(!0===this.i.audio.useAudioTag||!0===Pc(this))this.c.data.currentTime=G.pd(a/1E3),this.c.data.play();this.u=!0;this.B=!1;null!==this.V&&this.V.D();this.i.audio.Rf()}else if(!1===this.fa||!1===this.wa)Sc(this),this.ya=!0};
...
this.f=this.N;null!==this.C&&this.C.D()}Q.prototype=Object.create(l.prototype);e=Q.prototype;e.constructor=Q;e.Zd=function(){0<this.c.length&&this.c.indexOf(this.f)+1===this.c.length&&(!1===this.F||!0===this.track.loop)?this.f=this.c[0]:this.nd()};e.el=function(){null!==this.A&&this.A.D()};e.gl=function(){null!==this.H&&this.H.D()};e.dl=function(){null!==this.u&&this.u.D()};e.fl=function(){null!==this.G&&this.G.D()};e.cl=function(){null!==this.o&&this.o.D()};e.hl=function(){return!!this.c.length};
...
function sa(a){this.i=a;this.j=this.c=null;this.M=this.W=this.P=!1;this.J=-1;this.K=this.o=null;l.call(this,"Director");this.Fe()}sa.prototype=Object.create(l.prototype);e=sa.prototype;e.constructor=sa;e.Fe=function(){this.o=this.i.clock.create(!1);this.i.story.onSceneLoadComplete.add(this.Si,this);this.i.onReady.add(this.dh,this)};e.load=function(a){if(null!==a.tracks&&Array.isArray(a.tracks))for(var b=0,d=a.tracks.length;b<d;b++)new uc(a.tracks[b])};
e.dh=function(){this.i.controllers.onControlStart.add(this.Zc,this);this.i.controllers.onControlEnd.add(this.Yc,this)};
...
(this.K=this.o.add(a.delay,this.Jf,this),this.o.start())))};e.Yd=function(){this.stop();this.i.renderer.media.displayObject.onPause.remove(this.Yd,this);this.i.renderer.media.displayObject.onPlay.add(this.Lf,this);this.i.controllers.onControlStart.remove(this.Zc,this);this.i.controllers.onControlEnd.remove(this.Yc,this)};
e.Lf=function(){null!==this.c&&this.play(this.c);this.i.renderer.media.displayObject.onPause.add(this.Yd,this);this.i.renderer.media.displayObject.onPlay.remove(this.Lf,this);this.i.controllers.onControlStart.add(this.Zc,this);this.i.controllers.onControlEnd.add(this.Yc,this)};
e.Wb=function(){this.stop();this.i.renderer.media.displayObject.onWaiting.remove(this.Wb,this);this.i.renderer.media.displayObject.onStalled.remove(this.Wb,this);this.i.renderer.media.displayObject.onPlaying.add(this.Mf,this);this.i.controllers.onControlStart.remove(this.Zc,this);this.i.controllers.onControlEnd.remove(this.Yc,this)};
e.Mf=function(){null!==this.c&&this.play(this.c);this.i.renderer.media.displayObject.onPlaying.remove(this.Mf,this);this.i.renderer.media.displayObject.onWaiting.add(this.Wb,this);this.i.renderer.media.displayObject.onStalled.add(this.Wb,this);this.i.controllers.onControlStart.add(this.Zc,this);this.i.controllers.onControlEnd.add(this.Yc,this)};e.xi=function(){!0===this.i.renderer.media.displayObject.loop&&this.Si()};e.Zc=function(){null!==this.c&&!0===this.M&&this.stop();this.o.stop(!0)};
e.Yc=function(){null!==this.K&&this.o.remove(this.K);null!==this.c&&!0===this.M&&(null===this.c&&"number"===typeof this.i.story.scene.config.director.animation.delay?(this.K=this.o.add(this.i.story.scene.config.director.animation.delay,this.Jf,this),this.o.start()):"number"===typeof this.J&&-1<this.J&&(this.K=this.o.add(this.J,this.Jf,this),this.o.start()))};
e.Hi=function(){if(1<this.j.length){var a=this.j.indexOf(this.c)+1;if(a<this.j.length){this.play(a);return}}!0===this.P&&(!0===this.W&&(this.j=B.od(this.j)),this.play(0))};e.Jf=function(){this.play(this.c);this.o.stop(!0)};
...
function Zc(a){a.i.renderer.camera.animation.onComplete.remove(a.Hi,a);"undefined"!==typeof a.i.story.scene.config.media&&a.i.story.scene.config.media.type===Ja.VIDEO&&(a.i.renderer.media.displayObject.onPlay.remove(a.Lf,a),a.i.renderer.media.displayObject.onPause.remove(a.Yd,a),a.i.renderer.media.displayObject.onWaiting.remove(a.Wb,a),a.i.renderer.media.displayObject.onStalled.remove(a.Wb,a),a.i.renderer.media.displayObject.onPlaying.remove(a.Mf,a),a.i.renderer.media.displayObject.onEnded.remove(a.xi,
a),a.i.renderer.media.displayObject.onCurrentTimeChange.remove(a.Wi,a))}e.destroy=function(){Zc(this);this.i.onReady.remove(this.dh,this);this.c=this.j=this.i=null;l.prototype.destroy.call(this)};function uc(a){this.G=this.o=!1;Hb.call(this,"DirectorTrack");this.j(a)}uc.prototype=Object.create(Hb.prototype);uc.prototype.constructor=uc;uc.prototype.j=function(a){this.o=a.smooth;this.G=a.cancelRoll;Hb.prototype.j.call(this,a)};Object.defineProperty(uc.prototype,"smooth",{get:function(){return this.o}});
...
$c.prototype.yb=function(){var a=bd(this,this.ja);if(null!==a){if(null!==this.c){var b=this.c;if("undefined"!==typeof a[b.name])switch("undefined"===typeof b.operation&&(b.operation=ad.Af),b.operation){case ad.Af:a[b.name]=b.value;break;case ad.Xh:a[b.name]+=b.value;break;case ad.ni:a[b.name]-=b.value;break;case ad.gi:a[b.name]*=b.value;break;case ad.bi:a[b.name]/=b.value;break;case ad.oi:a[b.name]=!a[b.name]}}if(null!==this.f&&(b=this.f,"function"===typeof a[b.name])){var d="undefined"!==typeof b.args?
...
function cd(a){a.A=B.ab(a.G.defaultConfig,a.H,a.K);a.J=a.A.options||{};a.hb=a.A.data||{};a.I=a.A.actions||{};for(var b in a.j)a.j[b].destroy(),a.j[b]=null;b=a.A.events;a.j={};var d,g;for(g in b)d=new ac(a.i),d.c(b[g]),a.j[g]=d}e.Zj=function(){!0===this.G.loaded?dd(this):this.G.onLoadComplete.ca(this.im,this)};e.im=function(){dd(this)};
...
e.load=function(a){if("undefined"!==typeof a){a=this.C=a;if("undefined"===typeof a.uid)throw"Can't load a plugin engine, missing id in config";this.O=a.uid;ba(this);this.J="string"===typeof a.prefix?a.prefix:this.i.plugins.prefix;if("undefined"===typeof a.url)throw"Can't load a plugin engine, missing url in config";this.j=a.url;this.o=this.J+this.j;this.N="string"===typeof a.manifest?a.manifest:"manifest.json";this.i.load.json(this.O,this.o+this.N,this.tm,this);return!0}return!1};
...
k.engine+" doesn't exist";k=new R(h.i,n,k,"number"===typeof k.index?k.index:h.c.size);k.onInstanceCreate.ca(h.Cm,h);h.c.add(k);k.Zj()}}}function ld(a,b){if("undefined"!==typeof b)for(var d=0,g=b.length;d<g;d++){var h=!1!==b[d].enabled?!0:!1,k=a.de(b[d].instance),n=null;!0===h&&(n=b[d]);null!==k&&(k.contextualConfig=n)}}e.Cm=function(a){a=a.emitter;null!==this.f&&this.f.D(a)};e.boot=function(){this.j=new md;this.c=new md;this.i.story.onSceneLoadStart.add(this.il,this)};
...
e.fo=function(a){a=new za(this.i,a);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};e.ho=function(a){a=new S(this.i,a);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};e.sound=function(a,b){a=new M(this.i,a,b);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};e.wn=function(a){a=new t(this.i,a);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};e.kl=function(a){a=new T(this.i,a);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};
e.image=function(a,b){var d=a;"string"===typeof a&&(d={key:null,url:a});d.key=this.Vb.uid+"-"+d.key;!1!==b&&(d.url=this.Vb.fullUrl+d.url);a=new I(this.i,d);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};e.co=function(a,b){a.key=this.Vb.uid+"-"+a.key;!1!==b&&(a.url=this.Vb.fullUrl+a.url,a.frames=this.Vb.fullUrl+a.frames);a=new nd(this.i,a);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};e.jl=function(a){a=new od(this.i,a);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};
e.ml=function(a,b,d,g,h){var k;"undefined"!==typeof d&&d.toLowerCase()===Ma.$e?k=new J(this.i,a,b,g):k=new K(this.i,a,b,g,h);k.onDestroy.ca(this.kb,this);this.Z.push(k);return k};e.canvas=function(){var a=new ia(this.i);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};e.ll=function(a){a=new Ab(this.i,a);a.onDestroy.ca(this.kb,this);this.i.tween.add(a);this.Z.push(a);return a};e.rj=function(){this.log("destroyAllObjects();");for(var a=this.Z.length;a--;)this.Z[a].destroy()};
e.destroy=function(){this.rj();this.Z=this.Vb=this.i=null;l.prototype.destroy.call(this)};
var N=function(a){a=a();a.prototype=Object.create(null);a.prototype.constructor=a;a.prototype.am=function(){if(/Playstation Vita/.test(this.aa))this.cb="Playstation Vita",this.Mg=!0;else if(/Xbox/.test(this.aa))this.cb="Xbox",this.Wg=!0;else if(/Kindle/.test(this.aa)||/\bKF[A-Z][A-Z]+/.test(this.aa)||/Silk.*Mobile Safari/.test(this.aa))this.cb="Kindle",this.pg=!0;else if(/Windows Phone/i.test(this.aa)||/IEMobile/i.test(this.aa))this.cb="Windows Phone",this.Ee=!0,/Windows Phone (\d+)/.test(this.aa)&&
(this.Zb=parseInt(RegExp.$1,10));else if(/Android/.test(this.aa))this.cb="Android",this.fj=!0,/Android ([\.\_\d]+)/.test(this.aa)&&(this.Zb=parseInt(RegExp.$1,10));else if(/CrOS/.test(this.aa))this.cb="Chrome OS",this.Uf=!0;else if(/iP[ao]d|iPhone/i.test(this.aa))this.cb="iOS",this.Fc=!0,/OS (\d+)/.test(navigator.appVersion)&&(this.Zb=parseInt(RegExp.$1,10));else if(/(Linux|X11)/.test(this.aa))this.cb="Linux",this.qg=!0;else if(/Mac OS X/.test(this.aa))this.cb="Mac OS X",this.tg=!0,/Mac OS X (10[\.\_\d]+)/.test(this.aa)&&
(this.Zb=parseInt(RegExp.$1,10));else if(/Windows/.test(this.aa)||/WPDesktop/i.test(this.aa))/WPDesktop/i.test(this.aa)?(this.cb="Windows Phone",this.Ee=!0):(this.cb="Windows",this.Vg=!0),/(Windows 10.0|Windows NT 10.0)/.test(this.aa)?this.Zb=10:/(Windows 8.1|Windows NT 6.3)/.test(this.aa)||/(Windows 8|Windows NT 6.2)/.test(this.aa)?this.Zb=8:/(Windows 7|Windows NT 6.1)/.test(this.aa)&&(this.Zb=7)};a.prototype.Sl=function(){this.jd="undefined"!==typeof document.documentMode;this.ae=!1===this.jd&&
!0===!!window.StyleMedia;this.bg="undefined"!==typeof window.InstallTrigger;this.opera=!0===!!window.opr||0<=this.aa.indexOf(" OPR/")||0<=this.aa.indexOf("Opera");this.Cg=0<Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor");this.chrome=!1===this.jd&&!1===this.ae&&!1===this.opera&&(!0===!!window.chrome||0<=this.aa.indexOf("CriOS"));if(this.ae)this.mb="Edge",/Edge\/(\d+)/.test(this.aa)&&(this.$a=this.tj=parseInt(RegExp.$1,10));else if(this.chrome)this.mb="Chrome",/CriOS\/(\d+)/.test(this.aa)?
this.$a=this.Vf=parseInt(RegExp.$1,10):/Chrome\/(\d+)/.test(this.aa)&&(this.$a=this.Vf=parseInt(RegExp.$1,10));else if(this.bg)this.mb="Firefox",/Firefox\D+(\d+)/.test(this.aa)&&(this.$a=this.xj=parseInt(RegExp.$1,10));else if(this.pg)/Silk/.test(this.aa)&&(this.mb="Silk",this.Hg=!0);else if(this.jd)this.mb="Internet Explorer",/MSIE (\d+\.\d+);/.test(this.aa)?this.$a=this.lg=parseInt(RegExp.$1,10):/Trident\/(\d+\.\d+)(.*)rv:(\d+\.\d+)/.test(this.aa)&&(this.$a=this.lg=parseInt(RegExp.$3,10));else if(this.opera)this.mb=
...
8)))}navigator.j&&(this.Ek=!0);this.pk="CSS1Compat"===document.compatMode?!1:!0};a.prototype.Ul=function(){this.nc=window.devicePixelRatio||1;this.Xj=!0===this.Fc&&-1!==this.aa.toLowerCase().indexOf("iphone");this.Yj=!0===this.Fc&&-1!==this.aa.toLowerCase().indexOf("ipod");this.kg=!0===this.Fc&&-1!==this.aa.toLowerCase().indexOf("ipad");this.rk=2<=this.nc&&!0===this.Fc;this.Vg&&!this.Ee||this.tg||this.qg&&!this.Hg||this.Uf?this.Dc=!0:/Mobi/i.test(this.aa)&&!1===this.kg?this.qe=!0:this.Jg=!0;if(/TV/i.test(this.aa)||
!0===this.Mg||!0===this.Wg||this.Dc&&/Windows NT/i.test(this.aa)&&/Touch/i.test(this.aa))this.kk=!0,this.Dc=this.Jg=this.qe=!1};a.prototype.cm=function(){var a=document.createElement("video");try{"function"===typeof a.canPlayType&&(a.canPlayType('video/ogg; codecs="theora"').replace(/^no$/,"")&&(this.yg=!0),a.canPlayType('video/mp4; codecs="avc1.42E01E"').replace(/^no$/,"")&&(this.wg=this.fg=!0),a.canPlayType('video/webm; codecs="vp8, vorbis"').replace(/^no$/,"")&&(this.Ug=!0),a.canPlayType('video/webm; codecs="vp9"').replace(/^no$/,
"")&&(this.Ng=!0),a.canPlayType('application/x-mpegURL; codecs="avc1.42E01E"').replace(/^no$/,"")&&(this.jg=!0))}catch(d){}};a.prototype.Ql=function(){this.Qf="undefined"!==typeof window.Audio;this.Pg="undefined"!==typeof window.AudioContext||"undefined"!==typeof window.webkitAudioContext;var a=document.createElement("audio");try{if("function"===typeof a.canPlayType){a.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/,"")&&(this.xg=!0);a.canPlayType("audio/mpeg;").replace(/^no$/,"")&&(this.ug=
!0);if(a.canPlayType('audio/ogg; codecs="opus"').replace(/^no$/,"")||a.canPlayType("audio/opus;").replace(/^no$/,""))this.ue=!0;a.canPlayType('audio/wav; codecs="1"').replace(/^no$/,"")&&(this.Og=!0);a.canPlayType("audio/aac;").replace(/^no$/,"")&&(this.Of=!0);if(a.canPlayType("audio/x-m4a;")||a.canPlayType("audio/m4a;")||a.canPlayType("audio/aac;").replace(/^no$/,""))this.sg=!0;if(a.canPlayType("audio/x-mp4;")||a.canPlayType("audio/mp4;")||a.canPlayType("audio/aac;").replace(/^no$/,""))this.vg=!0;
a.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/,"")&&(this.Sg=this.Tg=!0)}}catch(d){}};a.prototype.Vl=function(){this.Kg="undefined"!==typeof navigator.Kg||"undefined"!==typeof navigator.o||"undefined"!==typeof navigator.c||"undefined"!==typeof navigator.f;this.Tf="function"===typeof navigator.getBattery};a.prototype.Xl=function(){this.canvas="undefined"!==typeof window.CanvasRenderingContext2D;if(!0===this.canvas){this.kj="function"===typeof document.createElement("canvas").getContext("2d").fillText;
...
typeof window.HTMLMenuItemElement};a.prototype.Wl=function(){this.ck=/^https/i.test(window.location.protocol);try{this.ng=window.self!==window.top}catch(b){this.ng=!0}};a.prototype.$l=function(){this.yk="undefined"!==typeof window.ontouchstart||"undefined"!==typeof window.c&&document instanceof window.c||"number"===typeof navigator.maxTouchPoints&&0<navigator.maxTouchPoints||"number"===typeof navigator.msMaxTouchPoints&&0<navigator.msMaxTouchPoints;if("undefined"!==typeof window.j||"undefined"!==
typeof window.m)this.zk=!(!MouseEvent.f||!MouseEvent.c);this.Dj="function"===typeof navigator.getGamepads||"function"===typeof navigator.webkitGetGamepads};a.prototype.Yl=function(){for(var a="requestFullscreen requestFullScreen webkitRequestFullscreen webkitRequestFullScreen mozRequestFullScreen mozRequestFullscreen msRequestFullscreen msRequestFullScreen".split(" "),d="cancelFullscreen cancelFullScreen exitFullscreen exitFullScreen webkitCancelFullscreen webkitCancelFullScreen webkitExitFullscreen webkitExitFullScreen mozCancelFullscreen mozCancelFullScreen mozExitFullscreen mozExitFullScreen msCancelFullscreen msCancelFullScreen msExitFullscreen msExitFullScreen".split(" "),
...
this.oj="undefined"!==typeof d&&0<d.length&&"none"!==d};a.prototype.gm=function(a){null!==a.rotationRate&&"undefined"!==typeof a.rotationRate.alpha&&"undefined"!==typeof a.rotationRate.beta&&"undefined"!==typeof a.rotationRate.gamma&&(this.Yf=!0);"undefined"!==typeof a.acceleration&&"undefined"!==typeof a.acceleration.x&&"undefined"!==typeof a.acceleration.y&&"undefined"!==typeof a.acceleration.z&&(this.Xf=!0);this.Li();"function"!==typeof this.Bc&&this.Ff()};a.prototype.hm=function(a){"undefined"!==
typeof a.alpha&&"undefined"!==typeof a.beta&&"undefined"!==typeof a.gamma&&(this.$f=!0);this.Mi();"function"!==typeof this.Ac&&this.Ff()};a.prototype.Li=function(){window.removeEventListener("devicemotion",this.Ac,!1);this.Ac=null};a.prototype.Mi=function(){window.removeEventListener("deviceorientation",this.Bc,!1);this.Bc=null};a.prototype.Zl=function(){this.Wf="undefined"!==typeof window.DeviceMotionEvent;this.Zf="undefined"!==typeof window.DeviceOrientationEvent;window.addEventListener("deviceorientation",
this.Bc,!1);window.addEventListener("devicemotion",this.Ac,!1)};a.prototype.bm=function(){var a=document.createElement("div");a.style.width="1in";a.style.height="1in";document.body.appendChild(a);this.sj=a.offsetWidth;document.body.removeChild(a);this.qe?(this.Eg=Math.floor(Math.min(window.screen.width,window.screen.height)*this.nc),this.Dg=Math.floor(Math.max(window.screen.width,window.screen.height)*this.nc)):(this.Eg=Math.floor(Math.max(window.screen.width,window.screen.height)*this.nc),this.Dg=
Math.floor(Math.min(window.screen.width,window.screen.height)*this.nc))};a.prototype.Pl=function(){this.aa=navigator.userAgent;this.language=navigator.languages&&navigator.languages[0]||navigator.language||navigator.m||"";this.am();this.Sl();this.Ul();this.Ql();this.cm();this.Vl();this.Xl();this.Wl();this.Rl();this.Yl();this.$l();this.Tl();this.Ac=this.gm.bind(this);this.Bc=this.hm.bind(this);this.Zl();this.bm();!1===this.Wf&&!1===this.Zf&&this.Ff()};a.prototype.Ff=function(){"function"===typeof this.Ac&&
this.Li();"function"===typeof this.Bc&&this.Mi();!0===this.Yf&&!0===this.Xf&&!0===this.$f&&(this.Qj=!0);this.ready=!0;Object.freeze(N)};a.prototype.tn=function(a){return"mp3"===a&&!0===this.ug||"ogg"===a&&(!0===this.xg||!0===this.ue)||"m4a"===a&&!0===this.sg||"mp4"===a&&!0===this.vg||"opus"===a&&!0===this.ue||"wav"===a&&!0===this.Og||"aac"===a&&!0===this.Of||"webm"===a&&!0===this.Tg||"weba"===a&&!0===this.Sg?!0:!1};a.prototype.un=function(a){if("webm"!==a||!0!==this.Ug&&!0!==this.Ng)if("mp4"!==a||
!0!==this.wg&&!0!==this.fg){if(("ogg"===a||"ogv"===a)&&!0===this.yg||"mpeg"===a&&!0===this.jg)return!0}else return!0;else return!0;return!1};a.prototype.Rn=function(){return navigator.getBattery().then(function(a){return this.Tf&&!a.charging&&.2>=a.level}.bind(this),function(){return!1})};return new a}(function(){return function(){this.ready=!1;this.cb=this.language=this.aa="";this.Zb=0;this.bg=this.Ee=this.Vg=this.tg=this.qg=this.Fc=this.Uf=this.fj=this.pg=this.Wg=this.Mg=!1;this.xj=0;this.chrome=
!1;this.Vf=0;this.jd=!1;this.lg=0;this.opera=!1;this.te=0;this.ae=!1;this.tj=0;this.Cg=!1;this.sk=0;this.Hg=!1;this.mb="";this.$a=0;this.ak=this.Ek=!1;this.gj=0;this.pk=!1;this.fullscreenElement=this.exitFullscreen=this.requestFullscreen=this.fullscreenEnabled="";this.kg=this.Yj=this.rk=this.Xj=this.Bj=!1;this.nc=1;this.ng=this.ck=this.wk=this.history=this.JSON=this.uj=this.hk=this.contextMenu=this.nk=this.geolocation=this.applicationCache=this.localStorage=this.wj=this.file=this.Rg=this.Qg=this.raf=
this.addEventListener=this.kj=this.lj=this.canvas=this.jg=this.Ng=this.Ug=this.wg=this.fg=this.yg=this.Sg=this.Tg=this.Of=this.vg=this.sg=this.Og=this.ue=this.ug=this.xg=this.Pg=this.Qf=this.zk=this.Dj=this.yk=this.kk=this.qe=this.Jg=this.Dc=this.Tf=this.Kg=!1;this.Lg=this.visibilityState="";this.$f=this.Yf=this.Xf=this.Zf=this.Wf=this.Qj=this.pj=this.dd=this.qj=this.oj=!1;this.Bc=this.Ac=null;this.Dg=this.Eg=this.sj=0;this.tk=!1;this.Ak=this.ek=this.orientation="";this.Pl()}});
...
e.ha=function(a){this.c="boolean"===typeof a.enabled?a.enabled:!0;!0===this.c&&(this.i.story.onSceneLoadStart.add(this.mh,this),this.i.i18n.onLocaleChangeComplete.add(this.lh,this),window.addEventListener("popstate",this.Ei,!1))};e.destroy=function(){this.i.story.onSceneLoadStart.remove(this.mh,this);this.i.i18n.onLocaleChangeComplete.remove(this.lh,this);window.removeEventListener("popstate",this.Ei,!1);this.i=null;l.prototype.destroy.call(this)};Object.defineProperty(na.prototype,"enabled",{get:function(){return this.c}});
...
function wd(a,b){if(0>b||b>=a.c.size)throw"The locale you are trying to set doesn't exist";a.f===b?a.warn("$_LocaleManager: You're trying to set a locale that is already the actual locale"):(a.f=b,null!==a.m&&a.m.D(),a.c.get(a.f).rg())}e.sm=function(){this.log("$_LocaleManager._localeAllFilesLoaded();");null!==this.j&&this.j.D()};
...
e.rg=function(){if(!0===yd(this))return this.f.D(),!0;for(var a,b=0,d=this.c.size;b<d;b++)a=this.c.get(b),!1===a.zb&&!1===a.loaded&&!1===a.zb&&!1===a.loaded&&(a.zb=!0,this.i.load.json(a.key,a.url,this.qm,this))};function xd(a,b){for(var d,g=0,h=a.c.size;g<h;g++)if(d=a.c.get(g),d.key===b)return d;return null}e.qm=function(a){a=xd(this,a.key);a.zb=!1;a.loaded=!0;this.log("loadFileComplete(); "+a.key);this.j.D();!0===yd(this)&&this.f.D()};
...
Object.defineProperty(vd.prototype,"name",{get:function(){return this.m}});function ua(a){this.i=a;this.j=!0;this.o=this.m=this.f=this.c=null;l.call(this,"Keyboard");this.c=[];this.f=[];this.m=this.nm.bind(this);this.o=this.om.bind(this);window.addEventListener("keydown",this.m,!1);window.addEventListener("keyup",this.o,!1)}ua.prototype=Object.create(l.prototype);e=ua.prototype;e.constructor=ua;
e.nm=function(a){if(!1!==this.j){var b=a.keyCode;this.log("keyDown "+b);-1===this.f.indexOf(b)?(this.f.push(b),b=!0):b=!1;!0===b&&zd(this,a)}};
e.om=function(a){if(!1!==this.j){var b=a.keyCode;this.log("keyUp "+b);b=this.f.indexOf(b);-1!==b?(this.f.splice(b,1),b=!0):b=!1;if(!0===b)a:if(b=a.keyCode,!0!==this.og(b))for(var b=this.dg(b),d,g=0,h=b.length;g<h;g++){d=b[g];for(var k=0,n=this.f.length;k<n;k++)if(d.je(this.f[k]))break a;d.Bk(a);k=0;for(n=this.f.length;k<n;k++)if(d.gg(this.f[k])){var v=new KeyboardEvent("keydown",{so:this.f[k],ctrlKey:a.ctrlKey,shiftKey:a.shiftKey,altKey:a.altKey});zd(this,v)}}}};
function Ad(a,b){if(null===a.c||!a.c.length)return-1;if("object"===typeof b&&"KeyBinding"===b.type)return a.c.indexOf(b);if("number"===typeof b)for(var d=0,g=a.c.length;d<g;d++)if(!0===a.c[d].je(b))return d;return-1}function zd(a,b){var d=b.keyCode;if(!0!==a.og(d)){a=a.dg(d);for(var g=0,h=a.length;g<h;g++)d=a[g],!1===d.pressed&&d.nh(b)}}e.update=function(){for(var a,b=0,d=this.c.length;b<d;b++)if(a=this.c[b],!0===a.pressed){if(!0===a.hasToWaitToHold&&!1===a.downComplete)break;a.Wj()}};
e.Qn=function(a){return-1!==this.f.indexOf(a)};e.og=function(a){for(var b,d=0,g=this.c.length;d<g;d++)if(b=this.c[d],!0===b.pressed&&!0===b.gg(a))return!0;return!1};e.Pf=function(a){if("object"!==typeof a&&"KeyBinding"!==a.type)return!1;if(-1===Ad(this,a))return this.c.push(a),!0;this.warn("Trying to add a duplicate key binding on keyboard!");return!1};e.ye=function(a){a=Ad(this,a);return-1!==a?(this.c[a].destroy(),this.c.splice(a,1),!0):!1};e.Gn=function(a){return-1!==Ad(this,a)};
e.dg=function(a){for(var b=[],d=0,g=this.c.length;d<g;d++)!0===this.c[d].je(a)&&b.push(this.c[d]);return b};e.destroy=function(){this.i=null;window.removeEventListener("keydown",this.m,!1);window.removeEventListener("keyup",this.o,!1);for(var a=this.c.length;a--;)this.ye(this.c[a]);this.o=this.m=this.c=null;l.prototype.destroy.call(this)};Object.defineProperty(ua.prototype,"enabled",{get:function(){return this.j},set:function(a){this.j=!!a}});
function P(a,b,d,g,h,k,n,v){this.i=a;this.G=b||[];this.o=d||null;this.C=g||null;this.u=h||null;this.A=k||null;this.f=n||this;this.I=v||"";this.Hf=this.H=this.K=!1;this.F=this.B=this.$c=0;this.m=this.j=this.c=null;l.call(this,"KeyBinding");if(!0===B.T(this.o,"string")||B.Ga(this.o,"string"))this.c=new ac(this.i),this.c.c(this.o);if(!0===B.T(this.u,"string")||B.Ga(this.u,"string"))this.j=new ac(this.i),this.j.c(this.u);if(!0===B.T(this.C,"string")||B.Ga(this.C,"string"))this.m=new ac(this.i),this.m.c(this.C)}
P.prototype=Object.create(l.prototype);e=P.prototype;e.constructor=P;e.je=function(a){return"number"===typeof this.G&&this.G===a?!0:"function"===typeof this.G.indexOf?-1!==this.G.indexOf(a):!1};e.gg=function(a){if(null!==this.A){if("number"===typeof this.A&&this.A===a)return!0;if("function"===typeof this.A.indexOf)return-1!==this.A.indexOf(a)}return!1};e.nh=function(a){this.log("down");this.$c++;this.H=!0;"function"===typeof this.o?this.o.call(this.f,this,a):null!==this.c&&this.c.D()};
e.mo=function(){this.K=!0;var a=this.$c;return function(){this.log("downCompleteCallback "+a+" "+this.$c);a===this.$c&&(this.Hf=!0)}.bind(this)};e.Bk=function(a){this.log("up");this.F++;this.Hf=this.H=!1;"function"===typeof this.C?this.C.call(this.f,this,a):null!==this.m&&this.m.D()};e.Wj=function(){this.log("hold");this.B++;"function"===typeof this.u?this.u.call(this.f,this):null!==this.j&&this.j.D()};
...
Object.defineProperty(P.prototype,"upCount",{get:function(){return this.F}});Object.defineProperty(P.prototype,"holdCount",{get:function(){return this.B}});Object.defineProperty(P.prototype,"hasToWaitToHold",{get:function(){return this.K}});Object.defineProperty(P.prototype,"downComplete",{get:function(){return this.Hf}});
...
null,this.L.right=null,this.L.bottom=null,this.L.left=null,this.G={x:a.pageX,y:a.pageY},this.N=this.L.alpha,this.L.alpha=this.F,null!==this.o&&this.o.D())};e.hh=function(){this.log("_panEndHandler");!0===this.H&&(this.H=!1,null!==this.u&&this.u.D(),!0===this.B&&null!==this.m?(this.K=!0,this.m.Ye({x:this.I.x,y:this.I.y},this.R,this.U).start()):this.L.alpha=this.N,this.G=this.I=null)};
...
e.Bh=function(a){null!==this.F&&!0===this.c&&this.F.D(a)};e.Ah=function(a){null!==this.B&&!0===this.c&&this.B.D(a)};e.Ri=function(a){null!==this.U&&!0===this.c&&this.U.D(a)};e.Qi=function(a){null!==this.R&&!0===this.c&&this.R.D(a)};e.Pi=function(a){null!==this.N&&!0===this.c&&this.N.D(a)};e.Vi=function(a){null!==this.W&&!0===this.c&&this.W.D(a)};e.yi=function(a){null!==this.u&&!0===this.c&&this.u.D(a)};e.Ai=function(a){null!==this.A&&!0===this.c&&this.A.D(a)};
e.Ji=function(a){null!==this.m&&!0===this.c&&this.m.D(a)};e.Ii=function(a){null!==this.j&&!0===this.c&&this.j.D(a)};e.Di=function(a){null!==this.f&&!0===this.c&&this.f.D(a)};e.Fh=function(a){null!==this.P&&!0===this.c&&this.P.D(a)};
e.enable=function(){!0===N.dd&&(this.L.dom.style.pointerEvents="auto");this.Ua.set({enable:!0});null===this.V&&(this.V=new Hammer.Tap,this.Ua.add(this.V));null===this.va&&(this.va=(new Hammer.Tap({event:U.events.Bd,Co:2})).recognizeWith(this.V),this.Ua.add(this.va));null===this.wa&&(this.wa=(new Hammer.Press).recognizeWith(this.V),this.Ua.add(this.wa));null===this.oa&&(this.oa=new Hammer.Pan,this.Ua.add(this.oa));null===this.na&&(this.na=new Hammer.Pinch,this.Ua.add(this.na));null===this.xa&&(this.xa=
(new Hammer.Rotate).recognizeWith(this.na),this.Ua.add(this.xa));null===this.ya&&(this.ya=(new Hammer.Swipe).recognizeWith(this.oa),this.Ua.add(this.ya));this.c=!0;null!==this.S&&this.S.D()};e.Te=function(){!0===N.dd&&(this.L.dom.style.pointerEvents="none");this.c=!1;this.Ua.set({enable:!1});null!==this.ba&&this.ba.D()};
e.destroy=function(){this.Te();this.ya=this.xa=this.na=this.oa=this.wa=this.va=this.V=null;null!==this.S&&(this.S.destroy(),this.S=null);null!==this.ba&&(this.ba.destroy(),this.ba=null);null!==this.M&&(this.M.destroy(),this.M=null);null!==this.o&&(this.o.destroy(),this.o=null);null!==this.J&&(this.J.destroy(),this.J=null);null!==this.I&&(this.I.destroy(),this.I=null);null!==this.H&&(this.H.destroy(),this.H=null);null!==this.G&&(this.G.destroy(),this.G=null);null!==this.C&&(this.C.destroy(),this.C=
...
null);null!==this.f&&(this.f.destroy(),this.f=null);null!==this.P&&(this.P.destroy(),this.P=null);this.L=null;l.prototype.destroy.call(this)};Object.defineProperty(U.prototype,"enabled",{get:function(){return this.c},set:function(a){!0===!!a?this.enable():this.Te()}});Object.defineProperty(U.prototype,"cursor",{get:function(){return this.$},set:function(a){this.L.dom.style.cursor=a;if(a!==this.L.dom.style.cursor||""===this.L.dom.style.cursor)this.L.dom.style.cursor="-webkit-"+a;this.$=a}});
Object.defineProperty(U.prototype,"onEnable",{get:function(){null===this.S&&(this.S=new q(this));return this.S}});Object.defineProperty(U.prototype,"onDisable",{get:function(){null===this.ba&&(this.ba=new q(this));return this.ba}});Object.defineProperty(U.prototype,"onTap",{get:function(){null===this.M&&(this.M=new q(this.L),this.M.onDestroy.ca(Hd(U.events.Cf,this.Xi,V.ka),this),Gd(this,U.events.Cf,this.Xi,V.ka));return this.M}});Object.defineProperty(U.prototype,"onClick",{get:function(){return this.onTap}});
Object.defineProperty(U.prototype,"onDoubleTap",{get:function(){null===this.o&&(this.o=new q(this.L),this.o.onDestroy.ca(Hd(U.events.Bd,this.vi,V.ka),this),Gd(this,U.events.Bd,this.vi,V.ka));return this.o}});Object.defineProperty(U.prototype,"onDoubleClick",{get:function(){return this.onDoubleTap}});Object.defineProperty(U.prototype,"onPressStart",{get:function(){null===this.J&&(this.J=new q(this.L),this.J.onDestroy.ca(Hd(U.events.wf,this.Eh,V.ka),this),Gd(this,U.events.wf,this.Eh,V.ka));return this.J}});
Object.defineProperty(U.prototype,"onDown",{get:function(){return this.onPressStart}});Object.defineProperty(U.prototype,"onPressEnd",{get:function(){null===this.I&&(this.I=new q(this.L),this.I.onDestroy.ca(Hd(U.events.vf,this.Dh,V.ka),this),Gd(this,U.events.vf,this.Dh,V.ka));return this.I}});Object.defineProperty(U.prototype,"onUp",{get:function(){return this.onPressEnd}});
Object.defineProperty(U.prototype,"onPanStart",{get:function(){null===this.H&&(this.H=new q(this.L),this.H.onDestroy.ca(Hd(U.events.qf,this.zh,V.ka),this),Gd(this,U.events.qf,this.zh,V.ka));return this.H}});Object.defineProperty(U.prototype,"onPanMove",{get:function(){null===this.G&&(this.G=new q(this.L),this.G.onDestroy.ca(Hd(U.events.pf,this.yh,V.ka),this),Gd(this,U.events.pf,this.yh,V.ka));return this.G}});
Object.defineProperty(U.prototype,"onPanEnd",{get:function(){null===this.C&&(this.C=new q(this.L),this.C.onDestroy.ca(Hd(U.events.nf,this.xh,V.ka),this),Gd(this,U.events.nf,this.xh,V.ka));return this.C}});Object.defineProperty(U.prototype,"onPinchStart",{get:function(){null===this.K&&(this.K=new q(this.L),this.K.onDestroy.ca(Hd(U.events.uf,this.Ch,V.ka),this),Gd(this,U.events.uf,this.Ch,V.ka));return this.K}});
Object.defineProperty(U.prototype,"onPinchMove",{get:function(){null===this.F&&(this.F=new q(this.L),this.F.onDestroy.ca(Hd(U.events.tf,this.Bh,V.ka),this),Gd(this,U.events.tf,this.Bh,V.ka));return this.F}});Object.defineProperty(U.prototype,"onPinchEnd",{get:function(){null===this.B&&(this.B=new q(this.L),this.B.onDestroy.ca(Hd(U.events.sf,this.Ah,V.ka),this),Gd(this,U.events.sf,this.Ah,V.ka));return this.B}});
Object.defineProperty(U.prototype,"onRotateStart",{get:function(){null===this.U&&(this.U=new q(this.L),this.U.onDestroy.ca(Hd(U.events.zf,this.Ri,V.ka),this),Gd(this,U.events.zf,this.Ri,V.ka));return this.U}});Object.defineProperty(U.prototype,"onRotateMove",{get:function(){null===this.R&&(this.R=new q(this.L),this.R.onDestroy.ca(Hd(U.events.yf,this.Qi,V.ka),this),Gd(this,U.events.yf,this.Qi,V.ka));return this.R}});
Object.defineProperty(U.prototype,"onRotateEnd",{get:function(){null===this.N&&(this.N=new q(this.L),this.N.onDestroy.ca(Hd(U.events.xf,this.Pi,V.ka),this),Gd(this,U.events.xf,this.Pi,V.ka));return this.N}});Object.defineProperty(U.prototype,"onSwipe",{get:function(){null===this.W&&(this.W=new q(this.L),this.W.onDestroy.ca(Hd(U.events.Bf,this.Vi,V.ka),this),Gd(this,U.events.Bf,this.Vi,V.ka));return this.W}});
Object.defineProperty(U.prototype,"onEnter",{get:function(){null===this.u&&(this.u=new q(this.L),this.u.onDestroy.ca(Hd(U.events.bf,this.yi,V.Ra),this),Gd(this,U.events.bf,this.yi,V.Ra));return this.u}});Object.defineProperty(U.prototype,"onLeave",{get:function(){null===this.A&&(this.A=new q(this.L),this.A.onDestroy.ca(Hd(U.events.jf,this.Ai,V.Ra),this),Gd(this,U.events.jf,this.Ai,V.Ra));return this.A}});
Object.defineProperty(U.prototype,"onOver",{get:function(){null===this.m&&(this.m=new q(this.L),this.m.onDestroy.ca(Hd(U.events.mf,this.Ji,V.Ra),this),Gd(this,U.events.mf,this.Ji,V.Ra));return this.m}});Object.defineProperty(U.prototype,"onOut",{get:function(){null===this.j&&(this.j=new q(this.L),this.j.onDestroy.ca(Hd(U.events.lf,this.Ii,V.Ra),this),Gd(this,U.events.lf,this.Ii,V.Ra));return this.j}});
Object.defineProperty(U.prototype,"onMove",{get:function(){null===this.f&&(this.f=new q(this.L),this.f.onDestroy.ca(Hd(U.events.kf,this.Di,V.Ra),this),Gd(this,U.events.kf,this.Di,V.Ra));return this.f}});Object.defineProperty(U.prototype,"onWheel",{get:function(){null===this.P&&(this.P=new q(this.L),this.P.onDestroy.ca(Hd(U.events.Ef,this.Fh,V.Ra),this),Gd(this,U.events.Ef,this.Fh,V.Ra));return this.P}});var V={Ra:0,ka:1};U.events={};U.events.Cf="tap";U.events.Bd="doubletap";U.events.wf="press";
U.events.vf="pressup";U.events.qf="panstart";U.events.pf="panmove";U.events.nf="panend";U.events.uf="pinchstart";U.events.tf="pinchmove";U.events.sf="pinchend";U.events.zf="rotatestart";U.events.yf="rotatemove";U.events.xf="rotateend";U.events.Bf="swipe";U.events.bf="mouseenter";U.events.jf="mouseleave";U.events.mf="mouseover";U.events.lf="mouseout";U.events.kf="mousemove";U.events.Ef="wheel";var Ed={DEFAULT:"default",Za:"pointer",El:"grab",Fl:"grabbing"};
function ga(a){this.i=a;this.Z=[];this.f=[];this.j=this.c=null;l.call(this,"DisplayList");this.c=this.jm.bind(this);document.addEventListener("fullscreenchange",this.c,!1);document.addEventListener("mozfullscreenchange",this.c,!1);document.addEventListener("webkitfullscreenchange",this.c,!1);document.addEventListener("MSFullscreenChange",this.c,!1)}ga.prototype=Object.create(l.prototype);e=ga.prototype;e.constructor=ga;
...
function Kd(a){a.log("_applyPending");a.W=!1;if(null!==a.xa&&0!==a.xa.length){a.ba=!0;for(var b=0,d=a.xa.length;b<d;b++)a[a.xa[b].prop]=a.xa[b].value;a.ba=!1;a.xa=[]}}e.gh=function(){this.c.style.display="block";this.ic()};e.Vj=function(){this.c.style.display="none";this.Td()};e.ko=function(){this.visible=!this.visible};
...
this.Ob=null),null!==this.Pb&&(this.Pb.destroy(),this.Pb=null),this.i=this.hb=this.c=null,l.prototype.destroy.call(this))};Object.defineProperty(T.prototype,"viewer",{get:function(){return this.i}});Object.defineProperty(T.prototype,"dom",{get:function(){return this.c}});Object.defineProperty(T.prototype,"id",{get:function(){return this.af},set:function(a){this.af=a;this.c.id=this.af}});Object.defineProperty(T.prototype,"ready",{get:function(){return this.ne}});
Object.defineProperty(T.prototype,"parent",{get:function(){return this.m},set:function(a){"object"===typeof a&&!1!==Array.isArray(a.children)&&a!==this.m&&(this.m=a,this.c.style.position="absolute",!0===this.R&&this.Ab(this.R),Md(this,"both"),Ld(this),null!==this.Mb&&this.Mb.D(),!0===this.m.ld()&&(this.Sd(),this.ic()))}});Object.defineProperty(T.prototype,"visible",{get:function(){return"block"===this.c.style.display},set:function(a){"boolean"===typeof a&&(!0===a?this.gh():this.Vj())}});
...
function t(a,b,d,g){this.f=[];this.M="undefined"!==typeof g?g:null;this.B=null;this.If=!1;this.fa="hidden";T.call(this,a,b,d||"DisplayObjectContainer")}t.prototype=Object.create(T.prototype);e=t.prototype;e.constructor=t;
...
e.Xb=function(a){if(a===this)throw"You can't add a $_DisplayObjectContainer to itself!";var b=a;a instanceof Element&&(b=new T(a));this.c.appendChild(b.dom);b.parent=this;a=this.f.push(b)-1;null===b.index&&(b.index=a)};e.pn=function(a,b){var d=a;a instanceof Element&&(d=new T(a));this.c.appendChild(d.dom);d.parent=this;this.f.splice(b,0,d);d.index=b;b=0;for(d=this.f.length;b<d;b++)a=this.f[b],a.index=b};
e.yj=function(){var a=this.f;if(0<a.length){this.If=!0;for(var b=0,d=a.length;b<d;b++)if(!0===a[b].ld()&&!0===a[b].visible){var g=Math.max(a[b].width+a[b].x,a[b].width+a[b].left,a[b].width+a[b].right),h=Math.max(a[b].height+a[b].y,a[b].height+a[b].top,a[b].height+a[b].bottom);g>this.pixelWidth&&(this.width=g);h>this.pixelHeight&&(this.height=h)}}null!==this.parent&&!0===B.T(this.parent,"DisplayObjectContainer")&&!0===this.parent.If&&this.parent.yj()};
e.removeChild=function(a,b){a=Od(this,a);-1!==a&&this.Ag(a,b)};e.Ag=function(a,b){if(0<=a&&a<this.f.length){var d=this.f[a];this.f.splice(a,1);this.c.removeChild(d.dom);"undefined"!==typeof b&&!0!==b||d.destroy();!0!==this.If||this.f.length||(this.height=this.width=0)}};e.eh=function(a){for(var b=this.f.length;b--;)this.Ag(b,a)};e.Kk=function(a){return-1!==Od(this,a)};e.destroy=function(){this.eh(!1);this.B=this.M=this.f=null;T.prototype.destroy.call(this)};
...
b!==this.oa&&(this.oa=b,!0===this.Kb&&(this.na=b,this.width=this.f.w*this.na)))),T.prototype.ta.call(this,a))};e.Kf=function(){this.F===Qd.CSS?this.c.style.backgroundPosition=-this.N+"px "+-this.N+"px":this.F===Qd.Jb&&(this.j.style.top=-this.N+"px",this.j.style.left=-this.N+"px");T.prototype.Kf.call(this)};e.Oe=function(){var a=this.M+"_"+this.i.i18n.locale;if(a!==this.sa&&(this.sa=a,!0===this.i.i18n.xb(this.ga))){var b=this.V.value;this.P=!1;this.i.load.image(a,b,this.Rd,this)}};
...
e.rm=function(a){"undefined"!==typeof a.data.frames?this.ea=a.data.frames:this.warn("No frames found in file!");this.la=!0;Ud(this)};function Ud(a){if(!0!==a.P&&!0===a.$&&!0===a.la){a.P=!0;var b;null!==a.f?b=a.f:null!==a.ea?b=a.ea[0].frame:b={x:0,y:0,w:a.B.naturalWidth,h:a.B.naturalHeight};Td(a,b);Ld(a);Kd(a);null!==a.J&&a.J.D()}}
...
this.fa&&"string"===typeof this.ga){this.V=new za(this.i,this.ga);!1===this.i.i18n.onLocaleChangeComplete.has(this.Oe,this)&&this.i.i18n.onLocaleChangeComplete.add(this.Oe,this);var d=this.i.i18n.locale;""!==d&&(a=this.M+"_"+d);!0===this.i.i18n.xb(this.ga)&&(b=this.V.value)}""!==b?(this.P=!1,this.i.load.image(a,b,this.Rd,this)):this.$=!0;"string"===typeof this.ma&&""!==this.ma?(a=this.ma,this.P=!1,this.i.load.json(this.M+"-frames",a,this.rm,this)):this.la=!0};
e.De=function(){this.c.style.backgroundImage="";this.B=null};
e.destroy=function(a){if(!1!==this.ib){null!==this.V&&(this.V.destroy(),this.V=null,this.i.i18n.onLocaleChangeComplete.remove(this.Oe,this));null!==this.S&&(this.S.destroy(),this.S=null);null!==this.J&&(this.J.destroy(),this.J=null);this.B=null;if("undefined"===typeof a||!0===a)if(!0===this.fa){a=this.i.i18n.locales;for(var b,d=0,g=a.length;d<g;d++)b=this.M+"_"+a[d],this.i.cache.remove(A.IMAGE,b)}else this.i.cache.remove(A.IMAGE,this.M);T.prototype.destroy.call(this)}};
...
e.Ea=function(){T.prototype.Ea.call(this);this.S=this.pm.bind(this);this.f=document.createElement("iframe");this.f.style.width="100%";this.f.style.height="100%";this.f.style.border=0;this.f.style.overflow="hidden";this.f.addEventListener("load",this.S,null!==this&&!!this);this.f.setAttribute("allowFullScreen","");this.c.appendChild(this.f);null!==this.V&&this.load(this.V);this.i.display.register(this);Jd(this);Kd(this)};
e.Ne=function(){this.log("_localeChangeComplete");!0===this.i.i18n.xb(this.B)&&Xd(this,this.J.value)};function Xd(a,b){a.log("_loadIframe url: "+b);a.P=!1;null!==a.I&&a.I.D();a.j=b;a.f.src=a.j}e.pm=function(){""!==this.j&&(this.log("_loadCompleteHandler url: "+this.j),this.P=!0,null!==this.F&&this.F.D())};function Yd(a){!1===a.i.i18n.onLocaleChangeComplete.has(a.Ne,a)&&a.i.i18n.onLocaleChangeComplete.add(a.Ne,a)}
...
e.destroy=function(){!1!==this.ib&&(null!==this.J&&(this.J.destroy(),this.J=null,this.i.i18n.onLocaleChangeComplete.remove(this.Ne,this)),null!==this.I&&(this.I.destroy(),this.I=null),null!==this.F&&(this.F.destroy(),this.F=null),this.S=this.f=null,T.prototype.destroy.call(this))};
...
e.Ea=function(){T.prototype.Ea.call(this);this.ma=this.dm.bind(this);this.la=this.Ol.bind(this);this.ia=this.Nl.bind(this);this.Fa=document.createElement("span");this.c.appendChild(this.Fa);"undefined"!==typeof this.fa&&null!==this.fa&&this.load(this.fa);this.i.display.register(this);Jd(this);Kd(this)};
...
function be(a){!1===a.i.i18n.onLocaleChangeComplete.has(a.We,a)&&a.i.i18n.onLocaleChangeComplete.add(a.We,a)}e.We=function(){this.log("_localeChangeComplete");!0===this.i.i18n.xb(this.F)&&(this.value=this.I.value)};
e.dm=function(){!0===this.M&&null===this.f&&(this.f=document.createElement("textarea"),this.f.style.position="absolute",this.f.style.top="0px",this.f.style.left="0px",this.f.style.width="100%",this.f.style.height="100%",this.f.style.resize="none",this.f.style.margin="0px",this.f.style.padding="0px",this.f.style.overflowX="hidden",this.f.style.overflowY="auto",this.f.style.boxSizing="border-box",this.f.value=this.V,this.f.addEventListener("input",this.la,!1),this.f.addEventListener("blur",this.ia,
!1),this.c.appendChild(this.f),this.f.focus())};e.Ol=function(){$d(this,this.f.value)};e.Nl=function(){this.Gf()};e.Gf=function(){null!==this.f&&(this.f.removeEventListener("input",this.la,!1),this.f.removeEventListener("blur",this.ia,!1),this.c.removeChild(this.f),this.f=null)};
...
this.value=a);!0===this.j&&"string"===typeof this.F&&""!==this.F&&(ae(this),be(this))};e.destroy=function(){!1!==this.ib&&(null!==this.I&&(this.I.destroy(),this.I=null,this.i.i18n.onLocaleChangeComplete.remove(this.We,this)),this.Gf(),null!==this.B&&(this.B.destroy(),this.B=null),null!==this.J&&(this.J.destroy(),this.J=null),T.prototype.destroy.call(this))};
...
e.constructor=od;
e.Ea=function(){t.prototype.Ea.call(this);this.I="out";this.J=new I(this.i);this.J.onLoadComplete.add(this.Pd,this);this.J.onResize.add(this.Qd,this);this.Xb(this.J);this.j=new S(this.i);this.j.onLoadComplete.add(this.Pd,this);this.j.onResize.add(this.Qd,this);this.j.autoWidth=!0;this.j.autoHeight=!0;this.Xb(this.j);this.pointer.enabled=!0;this.pointer.cursor=Ed.Za;this.pointer.onEnter.add(this.vm,this);this.pointer.onLeave.add(this.wm,this);this.pointer.onPressStart.add(this.Jk,this);this.pointer.onPressEnd.add(this.Ik,
this);this.i.display.register(this);Jd(this);Kd(this);this.i.i18n.onLocaleChangeComplete.add(this.Xg,this);this.load(this.ga)};e.vm=function(){ce(this,"over")};e.wm=function(){ce(this,"out")};e.Jk=function(){ce(this,"down")};e.Ik=function(){ce(this,"over")};e.Xg=function(){ce(this,this.I)};e.Pd=function(a){this.log("_itemLoadComplete "+a.emitter.className);this.ea++;2===this.ea&&(this.log("_allItemsLoaded"),de(this),ee(this))};e.Qd=function(){de(this);ee(this)};function fe(a,b){a.P=b;ce(a,a.I)}
...
e.Sj=function(a){return"undefined"!==typeof this.F[a]};e.lo=function(){this.F[this.P].Gg("out");fe(this,this.P)};
...
e.Ea=function(){T.prototype.Ea.call(this);!0===this.Bb&&!1===oe(this)&&(this.log("$_VideoHTML5: can't manage ambisonic sound without Google Chrome Omnitone library and WebAudio API."),this.Bb=!1);this.O=this.Rc;ba(this);this.S=this.Mm.bind(this);this.tb=this.Nm.bind(this);this.vb=this.Pm.bind(this);this.ub=this.Om.bind(this);this.sb=this.Lm.bind(this);this.wb=this.Qm.bind(this);this.rb=this.Km.bind(this);this.Fb=this.Rm.bind(this);this.j=this.Bm.bind(this);this.Pa=this.i.clock.create(!1);this.gb=
this.i.clock.create(!1);this.gb.Xe(500,this.Ml,this);this.i.audio.onVolumeChange.add(this.Vh,this);this.i.audio.onDisable.add(this.Uh,this);this.V=new q(this,!0);null!==this.ac&&this.load(this.ac);this.i.display.register(this,oe(this));Jd(this);Kd(this)};e.ta=function(a){var b=pe(this);null!==b&&null!==b.element&&(b.element.setAttribute("width",this.pixelWidth),b.element.setAttribute("height",this.pixelHeight));T.prototype.ta.call(this,a)};
...
k;d.lastTimeStamp=0;d.requestCount++;g=a.F[a.B];-1<a.I&&(d.element.addEventListener("loadstart",a.tb,!1),d.element.addEventListener("error",a.S,!1));h=document.createElement("source");h.addEventListener("error",a.S,!1);h.src=g.url;h.type=g.mimeType;d.element.appendChild(h);a.ec=a.ui.bind(a);!0===oe(a)?(a.f=a.i.audio.context,a.Eb=Omnitone.createFOADecoder(a.f,d.element,{channelMap:a.Ic}),a.dc=a.fm.bind(a),a.Eb.initialize().then(a.ec,a.dc)):a.ui();-1===a.I?(a.log("No current video, set directly the current index"),
ye(a,b)):(a.Pa.add(2E4,a.cn,a),a.Pa.start())}}e.ui=function(){-1===this.B?pe(this).element.load():se(this).element.load()};e.fm=function(){this.log("FOA decoder could not be initialized")};e.Nm=function(){var a=se(this).element;this.log("_onRequestLoadStart [readyState: "+a.readyState+"]");a.removeEventListener("loadstart",this.tb,!1);a.addEventListener("loadedmetadata",this.vb,!1)};
e.Pm=function(){var a=se(this).element;this.log("_onRequestLoadedMetaData [readyState: "+a.readyState+"]");a.removeEventListener("loadedmetadata",this.vb,!1);a.addEventListener("loadeddata",this.ub,!1)};e.Om=function(){var a=se(this).element;this.log("_onRequestLoadedData [readyState: "+a.readyState+"]");a.removeEventListener("loadeddata",this.ub,!1);!0===N.Dc?(a.addEventListener("play",this.sb,!1),a.play()):ye(this,this.B,!0)};
e.Lm=function(){var a=se(this).element;this.log("_onRequestCanPlayBeforeSeek [readyState: "+a.readyState+"]");a.pause();a.removeEventListener("play",this.sb,!1);a.addEventListener("seeked",this.wb,!1);var b=this.currentTime;a.currentTime=!0===this.P&&!1===this.qb?b+6:b};
e.Qm=function(){var a=se(this).element;this.log("_onRequestSeeked [readyState: "+a.readyState+"]");a.removeEventListener("seeked",this.wb,!1);4===a.readyState?(a.removeEventListener("error",this.S,!1),ze(this)):a.addEventListener("canplay",this.rb,!1)};e.Km=function(){var a=se(this).element;this.log("_onRequestCanPlayAfterSeek [readyState: "+a.readyState+"]");a.removeEventListener("canplay",this.rb,!1);a.removeEventListener("error",this.S,!1);ze(this)};
function ze(a){var b=pe(a);null!==b&&null!==b.element&&!1===a.qb&&(a.log("Current video listen to seek, wait both video to sync"),b.element.addEventListener("seeked",a.Fb,!1),a.Pa.Xe(10,a.ln,a));for(var b=se(a).element,d,g=0,h=b.children.length;g<h;g++)d=b.children[g],d.removeEventListener("error",a.S,!1);!0===a.qb&&ye(a,a.B)}e.Rm=function(){this.log("_onRequestSeekedWhileSync "+this.currentTime);var a=this.B;Ae(this,!1);ve(this,a)};
e.ln=function(){this.log("_videoSyncTimerLoop "+this.B);var a=se(this);null!==a&&this.currentTime>=a.element.currentTime&&this.currentTime<a.element.currentTime+.05&&ye(this,this.B)};e.cn=function(){this.log("_requestTimeOutHandler");Ae(this,!0)};e.Mm=function(a){this.log("_onRequestError");this.log(a);Ae(this,!0)};
...
e.Bm=function(a){var b=pe(this).element;this.log(a.type+" [readyState: "+b.readyState+"]");switch(a.type){case "loadstart":null!==this.la&&this.la.D(a);break;case "durationchange":null!==this.fa&&1===b.readyState&&this.fa.D(a);break;case "loadedmetadata":this.rc=!0;null!==this.pa&&this.pa.D(a);break;case "loadeddata":null!==this.ma&&this.ma.D(a);break;case "progress":null!==this.Aa&&this.Aa.D(a);break;case "canplay":this.Db=!0;null!==this.$&&this.$.D(a);break;case "canplaythrough":this.Db=!0;null!==
...
function J(a,b,d,g){this.i=a;this.Jl=b;this.Qc=d||null;this.Sa="";this.Fa=null;this.Il=g||ne.Hb;this.Oa="";this.j=null;this.Rc=!1;this.Ka=1;this.Ca=!1;this.hi=0;this.ei=!1;this.Xa=this.f=null;this.ef=this.df=this.Ha=this.Pa=0;this.gb=this.Aa=this.tc=this.Ic=null;this.fb=this.Da=!1;this.di=this.ii=0;this.Bb=this.gf=this.bc=this.dc=this.Fb=this.qc=this.La=this.tb=this.ec=this.sc=this.rc=this.Db=this.Eb=this.rb=this.qb=this.sb=this.ac=this.vb=this.wb=this.ub=this.Ba=this.ma=this.B=this.Ja=this.la=this.pa=
...
e.Ea=function(){T.prototype.Ea.call(this);if("undefined"===typeof dashjs)throw"$_VideoDash._boot: Can't create MPEG-DASH video stream without dash.js Media Player.";this.O=this.Jl;ba(this);this.ub=this.Dm.bind(this);this.sb=this.zm.bind(this);this.wb=this.wl.bind(this);this.vb=this.Em.bind(this);this.ac=this.Hm.bind(this);this.qb=this.ym.bind(this);this.rb=this.ul.bind(this);this.Eb=this.yl.bind(this);this.Db=this.xl.bind(this);this.rc=this.Wm.bind(this);this.sc=this.an.bind(this);this.ec=this.Tm.bind(this);
this.tb=this.vl.bind(this);this.La=this.Am.bind(this);this.qc=this.Um.bind(this);this.Fb=this.Gm.bind(this);this.dc=this.Jm.bind(this);this.bc=this.Im.bind(this);this.gf=this.Vm.bind(this);this.Bb=this.Fm.bind(this);this.i.audio.onVolumeChange.add(this.Sh,this);this.i.audio.onDisable.add(this.Rh,this);this.B=new q(this,!0);null!==this.Qc&&this.load(this.Qc);this.i.display.register(this);Jd(this);Kd(this)};
...
function Ge(a,b,d,g){if(null!==d&&null!==g){var h=a.Xa.index,k,n,v,x,E,Bb;k=g.getCurrentRepresentationSwitch(d);null!==k&&(n=Math.round(g.getBandwidthForRepresentation(k.to,h)/1E3));if(isNaN(n)||void 0===n)n=0;b===Ee.VIDEO?(v=a.Pa+1,x=a.Ha+1):b===Ee.AUDIO&&(v=a.df+1,x=a.ef+1);if(isNaN(v)||void 0===v)v=0;if(isNaN(x)||void 0===x)x=0;a=g.getMaxIndexForBufferType(b,h);if(isNaN(a)||void 0===a)a=0;b=g.getCurrentBufferLevel(d);null!==b&&(E=b.toPrecision(5));if(isNaN(E)||void 0===E)E=0;d=g.getCurrentDroppedFrames(d);
null!==d&&(Bb=d.droppedFrames);return{bitrate:n,index:v,mk:x,gk:a,jj:E,droppedFrames:Bb}}return null}e.Im=function(a){this.log("onQualityChange [readyState: "+this.j.element.readyState+"]");a.mediaType===Ee.AUDIO?this.ef=this.df=a.newQuality:a.mediaType===Ee.VIDEO&&(this.Ha=this.Pa=a.newQuality,null!==this.la&&this.la.D(this.Ha))};
e.Jm=function(a){this.log("onQualityRequest [readyState: "+this.j.element.readyState+"]");a.mediaType===Ee.AUDIO?(this.df=a.oldQuality,this.ef=a.newQuality):a.mediaType===Ee.VIDEO&&(this.Pa=a.oldQuality,this.Ha=a.newQuality,null!==this.pa&&this.pa.D(this.Ha))};e.zm=function(a){var b=this.j.element;this.log("onDurationChange [readyState: "+b.readyState+"]");null!==this.J&&1===b.readyState&&this.J.D(a)};
e.wl=function(a){this.log("onLoadedMetaData [readyState: "+this.j.element.readyState+"]");this.ei=!0;null!==this.$&&this.$.D(a)};e.Em=function(a){this.log("onLoadedData [readyState: "+this.j.element.readyState+"]");null!==this.V&&this.V.D(a)};e.Hm=function(a){null!==this.ia&&this.ia.D(a)};e.ym=function(a){this.log("onCanPlay [readyState: "+this.j.element.readyState+"]");this.fb=!0;null!==this.F&&this.F.D(a)};
e.ul=function(a){this.log("onCanPlayThrough [readyState: "+this.j.element.readyState+"]");this.fb=!0;null!==this.I&&this.I.D(a)};e.yl=function(a){this.log("onPlay [readyState: "+this.j.element.readyState+"]");null!==this.fa&&this.fa.D(a)};e.xl=function(a){this.log("onPause [readyState: "+this.j.element.readyState+"]");this.Da=!1;null!==this.ea&&this.ea.D(a)};e.Wm=function(a){null!==this.sa&&this.sa.D(a)};
e.an=function(a){var b=this.j.element;this.log("onVolumeChange [readyState: "+b.readyState+"]");null!==this.za&&0!==b.readyState&&this.za.D(a)};e.Tm=function(a){this.log("onSeeked [readyState: "+this.j.element.readyState+"]");this.fb=!1;null!==this.qa&&this.qa.D(a)};e.vl=function(a){this.log("onEnded [readyState: "+this.j.element.readyState+"]");this.Da=!1;this.di++;!0===this.Rc&&this.play();null!==this.M&&this.M.D(a)};
e.Am=function(a){this.log("onError [readyState: "+this.j.element.readyState+"]");null!==this.P&&this.P.D(a)};e.Um=function(a){this.log("onStalled [readyState: "+this.j.element.readyState+"]");null!==this.ra&&this.ra.D(a)};e.Gm=function(a){this.log("onPlaying [readyState: "+this.j.element.readyState+"]");null!==this.ga&&this.ga.D(a)};e.Rh=function(){var a=this.j;null!==a&&null!==a.element&&!1===this.i.audio.enabled&&this.f.setVolume(0)};e.Sh=function(){He(this)};
...
this.bc),this.f.on(dashjs.MediaPlayer.events.QUALITY_CHANGE_REQUESTED,this.dc),this.f.on(dashjs.MediaPlayer.events.STREAM_INITIALIZED,this.ub),this.f.on(dashjs.MediaPlayer.events.PLAYBACK_PLAYING,this.Fb),this.f.on(dashjs.MediaPlayer.events.BUFFER_EMPTY,this.qc),this.f.on(dashjs.MediaPlayer.events.PERIOD_SWITCH_COMPLETED,this.gf),this.f.on(dashjs.MediaPlayer.events.METRIC_CHANGED,this.Bb),this.j.element.addEventListener("loadeddata",this.vb,!1),this.j.element.addEventListener("durationchange",this.sb,
!1),this.j.element.addEventListener("canplaythrough",this.rb,!1),this.j.element.addEventListener("volumechange",this.sc,!1),this.c.innerHTML="",this.c.appendChild(this.j.element));""===this.Oa&&Je(this,this.Il)};e.play=function(a,b){this.currentTime=a;this.loop=b;null!==this.f&&!0===this.f.isReady()&&(this.f.play(),this.Da=!0,this.ii++)};e.pause=function(){null!==this.f&&!0===this.f.isReady()&&(this.f.pause(),this.Da=!1)};
e.stop=function(){null!==this.f&&!0===this.f.isReady()&&(this.f.pause(),this.f.seek(0),this.j.element.currentTime=0,this.Da=!1)};e.Al=function(){!0===this.Da||!1===this.i.audio.enabled?this.pause():this.play()};e.bb=function(){!0!==this.Ca&&!1!==this.i.audio.enabled&&(this.Ca=!0,this.hi=this.Ka,this.Ka=0,He(this))};e.Th=function(a){!1!==this.Ca&&(a="number"===typeof a?a:this.hi,this.Ca=!1,this.Ka=G.X(a,0,1),He(this))};e.zl=function(a){null!==this.f&&!0===this.f.isReady()&&this.f.enableBufferOccupancyABR(a)};
...
e.add=function(a,b,d){var g;(g="string"!==typeof b||""===b)||(g=Oe(this,a),g=!0===(!0===Qe(a,b)&&!0===g.has(b)));g&&(b=Pe(this,a,a+"-cache"));return!1===this.has(b,a)&&(a=Oe(this,a),null!==a)?(a.set(b,d),!0):!1};e.remove=function(a,b){return!0===this.has(a,b)&&(a=Oe(this,a),null!==a)?(a.Pe(b),!0):!1};e.destroy=function(){this.c=this.f=this.O=this.i=null};function Re(){}e=Re.prototype;e.key="";e.url="";e.type="";e.data=null;e.no=null;e.zb=!1;e.Mk=!1;e.Lk="";e.constructor=Re;
function wa(a){this.i=a;l.call(this,"Loader")}wa.prototype=Object.create(l.prototype);e=wa.prototype;e.constructor=wa;e.json=function(a,b,d,g,h,k){var n=new Re;n.type="json";n.key=a;n.url=b;n.c=d;n.f=g;n.O=h;n.j=k;Se(this,n,"text",this.lm,this.mm)};
e.lm=function(a,b){if(b.responseText){if(a.data=Object(JSON.parse(b.responseText)),!1===this.i.cache.has(A.JSON,a.key)?this.i.cache.add(A.JSON,a.key,a):this.log("$_Loader.json : JSON file already exists"),"function"===typeof a.c&&null!==a.f){b=a.c;var d=a.f;a.c=null;a.f=null;a.O=null;a.j=null;b.call(d,a)}}else throw"$_Loader.json : JSON file empty ?";};
e.mm=function(a,b){if(b.responseText){if("function"===typeof a.O&&null!==a.j){b=a.O;var d=a.j;a.c=null;a.f=null;a.O=null;a.j=null;b.call(d,a)}}else throw"$_Loader.json : JSON file empty ?";};e.Sk=function(a,b,d,g,h,k){h=new Re;h.type="xml";h.key=a;h.url=b;h.c=d;h.f=g;h.O=d;h.j=k;Se(this,h,"document",this.mn,this.nn)};
e.mn=function(a,b){if(b.responseXML){if(a.data=b.responseXML,!1===this.i.cache.has(A.Tb,a.key)?this.i.cache.add(A.Tb,a.key,a):this.log("$_Loader.xml : XML file already exists"),"function"===typeof a.c&&null!==a.f){b=a.c;var d=a.f;a.c=null;a.f=null;a.O=null;a.j=null;b.call(d,a)}}else throw"$_Loader.xml : XML file empty ?";};
e.nn=function(a,b){if(b.responseXML){if("function"===typeof a.O&&null!==a.j){b=a.O;var d=a.j;a.c=null;a.f=null;a.O=null;a.j=null;b.call(d,a)}}else throw"$_Loader.xml : JSON file empty ?";};e.sound=function(a,b,d,g,h){var k=new Re;k.type="sound";k.key=a;k.url=b;k.c=d;k.f=g;!0===this.i.audio.useWebAudio&&!0!==h?Se(this,k,"arraybuffer",this.Ui):!0!==this.i.audio.useAudioTag&&!0!==h||Te(k,this.Ui,this)};
...
Object.defineProperty(ja.prototype,"onAllScriptsLoaded",{get:function(){null===this.c&&(this.c=new q(this));return this.c}});function ka(a){this.i=a;this.f=0;this.c=null;l.call(this,"Clock");this.f=Date.now();this.c=[]}ka.prototype=Object.create(l.prototype);e=ka.prototype;e.constructor=ka;e.Xm=function(a){a:{if(null!==this.c)for(var b,d=0,g=this.c.length;d<g;d++)if(b=this.c[d],b===a.emitter){a=d;break a}a=-1}-1!==a&&this.c.splice(a,1)};e.create=function(a){return this.add(new X(this.i,a))};
e.add=function(a){this.c.push(a);a.onDestroy.add(this.Xm,this);return a};e.update=function(){this.f=Date.now();for(var a=0,b=this.c.length;a<b;a++)this.c[a].update(this.f)};e.destroy=function(){this.i=null;for(var a=this.c.length;a--;)this.c[a].destroy();this.c=null};Object.defineProperty(ka.prototype,"time",{get:function(){return this.f}});
function X(a,b){this.i=a;this.J="undefined"!==typeof b?b:!0;this.B=0;this.j=!1;this.K=this.I=0;this.m=!1;this.f=0;this.F=!1;this.u=this.H=this.C=this.A=this.G=this.c=null;l.call(this,"Timer");this.c=[];this.f=Date.now()}X.prototype=Object.create(l.prototype);e=X.prototype;e.constructor=X;function Ue(a,b){for(var d=0;d<a.c.length;d++){var g=a.c[d];if(!1===g.f){var h=g.c-b;0>h&&(h=0);g.c=a.f+h}}b=a.o-b;a.o=0>b?a.f:a.f+b}function Ve(a){0<a.c.length&&(a.c.sort(a.gn),a.o=a.c[0].c)}
e.gn=function(a,b){return a.c<b.c?-1:a.c>b.c?1:0};e.create=function(a,b,d,g,h,k){var n=a=Math.round(a);this.f?n+=this.f:n+=this.i.clock.time;a=new We(0,a,n,d,b,g,h,k);this.c.push(a);Ve(this);this.F=!1;return a};e.add=function(a,b,d,g){return this.create(a,!1,0,b,d,Array.prototype.splice.call(arguments,3))};e.tl=function(a,b,d,g){return this.create(a,!1,b,d,g,Array.prototype.splice.call(arguments,4))};e.Xe=function(a,b,d){return this.create(a,!0,0,b,d,Array.prototype.splice.call(arguments,3))};
...
We.prototype.yb=function(){this.m.apply(this.o,this.j)};function xa(a){this.i=a;this.c=[];l.call(this,"TweenManager")}xa.prototype=Object.create(l.prototype);e=xa.prototype;e.constructor=xa;e.kn=function(a){this.remove(a.emitter)};e.add=function(a){this.c.push(a);a.onDestroy.ca(this.kn,this)};e.remove=function(a){a:{for(var b=0,d=this.c.length;b<d;b++)if(a===this.c[b]){a=b;break a}a=-1}-1!==a&&this.c.splice(a,1)};e.update=function(){for(var a=0,b=this.c.length;a<b;a++)this.c[a].update()};
...
e.Ye=function(a,b,d){null===this.f&&(this.f={});for(var g in a)this.f[g]={name:g,min:null,max:a[g],duration:"number"===typeof b?b:0,easing:"function"===typeof d?d:null,started:!1,complete:!1,startTime:null};return this};e.start=function(){this.H=Date.now();this.B=!0;this.A=this.G=!1;var a,b;for(b in this.f)a=this.f[b],a.min=this.C[b],a.max="string"===typeof this.f[b].max?a.min+parseInt(this.f[b].max,10):a.max,a.started=!0,a.startTime=this.H;null!==this.o&&this.o.D();return this};
...
!0);return d},clone:function(a){if(!(a instanceof Object))return a;var b=new a.constructor,d;for(d in a)b[d]=B.clone(a[d]);return b},Pn:function(a){return null!==a&&"object"===typeof a&&"string"===typeof a.className&&-1!==Id.indexOf(a.className)?!0:!1},T:function(a,b){if("string"===typeof b&&(null!==a&&"object"===typeof a&&"string"===typeof a.className&&a.className.toLowerCase()===b.toLowerCase()||typeof a===b.toLowerCase()))return!0;if(!0===Array.isArray(b)&&!0===B.Ga(b,"string"))for(var d=0,g=b.length;d<
g;d++)if(!0===B.T(a,b[d]))return!0;return!1},Sn:function(a,b,d){b=b.split(".");for(var g=0,h=b.length;g<h;g++){a=a[b[g]];if(g===h-1)return B.T(a,d);if("undefined"===typeof a)break}return!1},Ga:function(a,b){if("object"===typeof a&&!0===Array.isArray(a)){for(var d=0,g=a.length;d<g;d++)if(!1===B.T(a[d],b))return!1;return!0}return!1},he:function(a,b,d){b=b.split(".");for(var g=0,h=b.length;g<h;g++){a=a[b[g]];if("undefined"===typeof a)break;if(g===h-1)return a}return d},qd:function(a,b){var d=b.split("."),
g=d.length;a.sort(function(a,b){for(var h=0;h<g;)a=a[d[h]],b=b[d[h]],h++;return a<b?-1:a>b?1:0});return a},od:function(a){a=a.slice();for(var b,d,g=a.length-1;0<g;g--)d=~~(Math.random()*(g+1)),b=a[g],a[g]=a[d],a[d]=b;return a},pe:function(a,b,d){for(a=String(a);a.length<d;)a=b+a;return a},lk:function(a){a={input:a,hours:0,minutes:0,seconds:0};if("number"!==typeof a.input||isNaN(a.input))return a;a.Mn=parseInt(a.input/3600,10)%24;a.Un=parseInt(a.input/60,10)%60;a.seconds=parseInt(a.input%60,10);return a},
yn:function(a,b){a=B.lk(a);var d="string"===typeof b?b:"H:M:S";b=0;-1!==d.indexOf("H")?b=2:-1!==d.indexOf("h")&&(b=1);var g=0;-1!==d.indexOf("M")?g=2:-1!==d.indexOf("m")&&(g=1);var h=0;-1!==d.indexOf("S")?h=2:-1!==d.indexOf("s")&&(h=1);d=d.toLowerCase();0<b&&(d=d.replace("h",B.pe(a.Mn,0,b)));0<g&&(d=d.replace("m",B.pe(a.Un,0,g)));0<h&&(d=d.replace("s",B.pe(a.seconds,0,h)));return d},Ce:function(a,b,d){return new THREE.Spherical(a,Math.PI/2-d,b)},Bn:function(a){return{radius:a.radius,theta:a.theta,
phi:Math.PI/2-a.phi}},ij:function(a,b){return a.filter(function(a){return 0>b.indexOf(a)})},Xn:function(a,b){return b>=a.length?null:a.splice(b,1)},endsWith:function(a,b){return"function"!==typeof String.prototype.endsWith?-1!==a.indexOf(b,a.length-b.length):a.endsWith(b)}},ha={fd:function(a,b){var d=window.getComputedStyle(a,null).getPropertyValue("display");a.style.display="none";b=window.getComputedStyle(a,null).getPropertyValue(b);a.style.display=d;return b},Nj:function(a){a=ha.fd(a,"width");
var b="px";-1<a.indexOf("%")&&(b="%");-1<a.indexOf("px")&&(b="px");return b},Pj:function(a){a=parseInt(ha.fd(a,"width"),10);return isNaN(a)?0:a},Mj:function(a){a=ha.fd(a,"height");var b="px";-1<a.indexOf("%")&&(b="%");-1<a.indexOf("px")&&(b="px");return b},Oj:function(a){a=parseInt(ha.fd(a,"height"),10);return isNaN(a)?0:a},has:function(a){return document.body.contains(a)},mg:function(a){return a instanceof HTMLElement},En:function(a){var b,d;d=["MouseEvent","PointerEvent","TouchEvent"];"object"===
...
e.Pe=function(a){if("undefined"!==typeof a&&void 0!==this.c[a])return delete this.c[a],--this.f};e.get=function(a){return this.c[a]};e.Vk=function(){var a=new md,b;for(b in this.c)a.add(b);return a.Ae()};e.Wk=function(){var a=new md,b;for(b in this.c)a.add(this.c[b]);return a.Ae()};e.Uk=function(){var a=new md,b;for(b in this.c){var d=[];d.push(b);d.push(this.c[b]);a.add(d)}return a.Ae()};e.Tk=function(){for(var a in this.c)this.Pe(a)};e.has=function(a){return 0<this.f&&void 0!==this.c[a]};
...
var Z={Zn:function(a,b,d){a/=255;b/=255;d/=255;var g=Math.max(a,b,d),h=Math.min(a,b,d),k,n=(g+h)/2;if(g===h)k=h=0;else{var v=g-h,h=.5<n?v/(2-g-h):v/(g+h);switch(g){case a:k=(b-d)/v+(b<d?6:0);break;case b:k=(d-a)/v+2;break;case d:k=(a-b)/v+4}k/=6}return{h:k,s:h,l:n}},Nn:function(a,b,d){if(b){var g=.5>d?d*(1+b):d+b-d*b,h=2*d-g;d=Z.ke(h,g,a+1/3);b=Z.ke(h,g,a);a=Z.ke(h,g,a-1/3)}else d=b=a=d;return{r:255*d,g:255*b,b:255*a}},ke:function(a,b,d){if(!(0>d||1<d)){if(d<1/6)return a+6*(b-a)*d;if(.5>d)return b;
if(d<2/3)return a+(b-a)*(2/3-d)*6}return a},$n:function(a,b,d){a/=255;b/=255;d/=255;var g=Math.max(a,b,d),h=Math.min(a,b,d),k,n=g-h;if(g===h)k=0;else{switch(g){case a:k=(b-d)/n+(b<d?6:0);break;case b:k=(d-a)/n+2;break;case d:k=(a-b)/n+4}k/=6}return{h:k,s:g?n/g:0,v:g}},On:function(a,b,d){var g,h,k,n=Math.floor(6*a),v=6*a-n;a=d*(1-b);var x=d*(1-v*b);b=d*(1-(1-v)*b);switch(n%6){case 0:g=d;h=b;k=a;break;case 1:g=x;h=d;k=a;break;case 2:g=a;h=d;k=b;break;case 3:g=a;h=x;k=d;break;case 4:g=b;h=a;k=d;break;
case 5:g=d,h=a,k=x}return{r:255*g,g:255*h,b:255*k}},$d:function(a){a=a.toString(16);return 1===a.length?"0"+a:a},Yn:function(a,b,d){return"#"+Z.$d(a)+Z.$d(b)+Z.$d(d)},zn:function(a){a=a.split("(")[1].split(")")[0].split(",");var b={r:parseInt(a[0],10),g:parseInt(a[1],10),b:parseInt(a[2],10)};3<a.length&&(b.a=parseInt(a[3],10));return b},Ln:function(a){a=a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(a,d,g,h){return d+d+g+g+h+h});return(a=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(a))?
{r:parseInt(a[1],16),g:parseInt(a[2],16),b:parseInt(a[3],16)}:null},ao:function(a){a=new THREE.Vector3(a.r,a.g,a.b);var b=(new THREE.Matrix3).set(.299,.587,.114,-.169,-.331,.5,.5,-.419,-.081),d=new THREE.Vector3(0,128,128);a.applyMatrix3(b).add(d);return{Y:a.x,Cr:a.y,Cb:a.z}},po:function(a){a=new THREE.Vector3(a.Y,a.Cr,a.Cb);var b=new THREE.Vector3(0,-128,-128),d=(new THREE.Matrix3).set(1,0,1.4,1,-.343,-.711,1,1.765,0);a.add(b).applyMatrix3(d);return{r:a.x,g:a.y,b:a.z}},oo:function(a,b){var d=G.da(b);
...
r.prototype.destroy=r.prototype.destroy;w.prototype.boot=w.prototype.boot;w.prototype.load=w.prototype.load;w.prototype.hasScenes=w.prototype.ql;w.prototype.hasGroups=w.prototype.mc;w.prototype.nextScene=w.prototype.rl;w.prototype.previousScene=w.prototype.sl;w.prototype.notifySceneConfigLoadComplete=w.prototype.jk;w.prototype.loadScene=w.prototype.md;w.prototype.loadGroup=w.prototype.dk;w.prototype.destroy=w.prototype.destroy;D.prototype.load=D.prototype.load;D.prototype.hasChild=D.prototype.Ie;
D.prototype.hasScene=D.prototype.Ec;D.prototype.hasGroup=D.prototype.gd;D.prototype.hasChildren=D.prototype.Hn;D.prototype.hasTypeOfChild=D.prototype.hg;D.prototype.hasScenes=D.prototype.Je;D.prototype.hasGroups=D.prototype.mc;D.prototype.getChildrenUids=D.prototype.ed;D.prototype.getChildren=D.prototype.ee;D.prototype.nextScene=D.prototype.Nk;D.prototype.previousScene=D.prototype.Ok;D.prototype.destroy=D.prototype.destroy;C.prototype.addConfig=C.prototype.ha;C.prototype.load=C.prototype.load;
...
y.prototype.worldToScreen=y.prototype.worldToScreen;y.prototype.enableVR=y.prototype.nl;y.prototype.setView=y.prototype.oc;y.prototype.destroy=y.prototype.destroy;ab.prototype.setSize=ab.prototype.setSize;ab.prototype.destroy=ab.prototype.destroy;Sa.prototype.enablePicking=Sa.prototype.ag;Sa.prototype.addBackground=Sa.prototype.bj;Sa.prototype.addRenderScenes=Sa.prototype.dj;Sa.prototype.addGlobalFx=Sa.prototype.cj;Sa.prototype.getShaderPassByUID=Sa.prototype.Fn;Sa.prototype.setSize=Sa.prototype.setSize;
Sa.prototype.render=Sa.prototype.render;Sa.prototype.clear=Sa.prototype.Ve;Sa.prototype.destroy=Sa.prototype.destroy;Qa.prototype.enableVR=Qa.prototype.Hh;Qa.prototype.getQuaternionFromPose=Qa.prototype.Hj;Qa.prototype.getRenderParams=Qa.prototype.Jj;Qa.prototype.setSize=Qa.prototype.setSize;Qa.prototype.submitFrame=Qa.prototype.Ih;Qa.prototype.destroy=Qa.prototype.destroy;rb.prototype.updateAfterViewChange=rb.prototype.fc;rb.prototype.setSize=rb.prototype.setSize;rb.prototype.render=rb.prototype.render;
...
$a.prototype.destroy=$a.prototype.destroy;Za.prototype.shaderSTW=Za.prototype.Gc;Za.prototype.shaderWTS=Za.prototype.cc;Za.prototype.updateScreenToWorld=Za.prototype.pc;Za.prototype.worldToScreen=Za.prototype.worldToScreen;Za.prototype.screenToWorld=Za.prototype.screenToWorld;Za.prototype.destroy=Za.prototype.destroy;xb.prototype.hasKeyframes=xb.prototype.In;xb.prototype.addKeyframe=xb.prototype.lb;xb.prototype.getKeyframes=xb.prototype.Dn;xb.prototype.getKeyframesIndexes=xb.prototype.ge;
xb.prototype.getSideKeyframes=xb.prototype.Kj;xb.prototype.getSideKeyframesIndexes=xb.prototype.Lj;xb.prototype.emptyKeyframes=xb.prototype.xn;xb.prototype.destroy=xb.prototype.destroy;zb.prototype.play=zb.prototype.play;zb.prototype.stop=zb.prototype.stop;zb.prototype.resume=zb.prototype.resume;zb.prototype.destroy=zb.prototype.destroy;Eb.prototype.stop=Eb.prototype.stop;Eb.prototype.resume=Eb.prototype.resume;Eb.prototype.destroy=Eb.prototype.destroy;Hb.prototype.destroy=Hb.prototype.destroy;
Ib.prototype.click=Ib.prototype.click;Ib.prototype.over=Ib.prototype.Re;Ib.prototype.out=Ib.prototype.rd;Ib.prototype.destroy=Ib.prototype.destroy;Ra.prototype.register=Ra.prototype.register;Ra.prototype.unregister=Ra.prototype.unregister;Ra.prototype.createRenderScenes=Ra.prototype.mj;Ra.prototype.getRaycastable=Ra.prototype.Ij;Ra.prototype.getByMesh=Ra.prototype.Fj;Ra.prototype.clear=Ra.prototype.Se;Ra.prototype.destroy=Ra.prototype.destroy;Mb.prototype.start=Mb.prototype.start;
Mb.prototype.stop=Mb.prototype.stop;Mb.prototype.click=Mb.prototype.click;Mb.prototype.clear=Mb.prototype.Gh;Qb.prototype.start=Qb.prototype.start;Qb.prototype.stop=Qb.prototype.stop;Qb.prototype.click=Qb.prototype.click;Qb.prototype.setSize=Qb.prototype.setSize;Qb.prototype.clear=Qb.prototype.qh;Qb.prototype.destroy=Qb.prototype.destroy;Pa.prototype.updateForViewType=Pa.prototype.Ck;Pa.prototype.clear=Pa.prototype.rh;Pa.prototype.setSize=Pa.prototype.setSize;Pa.prototype.click=Pa.prototype.click;
Pa.prototype.start=Pa.prototype.start;Pa.prototype.stop=Pa.prototype.stop;Pa.prototype.destroy=Pa.prototype.destroy;qa.prototype.boot=qa.prototype.boot;qa.prototype.getByType=qa.prototype.Cn;qa.prototype.addConfig=qa.prototype.ha;qa.prototype.addTracks=qa.prototype.ej;qa.prototype.update=qa.prototype.update;qa.prototype.clear=qa.prototype.Le;qa.prototype.destroy=qa.prototype.destroy;Ub.prototype.update=Ub.prototype.update;Ub.prototype.destroy=Ub.prototype.destroy;$b.prototype.load=$b.prototype.load;
$b.prototype.update=$b.prototype.update;$b.prototype.destroy=$b.prototype.destroy;Yb.prototype.load=Yb.prototype.load;Yb.prototype.update=Yb.prototype.update;Yb.prototype.destroy=Yb.prototype.destroy;Wb.prototype.load=Wb.prototype.load;Wb.prototype.destroy=Wb.prototype.destroy;Xb.prototype.load=Xb.prototype.load;Xb.prototype.play=Xb.prototype.play;L.prototype.load=L.prototype.load;L.prototype.lookAt=L.prototype.fk;L.prototype.update=L.prototype.update;L.prototype.destroy=L.prototype.destroy;
...
u.prototype.update=u.prototype.update;u.prototype.add=u.prototype.add;u.prototype.remove=u.prototype.remove;u.prototype.autoSuspend=u.prototype.Sf;u.prototype.autoResume=u.prototype.Rf;u.prototype.mute=u.prototype.bb;u.prototype.unmute=u.prototype.Mh;u.prototype.destroy=u.prototype.destroy;M.prototype.update=M.prototype.update;M.prototype.play=M.prototype.play;M.prototype.stop=M.prototype.stop;M.prototype.pause=M.prototype.pause;M.prototype.resume=M.prototype.resume;M.prototype.mute=M.prototype.bb;
M.prototype.unmute=M.prototype.Qh;M.prototype.destroy=M.prototype.destroy;Q.prototype.hasTracks=Q.prototype.hl;Q.prototype.play=Q.prototype.play;Q.prototype.stop=Q.prototype.stop;Q.prototype.pause=Q.prototype.pause;Q.prototype.resume=Q.prototype.resume;Q.prototype.nextTrack=Q.prototype.nd;Q.prototype.previousTrack=Q.prototype.xe;Q.prototype.destroy=Q.prototype.destroy;z.prototype.boot=z.prototype.boot;z.prototype.addConfig=z.prototype.ha;z.prototype.add=z.prototype.add;z.prototype.addTrack=z.prototype.th;
z.prototype.hasPlaylists=z.prototype.Jn;z.prototype.hasTracks=z.prototype.bl;z.prototype.play=z.prototype.play;z.prototype.stop=z.prototype.stop;z.prototype.pause=z.prototype.pause;z.prototype.resume=z.prototype.resume;z.prototype.nextTrack=z.prototype.nd;z.prototype.previousTrack=z.prototype.xe;z.prototype.destroy=z.prototype.destroy;Yc.prototype.play=Yc.prototype.play;Yc.prototype.stop=Yc.prototype.stop;Yc.prototype.pause=Yc.prototype.pause;Yc.prototype.resume=Yc.prototype.resume;
...
R.prototype.instantiate=R.prototype.Zj;R.prototype.notifyInstanceReady=R.prototype.Wn;R.prototype.update=R.prototype.update;R.prototype.resetInstance=R.prototype.qk;R.prototype.destroy=R.prototype.destroy;fd.prototype.load=fd.prototype.load;fd.prototype.getNewInstance=fd.prototype.Gj;fd.prototype.destroy=fd.prototype.destroy;pa.prototype.boot=pa.prototype.boot;pa.prototype.addConfig=pa.prototype.ha;pa.prototype.getById=pa.prototype.de;pa.prototype.getByIndex=pa.prototype.Ej;pa.prototype.get=pa.prototype.get;
pa.prototype.remove=pa.prototype.remove;pa.prototype.update=pa.prototype.update;pa.prototype.render=pa.prototype.render;pa.prototype.destroy=pa.prototype.destroy;ed.prototype.string=ed.prototype.fo;ed.prototype.textField=ed.prototype.ho;ed.prototype.sound=ed.prototype.sound;ed.prototype.displayObjectContainer=ed.prototype.wn;ed.prototype.displayObject=ed.prototype.kl;ed.prototype.image=ed.prototype.image;ed.prototype.sprite=ed.prototype.co;ed.prototype.button=ed.prototype.jl;ed.prototype.video=ed.prototype.ml;
ed.prototype.canvas=ed.prototype.canvas;ed.prototype.tween=ed.prototype.ll;ed.prototype.destroyAllObjects=ed.prototype.rj;ed.prototype.destroy=ed.prototype.destroy;la.prototype.boot=la.prototype.boot;la.prototype.start=la.prototype.start;la.prototype.stop=la.prototype.stop;la.prototype.destroy=la.prototype.destroy;na.prototype.addConfig=na.prototype.ha;na.prototype.destroy=na.prototype.destroy;q.prototype.add=q.prototype.add;q.prototype.addOnce=q.prototype.ca;q.prototype.remove=q.prototype.remove;
q.prototype.has=q.prototype.has;q.prototype.dispatch=q.prototype.D;q.prototype.destroy=q.prototype.destroy;rd.prototype.execute=rd.prototype.yb;rd.prototype.detach=rd.prototype.oh;rd.prototype.destroy=rd.prototype.destroy;ma.prototype.addConfig=ma.prototype.ha;ma.prototype.getValue=ma.prototype.Yb;ma.prototype.hasValue=ma.prototype.xb;ma.prototype.destroy=ma.prototype.destroy;za.prototype.destroy=za.prototype.destroy;vd.prototype.addConfig=vd.prototype.ha;vd.prototype.loadFiles=vd.prototype.rg;
vd.prototype.getValue=vd.prototype.Yb;vd.prototype.hasValue=vd.prototype.xb;vd.prototype.getKey=vd.prototype.ph;vd.prototype.destroy=vd.prototype.destroy;ua.prototype.update=ua.prototype.update;ua.prototype.isKeyPressed=ua.prototype.Qn;ua.prototype.isKeyOut=ua.prototype.og;ua.prototype.addBinding=ua.prototype.Pf;ua.prototype.removeBinding=ua.prototype.ye;ua.prototype.hasBinding=ua.prototype.Gn;ua.prototype.getBindings=ua.prototype.dg;ua.prototype.destroy=ua.prototype.destroy;
P.prototype.hasKeyIn=P.prototype.je;P.prototype.hasKeyOut=P.prototype.gg;P.prototype.down=P.prototype.nh;P.prototype.waitToHold=P.prototype.mo;P.prototype.up=P.prototype.Bk;P.prototype.hold=P.prototype.Wj;P.prototype.destroy=P.prototype.destroy;Bd.prototype.enable=Bd.prototype.enable;Bd.prototype.disable=Bd.prototype.kh;Bd.prototype.destroy=Bd.prototype.destroy;U.prototype.enable=U.prototype.enable;U.prototype.disable=U.prototype.Te;U.prototype.destroy=U.prototype.destroy;ga.prototype.register=ga.prototype.register;
ga.prototype.unregister=ga.prototype.unregister;ga.prototype.update=ga.prototype.update;ga.prototype.destroy=ga.prototype.destroy;T.prototype.show=T.prototype.gh;T.prototype.hide=T.prototype.Vj;T.prototype.toggleVisibility=T.prototype.ko;T.prototype.maximize=T.prototype.Ab;T.prototype.isInDom=T.prototype.ld;T.prototype.resize=T.prototype.fh;T.prototype.fullscreenEnter=T.prototype.zj;T.prototype.fullscreenExit=T.prototype.Aj;T.prototype.isFullscreen=T.prototype.kd;T.prototype.destroy=T.prototype.destroy;
t.prototype.update=t.prototype.update;t.prototype.addChild=t.prototype.Xb;t.prototype.addChildAt=t.prototype.pn;t.prototype.fitToContent=t.prototype.yj;t.prototype.removeChild=t.prototype.removeChild;t.prototype.removeChildAt=t.prototype.Ag;t.prototype.empty=t.prototype.eh;t.prototype.hasChild=t.prototype.Kk;t.prototype.destroy=t.prototype.destroy;I.prototype.load=I.prototype.load;I.prototype.unload=I.prototype.De;I.prototype.destroy=I.prototype.destroy;ic.prototype.destroy=ic.prototype.destroy;
...
od.prototype.hasSkin=od.prototype.Sj;od.prototype.updateSkin=od.prototype.lo;od.prototype.destroy=od.prototype.destroy;ge.prototype.setDefaultFromState=ge.prototype.Gg;ge.prototype.getProperty=ge.prototype.Qa;ge.prototype.hasImage=ge.prototype.Rj;ge.prototype.hasLabel=ge.prototype.m;K.prototype.update=K.prototype.update;K.prototype.load=K.prototype.load;K.prototype.play=K.prototype.play;K.prototype.pause=K.prototype.pause;K.prototype.stop=K.prototype.stop;K.prototype.togglePlayback=K.prototype.Bl;
K.prototype.mute=K.prototype.bb;K.prototype.unmute=K.prototype.Wh;K.prototype.destroy=K.prototype.destroy;J.prototype.load=J.prototype.load;J.prototype.play=J.prototype.play;J.prototype.pause=J.prototype.pause;J.prototype.stop=J.prototype.stop;J.prototype.togglePlayback=J.prototype.Al;J.prototype.mute=J.prototype.bb;J.prototype.unmute=J.prototype.Th;J.prototype.enableBufferOccupancyABR=J.prototype.zl;J.prototype.destroy=J.prototype.destroy;xe.prototype.getTimeRange=xe.prototype.j;
xe.prototype.isInRanges=xe.prototype.bk;Vd.prototype.add=Vd.prototype.add;Vd.prototype.play=Vd.prototype.play;Vd.prototype.pause=Vd.prototype.pause;Vd.prototype.resume=Vd.prototype.resume;Vd.prototype.stop=Vd.prototype.stop;Vd.prototype.get=Vd.prototype.get;Vd.prototype.update=Vd.prototype.update;Vd.prototype.destroy=Vd.prototype.destroy;W.prototype.play=W.prototype.play;W.prototype.pause=W.prototype.pause;W.prototype.resume=W.prototype.resume;W.prototype.stop=W.prototype.stop;
W.prototype.update=W.prototype.update;W.prototype.destroy=W.prototype.destroy;va.prototype.has=va.prototype.has;va.prototype.get=va.prototype.get;va.prototype.add=va.prototype.add;va.prototype.remove=va.prototype.remove;va.prototype.destroy=va.prototype.destroy;Re.prototype.key=Re.prototype.key;Re.prototype.url=Re.prototype.url;Re.prototype.type=Re.prototype.type;Re.prototype.data=Re.prototype.data;Re.prototype.xhr=Re.prototype.no;Re.prototype.loading=Re.prototype.zb;Re.prototype.loaded=Re.prototype.Mk;
Re.prototype.error=Re.prototype.Lk;wa.prototype.json=wa.prototype.json;wa.prototype.xml=wa.prototype.Sk;wa.prototype.sound=wa.prototype.sound;wa.prototype.image=wa.prototype.image;wa.prototype.script=wa.prototype.Fg;wa.prototype.css=wa.prototype.nj;wa.prototype.destroy=wa.prototype.destroy;ja.prototype.add=ja.prototype.add;ja.prototype.destroy=ja.prototype.destroy;ka.prototype.create=ka.prototype.create;ka.prototype.add=ka.prototype.add;ka.prototype.update=ka.prototype.update;
ka.prototype.destroy=ka.prototype.destroy;X.prototype.create=X.prototype.create;X.prototype.add=X.prototype.add;X.prototype.repeat=X.prototype.tl;X.prototype.loop=X.prototype.Xe;X.prototype.remove=X.prototype.remove;X.prototype.start=X.prototype.start;X.prototype.stop=X.prototype.stop;X.prototype.pause=X.prototype.pause;X.prototype.resume=X.prototype.resume;X.prototype.update=X.prototype.update;X.prototype.destroy=X.prototype.destroy;We.prototype.execute=We.prototype.yb;xa.prototype.add=xa.prototype.add;
xa.prototype.remove=xa.prototype.remove;xa.prototype.update=xa.prototype.update;xa.prototype.destroy=xa.prototype.destroy;Ab.prototype.to=Ab.prototype.Ye;Ab.prototype.start=Ab.prototype.start;Ab.prototype.stop=Ab.prototype.stop;Ab.prototype.update=Ab.prototype.update;Ab.prototype.destroy=Ab.prototype.destroy;Me.prototype.set=Me.prototype.set;Me.prototype["delete"]=Me.prototype.Pe;Me.prototype.get=Me.prototype.get;Me.prototype.keys=Me.prototype.Vk;Me.prototype.values=Me.prototype.Wk;
Me.prototype.entries=Me.prototype.Uk;Me.prototype.clear=Me.prototype.Tk;Me.prototype.has=Me.prototype.has;md.prototype.add=md.prototype.add;md.prototype.remove=md.prototype.remove;md.prototype.get=md.prototype.get;md.prototype.toArray=md.prototype.Ae;window.FORGE.Math=G;G.degToRad=G.da;G.radToDeg=G.$b;G.round10=G.pd;G.clamp=G.X;G.wrap=G.Wa;G.mix=G.Vn;G.smoothStep=G.bo;G.rotationMatrixToEuler=G.Bg;G.eulerToRotationMatrix=G.be;window.FORGE.Quaternion=H;H.toEuler=H.Be;H.fromEuler=H.lc;
H.toRotationMatrix=H.xk;H.fromRotationMatrix=H.An;H.cancelRoll=H.cancelRoll;H.diffBetweenQuaternions=H.vn;H.angularDistance=H.hj;H.multiplyScalar=H.multiplyScalar;H.add=H.add;H.log=H.log;H.exp=H.exp;H.slerp=H.slerp;H.squad=H.eo;H.nlerpNoInvert=H.ik;H.slerpNoInvert=H.ze;H.squadNoInvert=H.vk;H.spline=H.Ig;bb.getUniqueName=ub;tb.parseIncludes=tb.eb;Qb.colorFrom3DObject=Rb;ge.isValid=function(a){return a?!0:!1};De.mimeTypeFromURL=Ke;window.FORGE.Utils=B;B.parseSizeString=B.zg;B.extendSimpleObject=B.kc;
B.extendMultipleObjects=B.ab;B.clone=B.clone;B.isDisplayObject=B.Pn;B.isTypeOf=B.T;B.isTypeOfRecursive=B.Sn;B.isArrayOf=B.Ga;B.getObjectProperty=B.he;B.sortArrayByProperty=B.qd;B.randomize=B.od;B.leftFill=B.pe;B.parseTime=B.lk;B.formatTime=B.yn;B.toTHREESpherical=B.Ce;B.fromTHREESpherical=B.Bn;B.arrayByDifference=B.ij;B.removeItemFromArrayAtIndex=B.Xn;B.endsWith=B.endsWith;window.FORGE.Dom=ha;ha.getCssProperty=ha.fd;ha.getUnitWidth=ha.Nj;ha.getValueWidth=ha.Pj;ha.getUnitHeight=ha.Mj;
ha.getValueHeight=ha.Oj;ha.has=ha.has;ha.isHtmlElement=ha.mg;ha.getMouseEventOffset=ha.En;Xe.parse=Da;Xe.exists=function(a,b,d,g){var h=new XMLHttpRequest,k=null;h.onreadystatechange=function(){4===this.readyState&&200===this.status&&(clearTimeout(k),"function"===typeof b&&b.call(g))};h.onerror=function(a){console.log(a)};h.open("HEAD",a);h.send();k=window.setTimeout(function(){"function"===typeof d&&d.call(g)},500)};
Xe.isValid=function(a){return/((([A-Za-z]{3,9}:(?:\/\/)?)(?:[\-;:&=\+\$,\w]+@)?[A-Za-z0-9\.\-]+|(?:www\.|[\-;:&=\+\$,\w]+@)[A-Za-z0-9\.\-]+)((?:\/[\+~%\/\.\w\-]*)?\??(?:[\-\+=&;%@\.\w]*)#?(?:[\.\!\/\\\w]*))?)/.test(a)?!0:!1};window.FORGE.Color=Z;Z.rgbToHsl=Z.Zn;Z.hslToRgb=Z.Nn;Z.hueToRgb=Z.ke;Z.rgbToHsv=Z.$n;Z.hsvToRgb=Z.On;Z.componentToHex=Z.$d;Z.rgbToHex=Z.Yn;Z.fromRgbaString=Z.zn;Z.hexToRgb=Z.Ln;Z.rgbToYcbcr=Z.ao;Z.ycbcrToRgb=Z.po;Z.ycbcrRotate=Z.oo;Z.distance=Z.distance;N.canPlayAudio=N.tn;
N.canPlayVideo=N.un;N.isLowBattery=N.Rn;N.os=N.cb;N.vita=N.Mg;N.xbox=N.Wg;N.kindle=N.pg;N.windowsPhone=N.Ee;N.osVersion=N.Zb;N.android=N.fj;N.chromeOS=N.Uf;N.iOS=N.Fc;N.linux=N.qg;N.macOS=N.tg;N.windows=N.Vg;N.ie=N.jd;N.edge=N.ae;N.firefox=N.bg;N.opera=N.opera;N.safari=N.Cg;N.chrome=N.chrome;N.browser=N.mb;N.browserVersion=N.$a;N.edgeVersion=N.tj;N.chromeVersion=N.Vf;N.firefoxVersion=N.xj;N.silk=N.Hg;N.ieVersion=N.lg;N.operaVersion=N.te;N.safariVersion=N.sk;N.isAndroidStockBrowser=N.ak;
N.androidStockBrowserVersion=N.gj;N.webApp=N.Ek;N.quirksMode=N.pk;N.pixelRatio=N.nc;N.iPhone=N.Xj;N.iPod=N.Yj;N.iPad=N.kg;N.retina=N.rk;N.desktop=N.Dc;N.mobile=N.qe;N.tablet=N.Jg;N.other=N.kk;N.oggVideo=N.yg;N.h264Video=N.fg;N.mp4Video=N.wg;N.webmVideo=N.Ug;N.vp9Video=N.Ng;N.hlsVideo=N.jg;N.audioTag=N.Qf;N.webAudio=N.Pg;N.ogg=N.xg;N.mp3=N.ug;N.opus=N.ue;N.wav=N.Og;N.aac=N.Of;N.m4a=N.sg;N.mp4=N.vg;N.webm=N.Tg;N.weba=N.Sg;N.vibrate=N.Kg;N.battery=N.Tf;N.canvas=N.canvas;N.canvasText=N.kj;
N.canvasWinding=N.lj;N.localStorage=N.localStorage;N.mediaSource=N.hk;N.encryptedMedia=N.uj;N.applicationCache=N.applicationCache;N.addEventListener=N.addEventListener;N.raf=N.Ao;N.webGL=N.Qg;N.webVR=N.Rg;N.geolocation=N.geolocation;N.history=N.history;N.svg=N.wk;N.contextMenu=N.contextMenu;N.isSecure=N.ck;N.isIframe=N.ng;N.touch=N.yk;N.touchForce=N.zk;N.gamepad=N.Dj;N.requestFullscreen=N.requestFullscreen;N.exitFullscreen=N.exitFullscreen;N.fullscreenKeyboard=N.Bj;N.fullscreenElement=N.fullscreenElement;
N.fullscreenEnabled=N.fullscreenEnabled;N.visibilityState=N.visibilityState;N.visibilityChange=N.Lg;N.orientation=N.orientation;N.screenOrientation=N.tk;N.lockOrientation=N.ek;N.unlockOrientation=N.Ak;N.file=N.file;N.fileSystem=N.wj;N.pointerLock=N.nk;N.cssPointerEvents=N.dd;N.cssRgba=N.qj;N.cssAnimation=N.pj;N.css3D=N.oj;N.deviceMotionRotationRate=N.Yf;N.deviceMotionAcceleration=N.Xf;N.deviceOrientationMagnetometer=N.$f;N.deviceMotion=N.Wf;N.deviceOrientation=N.Zf;N.dpi=N.sj;N.screenWidth=N.Eg;
N.screenHeight=N.Dg;N.ua=N.aa;N.language=N.language;N.gyroscope=N.Qj;N.ready=N.ready;p.generate=p.cg;p.validate=p.Dk;p.register=p.register;p.unregister=p.unregister;p.getUids=p.eg;p.filterType=p.ce;p.get=p.get;p.isTypeOf=p.T;p.exists=p.Va;ca.register=ca.register;ca.getUids=ca.eg;ca.get=ca.get;ca.hasTypeOf=ca.Kn;ca.exists=ca.Va;window.FORGE.VIEWERS=aa;window.FORGE.VERSION="0.9.0";window.FORGE.DEBUG=!1;window.FORGE.WARNING=!1;r.DEFAULT_CONFIG=fa;window.FORGE.Math=G;G.DEGREES=G.Na;G.RADIANS=G.nb;
G.DEG2RAD=G.ai;G.RAD2DEG=G.li;G.TWOPI=G.ri;window.FORGE.MediaType=Ja;Ja.IMAGE=Ja.IMAGE;Ja.VIDEO=Ja.VIDEO;window.FORGE.MediaFormat=Ka;Ka.EQUIRECTANGULAR=Ka.Pc;Ka.CUBE=Ka.xd;Ka.FLAT=Ka.ci;Ka.HOTSPOT=Ka.Gl;window.FORGE.BackgroundType=Oa;Oa.UNDEFINED=Oa.Tc;Oa.SHADER=Oa.Gd;Oa.MESH=Oa.Sc;window.FORGE.EffectComposerType=cb;cb.MAIN=cb.fi;cb.RENDER=cb.Sb;cb.PICKING=cb.rf;window.FORGE.PassPosition=eb;eb.UNKNOWN=eb.Kd;eb.BACKGROUND=eb.ud;eb.RENDER=eb.Sb;eb.GLOBAL=eb.cf;window.FORGE.ViewType=Na;
Na.UNDEFINED=Na.Tc;Na.RECTILINEAR=Na.ob;Na.GOPRO=Na.gc;window.FORGE.PickingManager.modes=Wa;Wa.POINTER=Wa.Za;Wa.GAZE=Wa.vc;window.FORGE.HotspotMaterial.types=bc;bc.IMAGE=bc.IMAGE;bc.PLUGIN=bc.ki;bc.GRAPHICS=bc.Cd;window.FORGE.HotspotMaterial.presets=Zb;Zb.TRANSPARENT=Zb.pi;Zb.DEBUG=Zb.$h;window.FORGE.HotspotGeometryType=cc;cc.PLANE=cc.ji;cc.BOX=cc.Yh;cc.SPHERE=cc.mi;cc.CYLINDER=cc.Zh;window.FORGE.HotspotType=Tb;Tb.THREE_DIMENSIONAL=Tb.Df;L.RADIUS=50;L.DEFAULT_CONFIG=kc;
window.FORGE.ControllerType=Bc;Bc.POINTER=Bc.Za;Bc.KEYBOARD=Bc.hf;oa.DEFAULT_CONFIG=Cc;window.FORGE.SoundType=Ga;Ga.STEREO=Ga.Ll;Ga.SPATIAL=Ga.Kl;Ga.AMBISONIC=Ga.Ze;window.FORGE.Action.operation=ad;ad.SET=ad.Af;ad.ADD=ad.Xh;ad.SUBSTRACT=ad.ni;ad.MULTIPLY=ad.gi;ad.DIVIDE=ad.bi;ad.TOGGLE=ad.oi;window.FORGE.Pointer.listenerTypes=V;V.NATIVE=V.Ra;V.HAMMER=V.ka;window.FORGE.Pointer.events=U.events;U.events.TAP=U.events.Cf;U.events.DOUBLE_TAP=U.events.Bd;U.events.PRESS_START=U.events.wf;
U.events.PRESS_END=U.events.vf;U.events.PAN_START=U.events.qf;U.events.PAN_MOVE=U.events.pf;U.events.PAN_END=U.events.nf;U.events.PINCH_START=U.events.uf;U.events.PINCH_MOVE=U.events.tf;U.events.PINCH_END=U.events.sf;U.events.ROTATE_START=U.events.zf;U.events.ROTATE_MOVE=U.events.yf;U.events.ROTATE_END=U.events.xf;U.events.SWIPE=U.events.Bf;U.events.ENTER=U.events.bf;U.events.LEAVE=U.events.jf;U.events.OVER=U.events.mf;U.events.OUT=U.events.lf;U.events.MOVE=U.events.kf;U.events.WHEEL=U.events.Ef;
window.FORGE.Pointer.cursors=Ed;Ed.DEFAULT=Ed.DEFAULT;Ed.POINTER=Ed.Za;Ed.GRAB=Ed.El;Ed.GRABBING=Ed.Fl;window.FORGE.Image.renderModes=Qd;Qd.CSS=Qd.CSS;Qd.CANVAS=Qd.Jb;ge.EMPTY_STATE_IMAGE=ie;ge.EMPTY_STATE_LABEL=je;ge.EMPTY_STATE=ke;ge.DEFAULT_STATE_IMAGE=le;ge.DEFAULT_STATE_LABEL=me;ge.DEFAULT_STATE=he;window.FORGE.VideoDash.mediaType=Ee;Ee.VIDEO=Ee.VIDEO;Ee.AUDIO=Ee.AUDIO;window.FORGE.VideoQualityMode=ne;ne.AUTO=ne.Hb;ne.MANUAL=ne.MANUAL;window.FORGE.VideoFormat=Ma;Ma.DASH=Ma.$e;Ma.HTML5=Ma.Hl;
