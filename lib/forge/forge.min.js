(function() {
  var root = this;
  var e,aa=[];function l(a){this.O="";this.hc=this.hb=this.Ya=null;this.ib=!0;this.wd=this.Xc=!1;this.gf=null;this.Ta=a||"BaseObject"}l.prototype.constructor=l;function ba(a){if("string"!==typeof a.O||""===a.O)a.O=p.dg();p.register(a);null!==a.Ya&&("string"===typeof a.Ya&&(a.Ya=[a.Ya]),!0===Array.isArray(a.Ya)&&ca.register(a))}function da(a){""!==a.O&&!0===p.Va(a.O)&&p.unregister(a)}
function ea(a,b,d){d=d||"log";console[d].apply(console,["%c[ForgeJS]%c FORGE."+a.Ta+" : "+b+" %c(@"+window.performance.now().toFixed(2)+"ms)","background: #e2edff; color: #4286f4; font-weight: 700","font-weight: 400","color: #AAA"]);if("object"===typeof b&&null!==b)console[d](b)}l.prototype.log=function(a){if(!0===window.FORGE[this.Ta].DEBUG||!0===this.Xc)ea(this,a,"log"),null===this.gf&&(this.gf=[]),this.gf.push(a)};
l.prototype.warn=function(a){!0!==window.FORGE[this.Ta].WARNING&&!0!==this.wd||ea(this,a,"warn")};l.prototype.destroy=function(){!1!==this.ib&&(da(this),null!==this.hc&&(this.hc.D(),this.hc.destroy(),this.hc=null),this.hb=null,this.ib=!1)};Object.defineProperty(l.prototype,"className",{get:function(){return this.Ta}});Object.defineProperty(l.prototype,"uid",{get:function(){return this.O}});Object.defineProperty(l.prototype,"tags",{get:function(){return this.Ya}});
Object.defineProperty(l.prototype,"alive",{get:function(){return this.ib}});Object.defineProperty(l.prototype,"data",{get:function(){return this.hb},set:function(a){this.hb=a}});Object.defineProperty(l.prototype,"debug",{get:function(){return this.Xc},set:function(a){this.Xc=!!a;!0===this.Xc&&(console.log("Enabling debug for a FORGE."+this.Ta+" instance :"),console.log(this))}});
Object.defineProperty(l.prototype,"warning",{get:function(){return this.wd},set:function(a){this.wd=!!a;!0===this.wd&&(console.log("Enabling warning for a FORGE."+this.Ta+" instance :"),console.log(this))}});Object.defineProperty(l.prototype,"onDestroy",{get:function(){null===this.hc&&(this.hc=new q(this));return this.hc}});
function r(a,b,d){l.call(this,"Viewer");this.j=a;this.ya=b||{viewer:fa};this.C=this.P=this.ba=this.G=this.J=this.B=this.va=this.S=this.wa=this.na=this.W=this.xa=this.R=this.V=this.fa=this.M=this.H=this.U=this.F=this.N=this.I=this.K=this.A=this.c=this.oa=null;this.ea=this.$=!1;this.u=this.m=this.o=null;this.f=d||null;window.setTimeout(this.Al.bind(this),0)}r.prototype=Object.create(l.prototype);r.prototype.constructor=r;var fa={background:"#000"};e=r.prototype;
e.Al=function(a){this.O="FORGE-instance-"+String(aa.length);aa.push(this.O);ba(this);this.log("$_Viewer.boot();");this.oa=new ga(this);"string"===typeof this.j&&""!==this.j&&(this.j=document.getElementById(this.j));if("undefined"===typeof this.j||null===this.j||!1===ha.mg(this.j))throw"$_Viewer.boot : Viewer parent is invalid";this.c=new t(this,null,null,this.j);this.c.id="FORGE-main-container-"+this.O;this.A=new t(this);this.A.id="FORGE-canvas-container-"+this.O;this.c.index=0;this.A.Ab(!0);this.c.Xb(this.A);
...
e.update=function(a){!0!==this.$&&(this.G.update(a),this.oa.update(),this.va.update(),this.F.update(),this.B.update(),this.ba.update(),this.H.update(),this.R.update(),null!==this.f&&"function"===typeof this.f.update&&this.f.update.call(),null!==this.f&&"function"===typeof this.f.pn&&this.f.pn.call(),null!==this.C&&this.C.render(),null!==this.f&&"function"===typeof this.f.nn&&this.f.nn.call())};e.pause=function(){this.$=!0;null!==this.m&&this.m.D()};e.resume=function(){this.$=!1;null!==this.u&&this.u.D()};
...
this.warn(a)}else this.warn("Tags: No uid or no tags on the object you try to register!"),this.warn(a)};a.prototype.fg=function(a,d){var b=[];if("string"===typeof a)b=this.jb[a];else if(Array.isArray(a)){var h=0;for(a=a.length;h<a;h++);}"string"===typeof d&&(b=p.ce(b,d));return b};a.prototype.get=function(a,d){if("string"===typeof a)return p.get(this.jb[a],d);if(Array.isArray(a)){var b=0;for(a=a.length;b<a;b++);return p.get([],d)}};a.prototype.In=function(a,d){if(!0===this.Va(a)){a=this.jb[a];for(var b=
...
a.prototype.constructor=a;a.prototype.dg=function(){var a="xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var b=16*Math.random()|0;return("x"==a?b:b&3|8).toString(16)});return!1===p.Va(a)?a:p.dg()};a.prototype.Dk=function(a){function b(a){var d,h;for(h in a)if("uid"===h)if(d=a[h],"string"===typeof d){if(p.Va(d))throw"UID configuration not valid, uid "+d+" already have an object binded to!";if(-1!==g.indexOf(d))throw"UID configuration not valid, uid "+d+" is in double in config file!";
...
e.load=function(a){this.log("$_Story.load();");"string"===typeof a?this.i.load.json("forge.story.config",a,this.nl,this):"object"===typeof a&&Aa(this,a)};e.ol=function(){return!!this.c.length};e.mc=function(){return!!this.o.length};e.pl=function(){var a=this.c.indexOf(this.m);this.md(a+1<this.c.length?this.c[a+1]:this.c[0])};e.ql=function(){var a=this.c.indexOf(this.m);this.md(0<=a-1?this.c[a-1]:this.c[this.c.length-1])};
e.nl=function(a){this.log("$_Story.loadComplete();");a=this.i.cache.get(A.JSON,a.key).data;Aa(this,a)};
function Aa(a,b){if(!0!==p.Dk(b))throw"Story configuration is not valid!";a.f=b;a.O=a.f.uid;ba(a);a.K=a.f["default"];a.J.key=a.f.name;a.N.key=a.f.slug;a.I.key=a.f.description;if("undefined"!==typeof a.f.scenes&&0<a.f.scenes.length){b=a.f.scenes;for(var d,g=0,h=b.length;g<h;g++)d=new C(a.i),d.ha(b[g]),!0===d.booted&&Ba(a,d)}if("undefined"!==typeof a.f.groups&&0<a.f.groups.length)for(b=a.f.groups,g=0,h=b.length;g<h;g++)d=new D(a.i,b[g]),a.o.push(d.uid);Ca(a)}
function Ca(a){if("undefined"===typeof a.f.scenes||a.c.length===a.f.scenes.length){null!==a.A&&a.A.D();var b=Da().hashParameters;null!==b&&"string"===typeof b.uid?Ea(b.uid):""!==a.K&&null!==a.K&&p.Va(a.K)?Ea(a.K):a.md(0)}}function Ea(a){!0!==p.T(a,"Scene")&&!0!==p.T(a,"Group")||p.get(a).load()}e.jk=function(a){Ba(this,a);Ca(this)};function Ba(a,b){b.onLoadStart.add(a.cn,a);b.onLoadComplete.add(a.bn,a);a.c.push(b.uid)}
e.md=function(a){var b;"number"===typeof a?0<=a&&a<this.c.length?b=this.c[a]:this.warn("Load scene, index "+a+" is out of bounds"):"string"===typeof a&&p.T(a,"Scene")?b=a:"object"===typeof a&&B.T(a,"Scene")&&(b=a.uid);"undefined"!==typeof b&&b!==this.m&&Ea(b)};e.cn=function(a){""!==this.m&&null!==this.m&&this.scene.De();a=a.emitter;this.m=a.uid;!1===a.mc()?(this.u=null,null!==this.j&&this.j.D()):!0===a.mc()&&!1===a.gd(this.u)&&Fa(this,a.groups[0].uid);null!==this.C&&this.C.D({uid:a.uid})};
e.bn=function(){null!==this.G&&this.G.D()};function Fa(a,b){!0===p.T(b,"Group")&&b!==a.u&&(a.u=b,null!==a.j&&a.j.D())}e.dk=function(a){var b;"number"===typeof a?0<=a&&a<this.o.length?b=this.o[a]:this.warn("Load group, index "+a+" is out of bounds"):"string"===typeof a&&p.T(a,"Group")?b=a:"object"===typeof a&&B.T(a,"Group")&&(b=a.uid);"undefined"!==typeof b&&b!==this.u&&(Fa(this,b),Ea(b))};
...
Object.defineProperty(w.prototype,"scene",{get:function(){return null===this.m||""===this.m?null:p.get(this.m)},set:function(a){this.md(a)}});Object.defineProperty(w.prototype,"sceneUid",{get:function(){return this.m}});Object.defineProperty(w.prototype,"groups",{get:function(){return p.get(this.o)}});Object.defineProperty(w.prototype,"group",{get:function(){return null===this.u||""===this.u?null:p.get(this.u)},set:function(a){this.dk(a)}});Object.defineProperty(w.prototype,"groupUid",{get:function(){return this.u}});
...
e.load=function(a){this.log("$_Group.load();");if(null===this.c||!this.c.length)throw"Group.load() : can't load a group that have no children";var b="";"undefined"===typeof a||null===a?b="string"===typeof this.j&&""!==this.j?this.j:this.c[0]:"number"===typeof a&&0<=a&&a<this.c.length?b=this.c[a]:"string"===typeof a?b=a:"object"===typeof a&&!0===this.Je(a)&&(b=a.uid);if(-1===this.c.indexOf(b))throw'Group.load() : uid "'+b+'" is not in children of the group!';if(!0===p.T(b,"Scene")||!0===p.T(b,"Group"))p.get(b).load();
else throw"Impossible to load group child with uid "+b+", it seems to be neither a scene or a group!";};e.Je=function(a){return"string"===typeof a?-1!==this.c.indexOf(a):!0===B.T(a,"Scene")||!0===B.T(a,"Group")?this.Je(a.uid):!1};e.Ec=function(a){return"string"===typeof a&&p.T(a,"Scene")?-1!==this.c.indexOf(a):!0===B.T(a,"Scene")?this.Ec(a.uid):!1};e.gd=function(a){return"string"===typeof a&&p.T(a,"Group")?-1!==this.c.indexOf(a):!0===B.T(a,"Group")?this.gd(a.uid):!1};e.Fn=function(){return!!this.c.length};
e.ig=function(a){for(var b,d=0,g=this.c.length;d<g;d++)if(b=this.c[d],p.T(b,a))return!0;return!1};e.Ke=function(){return this.ig("Scene")};e.mc=function(){return this.ig("Group")};e.ed=function(a){if("string"!==typeof a)return this.c;for(var b=[],d=0,g=this.c.length;d<g;d++)p.T(this.c[d],a)&&b.push(this.c[d]);return b};e.ee=function(a){a=this.ed(a);return p.get(a)};
e.Mk=function(){if(!1===this.Ke())this.warn("Can't do Group.nextScene() on this group that have no scenes!");else{var a=this.scenesUids,b=a.indexOf(this.i.story.sceneUid),d;-1===b&&(p.T(this.j,"Scene")?d=this.j:d=a[0]);b+1<a.length?d=a[b+1]:-1!==b&&(d=a[0]);this.load(d)}};
e.Nk=function(){if(!1===this.Ke())this.warn("Can't do Group.previousScene() on this group that have no scenes!");else{var a=this.scenesUids,b=a.indexOf(this.i.story.sceneUid),d;-1===b&&(p.T(this.j,"Scene")?d=this.j:d=a[0]);0<=b-1?d=a[b-1]:-1!==b&&(d=a[a.length-1]);this.load(d)}};e.destroy=function(){this.c=this.i=null;this.o.destroy();this.o=null;this.u.destroy();this.u=null;this.m.destroy();this.m=null;l.prototype.destroy.call(this)};Object.defineProperty(D.prototype,"config",{get:function(){return this.f}});
...
Object.defineProperty(F.prototype,"audio",{get:function(){return this.c.audio}});var G={Na:"degrees",nb:"radians"};G.ai=Math.PI/180;G.li=180/Math.PI;G.ri=2*Math.PI;G.da=function(a){return a*G.ai};G.$b=function(a){return a*G.li};G.pd=function(a){return Math.round(10*a)/10};G.X=function(a,b,d){b="number"===typeof b&&!1===isNaN(b)?b:-Infinity;d="number"===typeof d&&!1===isNaN(d)?d:Infinity;return Math.min(Math.max(a,b),d)};G.Wa=function(a,b,d){d-=b;return((a-b)%d+d)%d+b};
G.Tn=function(a,b,d){return a*d+b*(1-d)};G.$n=function(a,b,d){a=G.X((a-b)/(d-b),0,1);return a*a*(3-2*a)};G.Bg=function(a){return{yaw:Math.atan2(-a.elements[2],a.elements[10]),pitch:Math.asin(-a.elements[6]),roll:Math.atan2(-a.elements[4],a.elements[5])}};
...
var H={Be:function(a){a=(new THREE.Euler).setFromQuaternion(a,"XYZ");return{yaw:a.x,pitch:-a.y,roll:a.z}},lc:function(a,b,d){"object"===typeof a&&(b=a.pitch,d=a.roll,a=a.yaw);return(new THREE.Quaternion).setFromEuler(new THREE.Euler(a,-b,d,"ZXY"))},xk:function(a){a=H.Be(a);return G.be(a.yaw,a.pitch,a.roll)},yn:function(a){return H.lc(G.Bg(a))},cancelRoll:function(a){a=H.Be(a);return H.lc(a.yaw,a.pitch,0)},tn:function(a,b){return(new THREE.Quaternion).copy(a).inverse().multiply(b)},hj:function(a,b){a=
...
g.w=Math.cos(b);Math.abs(d)>Number.EPSILON&&(g.x=d*a.x/b,g.y=d*a.y/b,g.z=d*a.z/b);return g},slerp:function(a,b,d){var g=new THREE.Quaternion;THREE.Quaternion.slerp(a,b,g,d);return g},bo:function(a,b,d,g,h,k){a=H.slerp(a,g,k);b=H.slerp(b,d,k);return H.slerp(a,b,2*k*(1-k))},ik:function(a,b,d){return H.add(H.multiplyScalar(1-d,a),H.multiplyScalar(d,b)).normalize()},ze:function(a,b,d){var g=a.dot(b);if(.95<=Math.abs(g))return H.ik(a,b,d);g=Math.acos(g);return H.multiplyScalar(1/Math.sin(g),H.add(H.multiplyScalar(Math.sin(g*
(1-d)),a),H.multiplyScalar(Math.sin(g*d),b)))},vk:function(a,b,d,g,h){a=H.ze(a,g,h);b=H.ze(b,d,h);return H.ze(a,b,2*h*(1-h))},Ig:function(a,b,d){var g=(new THREE.Quaternion).copy(b).conjugate();a=(new THREE.Quaternion).copy(g).multiply(a);d=(new THREE.Quaternion).copy(g).multiply(d);g=H.log(a);d=H.log(d);d=H.add(g,d);d=H.multiplyScalar(-.25,d);d=H.exp(d);return(new THREE.Quaternion).copy(b).multiply(d).normalize()}};
...
Object.defineProperty(Ha.prototype,"size",{get:function(){return new Ia(this.f,this.c)}});function Ia(a,b){this.f=a||0;this.c=b||0}Ia.prototype.constructor=Ia;Object.defineProperty(Ia.prototype,"width",{get:function(){return this.f}});Object.defineProperty(Ia.prototype,"height",{get:function(){return this.c}});Object.defineProperty(Ia.prototype,"ratio",{get:function(){return this.f/this.c}});var Ja={IMAGE:"image",VIDEO:"video"},Ka={Pc:"equi",xd:"cube",ci:"flat",El:"hotspot"};
function La(a,b){this.i=a;this.j=b;this.c=this.L=this.f=null;l.call(this,"Media");a=this.j;this.warn("$_Media config validator not implemented");a=a.media;this.O=a.uid;b=a.source;if(!b)throw"No source specified !";if(a.type===Ja.IMAGE){if(!b.url)throw"Multi resolution not implemented yet !";if(b.format===Ka.Pc)b={key:this.O,url:b.url},this.L=new I(this.i,b);else if(b.format===Ka.xd)b={key:this.O,url:b.url},this.L=new I(this.i,b);else if(b.format===Ka.ci)throw"Flat media not supported yet !";this.L.onLoadComplete.ca(this.o,
this)}else if(a.type===Ja.VIDEO){if(Array.isArray(b.levels)){b.url=[];for(var d=0,g=b.levels.length;d<g;d++)b.url.push(b.levels[d].url)}"undefined"!==typeof b.streaming&&b.streaming.toLowerCase()===Ma.af?this.L=new J(this.i,this.O):this.L=new K(this.i,this.O,null,null,!0===this.j.Uj(this.O)&&!0===this.j.$j()?!0:!1);this.L.load(b.url);this.L.onLoadedMetaData.ca(this.m,this)}this.f="undefined"!==typeof a.options?a.options:null}La.prototype=Object.create(l.prototype);La.prototype.constructor=La;
...
Object.defineProperty(La.prototype,"onLoadComplete",{get:function(){null===this.c&&(this.c=new q(this));return this.c}});function y(a){this.i=a;this.C=this.f=this.o=this.H=null;this.V=Na.Tc;this.c=this.A=this.u=this.m=null;this.P=Oa.Tc;this.j=this.F=this.I=this.ba=this.B=null;this.S=this.M=this.N=!1;this.W=this.U=this.J=this.K=null;l.call(this,"RenderManager");this.G=new THREE.Clock;this.i.onReady.add(this.Jh,this,1E3)}y.prototype=Object.create(l.prototype);e=y.prototype;e.constructor=y;
e.Jh=function(){var a={antialias:!0,alpha:!0,premultipliedAlpha:!1,stencil:!0,canvas:this.i.canvas.dom};try{this.H=new THREE.WebGLRenderer(a)}catch(b){this.destroy();return}this.H.autoClear=!1;this.H.autoClearDepth=!0;this.H.autoClearColor=!0;this.A=new Pa(this.i);this.f=new Qa(this.i);this.F=new Ra(this.i);this.o=new Sa(this.i);this.f.onDisplayChange.add(this.Ni,this);Ta(this,this.f.rendererSize);this.B=new L(this.i);this.i.canvas.onResize.add(this.si,this);this.i.story.onSceneLoadStart.add(this.Ih,
this)};
e.Ih=function(){this.i.story.scene.onUnloadStart.ca(this.Qm,this);this.j=this.i.story.scene.config;"undefined"!==typeof this.j.background&&(this.i.container.background=this.j.background);this.F.mj();this.o.dj(this.F.renderScenes);var a=B.ab(this.i.config.view,this.j.view);switch("string"===typeof a.type?a.type.toLowerCase():Na.ob){case Na.gc:this.oc(Na.gc);break;default:this.oc(Na.ob)}a=B.ab(this.i.config.camera,this.j.camera);this.B.load(a);a=this.j;"undefined"!==typeof a.media&&"undefined"!==typeof a.media.source?
(this.P=a.media.source.format===Ka.xd?Oa.Sc:Oa.Gd,this.m=new La(this.i,a),this.m.onLoadComplete.ca(this.sm,this),B.T(this.m.displayObject,["VideoHTML5","VideoDash"])&&this.m.displayObject.onQualityChange.add(this.Ve,this),null!==this.U&&this.U.D()):Ua(this);a=this.j;if("undefined"!==typeof a.sound&&"undefined"!==typeof a.sound.source){var b,d,g,h;"undefined"!==typeof a.sound.options&&(b="number"===typeof a.sound.options.volume?G.X(a.sound.options.volume,0,1):1,d="boolean"===typeof a.sound.options.loop?
a.sound.options.loop:!1,g="number"===typeof a.sound.options.startTime?a.sound.options.startTime:0,h="boolean"===typeof a.sound.options.autoPlay?a.sound.options.autoPlay:!1);"undefined"!==typeof a.sound.source.url&&""!==a.sound.source.url&&(this.u=new M(this.i,a.sound.uid,a.sound.source.url,a.sound.type===Ga.$e?!0:!1),"undefined"!==typeof a.sound.options&&(this.u.volume=b,this.u.loop=d,this.u.startTime=g,!0===h&&this.u.play(this.u.startTime,this.u.loop,!0)))}};
e.Qm=function(){this.S=this.N=this.M=!1;null!==this.F&&this.F.Te();null!==this.A&&this.A.qh();null!==this.o&&this.o.We();null!==this.u&&(this.u.destroy(),this.u=null);null!==this.m&&(!0===B.T(this.m.displayObject,["VideoHTML5","VideoDash"])&&void 0!==this.m.displayObject.onQualityChange&&this.m.displayObject.onQualityChange.has(this.Ve,this)&&this.m.displayObject.onQualityChange.remove(this.Ve,this),null!==this.W&&this.W.D(),this.m.destroy(),this.m=null)};
e.sm=function(a){this.log("Media load is complete");Va(this,this.P);this.c.displayObject=a.emitter.displayObject;a=null;"undefined"!==typeof this.j.media.fx&&null!==this.j.media.fx&&(a=this.i.postProcessing.fe(this.j.media.fx));this.o.bj(this.c.renderTarget.texture,a);"undefined"!==typeof this.j.fx&&this.o.cj(this.i.postProcessing.fe(this.j.fx))};e.Ve=function(a){this.log("Media quality has changed");this.c.displayObject=a.emitter};
function Ta(a,b){a.log("Renderer size: "+b.width+"x"+b.height);var d=a.f.presentingVR,g=!0;!0===d&&(g=!1);!1===d&&a.f.setSize(b);a.H.setSize(b.width,b.height,g);a.ba=b;a.I=new Ia(b.width*(d?.5:1),b.height);null!==a.c&&a.c.setSize(a.I);a.A.setSize(a.I);a.o.setSize(a.I);a.log("Render size change in "+(d?"VR":"screen")+" mode, resolution: "+a.I.width+"x"+a.I.height)}e.si=function(){this.log("_canvasResizeHandler");var a=this.i.canvas.dom;Ta(this,new Ia(a.width,a.height))};
e.Ni=function(){Ta(this,this.f.rendererSize);this.A.mode=!0===this.f.presentingVR?Wa.vc:Wa.Za};
function Va(a,b){b=Oa.Sc;var d=null,g=null;null!==a.c&&(null!==a.c.displayObject&&(d=a.c.displayObject),null!==a.c.renderTarget&&(g=a.c.renderTarget));Ua(a);b===Oa.Gd?(a.c=new Xa(a.i,g),g=a.H.getSize(),Ta(a,new Ia(g.width,g.height))):b===Oa.Sc&&(b={order:a.j.media.source.order||"RLUDFB",tile:a.j.media.source.tile},b.Rn=a.j.media.source.format,a.c=new Ya(a.i,g,b));null!==d&&(a.c.displayObject=d);a.N=!0;null!==a.K&&a.K.D()}function Ua(a){null!==a.c&&(a.c.destroy(),a.c=null);a.N=!1}
e.render=function(){if(!1!==this.N&&!1!==this.M&&null!==this.o&&!0===this.N){var a=this.f.presentingVR,b=this.f.Jj();this.B.update();for(var d=0,g=b.length;d<g;d++){var h=b[d],k=h.rectangle,h=h.camera;this.H.setViewport(k.origin.x,k.origin.y,k.size.width,k.size.height);null!==this.c&&this.c.render((a?h:null)||null);this.o.render(h);this.H.clearDepth();!0===a&&(k=new THREE.Scene,k.add(h),this.H.render(k,h))}!0===this.f.presentingVR&&this.f.Hh()}};e.screenToWorld=function(a){return this.C.screenToWorld(a)};
e.worldToScreen=function(a,b){return this.C.worldToScreen(a,b||0)};e.Kh=function(a){this.f.presentingVR!==a&&!0===N.Ee&&(this.f.Gh(a),a?(this.V=this.C.type,this.oc(Na.ob)):this.oc(this.V),this.j.media.source.format===Ka.Pc&&(this.P=!0===a?Oa.Sc:Oa.Gd,Va(this,this.P)))};e.fo=function(){this.Kh(!this.f.presentingVR)};
e.oc=function(a){this.log("setView");this.M=!1;null!==this.C&&(this.log("Destroy previous view"),this.C.destroy(),this.C=null);if(a===Na.ob)this.C=new Za(this.i,this.B);else if(a===Na.gc)this.C=new $a(this.i,this.B);else throw"View type not supported "+a;null!==this.c&&this.c.fc();this.M=!0;this.A.Ck(a);a===Na.ob?this.o.bg(!1):this.o.bg(!0,this.A.material,this.A.renderTarget);this.onViewReady.D()};
e.destroy=function(){this.i.canvas.onResize.remove(this.si,this);this.i.story.onSceneLoadStart.remove(this.Ih,this);this.i.onReady.remove(this.Jh,this);null!==this.A&&(this.A.destroy(),this.A=null);null!==this.K&&(this.K.destroy(),this.K=null);null!==this.J&&(this.J.destroy(),this.J=null);null!==this.R&&(this.R.destroy(),this.R=null);null!==this.u&&(this.u.destroy(),this.u=null);null!==this.m&&(this.m.destroy(),this.m=null);null!==this.F&&(this.F.destroy(),this.F=null);null!==this.C&&(this.C.destroy(),
this.C=null);null!==this.c&&(this.c.destroy(),this.c=null);null!==this.B&&(this.B.destroy(),this.B=null);null!==this.f&&(this.f.onDisplayChange.remove(this.Ni,this),this.f.destroy(),this.f=null);null!==this.o&&(this.o.destroy(),this.o=null);this.H=this.j=this.G=null;l.prototype.destroy.call(this)};Object.defineProperty(y.prototype,"viewer",{get:function(){return this.i}});Object.defineProperty(y.prototype,"media",{get:function(){return this.m}});Object.defineProperty(y.prototype,"mediaSound",{get:function(){return this.u}});
...
function ab(a,b,d,g){this.i=a;this.j=b;this.m=d;this.o=g;this.f=this.c=null;l.call(this,"RenderScene");this.c=new bb(cb.Sb,this.i.renderer.webGLRenderer);a=new db(this.j,this.m);a.position=eb.Sb;this.c.addPass(a);a=this.i.postProcessing.ve(this.o);b=0;for(d=a.length;b<d;b++)g=a[b],g.renderToScreen=!1,g.position=eb.Sb,this.c.addPass(g);this.f=new bb(cb.sf,this.i.renderer.webGLRenderer);a=new db(this.j,this.m);a.position=eb.Sb;this.f.addPass(a)}ab.prototype=Object.create(l.prototype);
...
Object.defineProperty(ab.prototype,"scene",{get:function(){return this.j}});Object.defineProperty(ab.prototype,"camera",{get:function(){return this.m}});Object.defineProperty(ab.prototype,"sceneComposer",{get:function(){return this.c}});Object.defineProperty(ab.prototype,"pickingComposer",{get:function(){return this.f}});function Sa(a){this.i=a;this.G=this.f=this.c=null;this.j=!0;l.call(this,"RenderPipeline");this.G=new THREE.Clock;this.f=[];this.c=new bb(cb.fi,this.i.renderer.webGLRenderer)}
...
function lb(a){var b=a.c.passes,d=[];b.filter(function(a,b){a.position===eb.ud&&d.push(b)});if(0<d.length&&0<d[0]){for(var g=[],h=d.length-1;0<=h;h--){var k=b.splice(d[h],1)[0];g.push(k)}h=0;for(k=g.length;h<k;h++)a.c.insertPass(g[h],0)}var n=[];b.filter(function(a,b){a.position===eb.df&&n.push(b)});if(0<n.length&&n[n.length-1]<b.length-1){g=[];h=0;for(k=n.length;h<k;h++){var v=b.splice(n[h],1)[0];g.push(v)}h=0;for(k=g.length;h<k;h++)a.c.addPass(g[h])}g=0;for(h=a.f.length;g<h;g++){var k=a.f[g],v=
!1,x,E=a.f.length;for(x=0;x<E;x++)if(x!==g&&k.readBuffer===a.f[x].readBuffer){v=!0;break}v=v&&g>x;x=0;for(E=k.passes.length;x<E;x++)k.passes[x].clear=!0===v?!1:!x}g=!1;for(h=b.length-1;0<=h;h--)k=b[h],!0===g?k.renderToScreen=!1:!0===k.enabled&&(g=k.renderToScreen=!0);ib(a)}e.bg=function(a,b,d){for(var g=0,h=this.f.length;g<h;g++){var k=this.f[g];k.type===cb.sf&&(k.enabled=a,"undefined"!==typeof b&&(k.passes[0].overrideMaterial=b),"undefined"!==typeof d&&(k.renderTarget=d))}};
e.bj=function(a,b){if("undefined"!==typeof b&&null!==b&&0<b.length){b=this.i.postProcessing.ve(b);for(var d=0,g=b.length;d<g;d++)b[d].position=eb.ud;mb(this.c,b,0)}a=new fb(a);a.position=eb.ud;this.c.insertPass(a,0);lb(this)};e.dj=function(a){for(var b=0,d=a.length;b<d;b++)jb(this,a[b].sceneComposer,!1),jb(this,a[b].pickingComposer,!0);lb(this)};e.cj=function(a){a=this.i.postProcessing.ve(a);for(var b=0,d=a.length;b<d;b++)a[b].position=eb.df;mb(this.c,a);lb(this)};
e.Dn=function(a){if(null!==this.c)for(var b=0,d=this.c.passes.length;b<d;b++){var g=this.c.passes[b];if(g.uid===a)return g}if(null!==this.f)for(b=0,d=this.f.length;b<d;b++)for(var g=this.f[b],h=0,k=g.passes.length;h<k;h++){var n=g.passes[h];if(n.uid===a)return n}return null};
...
e.We=function(){if(null!==this.c){this.c.readBuffer.dispose();this.c.writeBuffer.dispose();for(var a=0,b=this.c.passes.length;a<b;a++){var d=this.c.passes[a];d instanceof hb&&d.uniforms.hasOwnProperty("tAdd")&&(d.uniforms.tAdd.value=null)}this.c.passes=[]}this.f=[]};
e.destroy=function(){this.We();this.G=null;for(var a=this.f.length-1;0<a;a--){for(var b=this.f[a],d=0,g=b.passes.length;d<g;d++){var h=b.passes[d];"function"===typeof h.destroy&&h.destroy()}b.passes.length=0}this.f=null;d=0;for(g=this.c.passes.length;d<g;d++)h=this.c.passes[d],"function"===typeof h.destroy&&h.destroy();this.c.passes.length=0;this.i=this.c=null};
...
function nb(a){var b=a.i.renderer.webGLRenderer;a.H=b.getPixelRatio();b=b.getSize();a.u=new Ia(b.width,b.height);a.f=a.u;a.j=[0,0,.5,1];a.m=[.5,0,.5,1];"VRFrameData"in window&&(a.A=new VRFrameData);!0===N.Ee?(navigator.getVRDisplays().then(function(b){a.G=0<b.length;for(var d=0,h=b.length;d<h;d++)if("VRDisplay"in window&&b[d]instanceof VRDisplay){a.c=b[d];break}}),ob(a)):a.warn("missing api navigator.getVRDisplays")}
...
null!==d[0].leftBounds&&4===d[0].leftBounds.length&&(this.j=d[0].leftBounds,this.m=d[0].rightBounds)),this.log("Bounds L:["+this.j[0]+", "+this.j[1]+", "+this.j[2]+", "+this.j[3]+"], R:["+this.m[0]+", "+this.m[1]+", "+this.m[2]+", "+this.m[3]+"]"));!1===a&&(this.H=b.getPixelRatio(),d=b.getSize(),this.u.width=d.width,this.u.height=d.height,this.f=new Ia(2*this.F,this.B),b.setPixelRatio(1))}else!0===a&&(this.f=this.u,b.setPixelRatio(this.H));this.o!==a&&null!==this.C&&this.C.D()};
...
e.Hj=function(){if(null===this.c)return null;var a=new THREE.Quaternion;if("function"===typeof this.c.getPose){var b=this.c.getPose();null!==b.orientation&&(a=b.orientation,a=new THREE.Quaternion(-a[1],-a[0],-a[2],a[3]))}return a};
e.Jj=function(){var a=this.i.renderer.camera,b=[];if("undefined"!==typeof this.c&&null!==this.c&&!0===this.o){var d=this.f.width*this.j[0],g=this.f.height*this.j[1],h=this.f.width*this.j[2],k=this.f.height*this.j[3],n=new Ha(d,g,h,k),d=this.f.width*this.m[0],g=this.f.height*this.m[1],h=this.f.width*this.m[2],k=this.f.height*this.m[3],d=new Ha(d,g,h,k);b.push(new qb(n,a.left));b.push(new qb(d,a.right))}else b.push(new qb(new Ha(0,0,this.u.width,this.u.height),a.main));return b};
...
e=rb.prototype;e.constructor=rb;e.Jc=function(){this.j=new THREE.Scene;null===this.A&&(this.A=new THREE.WebGLRenderTarget(this.i.renderer.canvasResolution.width,this.i.renderer.canvasResolution.height,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBAFormat,qo:!1}))};e.fc=function(){throw Error(this.Ta+"::updateAfterViewChange not implemented");};e.setSize=function(a){null!==this.renderTarget&&this.renderTarget.setSize(a.width,a.height)};
e.render=function(a){if(null!==this.i.renderer&&null!==this.A){if(this.c.material instanceof THREE.ShaderMaterial){var b=this.i.renderer.displayResolution;this.c.material.uniforms.hasOwnProperty("tViewportResolution")&&(this.c.material.uniforms.tViewportResolution.value=new THREE.Vector2(b.width,b.height));this.c.material.uniforms.hasOwnProperty("tViewportResolutionRatio")&&(this.c.material.uniforms.tViewportResolutionRatio.value=b.ratio);this.c.material.uniforms.hasOwnProperty("tModelViewMatrixInverse")&&
(this.c.material.uniforms.tModelViewMatrixInverse.value=this.i.renderer.camera.modelViewInverse);this.i.renderer.view.pc(this.c.material.uniforms)}null!==a?this.i.renderer.webGLRenderer.render(this.j,a,this.A,!0):this.i.renderer.webGLRenderer.render(this.j,this.H,this.A,!0)}};
e.destroy=function(){this.H=null;null!==this.A&&(this.A.dispose(),this.A=null);for(;0<this.j.children.length;){var a=this.j.children.pop();null!==a.geometry&&(a.geometry.dispose(),a.geometry=null);this.j.remove(a)}this.i=this.j=null;l.prototype.destroy.call(this)};Object.defineProperty(rb.prototype,"renderTarget",{get:function(){return this.A}});Object.defineProperty(rb.prototype,"displayObject",{get:function(){return this.L},set:function(a){null===a?this.Od():this.Ti(a)}});
var Oa={Tc:"undefined",Gd:"shader",Sc:"mesh"};function Ya(a,b,d){this.C=this.u=this.f=this.L=null;this.I=d.order||"RLUDFB";this.m=new THREE.Vector2(0,0);this.K=d.tile||512;this.F=d.Rn||Ka.xd;this.o=this.G=0;this.B=1;rb.call(this,a,b,"BackgroundMeshRenderer")}Ya.prototype=Object.create(rb.prototype);e=Ya.prototype;e.constructor=Ya;
e.Jc=function(){rb.prototype.Jc.call(this);this.H=this.i.renderer.camera.main;this.i.renderer.camera.fovMin=this.i.renderer.view.fovMin;this.i.renderer.camera.fovMax=this.i.renderer.view.fovMax;this.G=1E3;this.o=32;this.fc()};
e.Ti=function(a){this.L=a;if(B.T(a,"Image"))this.f=new THREE.Texture,this.f.image=a.element;else if(B.T(a,"Canvas"))this.f=new THREE.Texture,this.f.image=a.element;else if(B.T(a,["VideoHTML5","VideoDash"]))"safari"===N.mb.toLowerCase()&&1440<a.originalHeight&&(this.B=2),this.u=document.createElement("canvas"),this.u.width=a.originalWidth/this.B,this.u.height=a.originalHeight/this.B,this.C=this.u.getContext("2d"),this.f=new THREE.Texture(this.u);else throw"Wrong type of display object "+a.type;this.f.format=
THREE.RGBAFormat;this.f.mapping=THREE.Texture.DEFAULT_MAPPING;this.f.magFilter=THREE.LinearFilter;this.f.minFilter=THREE.LinearFilter;this.f.wrapS=THREE.ClampToEdgeWrapping;this.f.wrapT=THREE.ClampToEdgeWrapping;this.f.generateMipmaps=!1;this.f.needsUpdate=!0;null!==this.f.image&&(this.m.x=this.f.image.width/this.K,this.m.y=this.f.image.height/this.K);this.c.onBeforeRender=this.Gk.bind(this);if(this.c.geometry instanceof THREE.BoxBufferGeometry)a=sb(this);else if(this.c.geometry instanceof THREE.SphereBufferGeometry){a=
new Float32Array(this.c.geometry.attributes.uv.array.byteLength/4);var b=a.keys(),d=this.o,g=1/d,h,k;for(k=0;k<=d;k++){var n=k*g;for(h=0;h<=d;h++){var v=h*g;a[b.next().value]=1-v;a[b.next().value]=1-n}}}else a=null;null!==a&&this.c.geometry.attributes.uv.set(a)};
e.Gk=function(){"undefined"!==typeof this.c.material.uniforms&&(this.c.material.uniforms.hasOwnProperty("tTexture")&&(this.c.material.uniforms.tTexture.value=this.f),this.c.material.uniforms.hasOwnProperty("tOpacity")&&(this.c.material.uniforms.tOpacity.value=1))};
...
e.render=function(a){if(null!==this.i.renderer){if(null!==this.f&&null!==this.u&&null!==this.C&&null!==this.L&&null!==this.L.element){var b=this.L.element;b&&b instanceof HTMLVideoElement&&b.readyState===HTMLMediaElement.HAVE_ENOUGH_DATA&&this.C&&(this.C.drawImage(b,0,0,b.videoWidth,b.videoHeight,0,0,this.u.width,this.u.height),this.f.needsUpdate=!0,this.log("texture update done"))}rb.prototype.render.call(this,a)}};e.Od=function(){this.i.renderer.webGLRenderer.clearColor()};
e.fc=function(){var a=B.clone(this.i.renderer.view.cc).mapping,b=tb.eb(a.vertexShader),d=tb.eb(a.fragmentShader),a=new THREE.RawShaderMaterial({fragmentShader:d,vertexShader:b,uniforms:a.uniforms,name:"BackgroundMeshMaterial",side:THREE.BackSide});null!==this.f&&(a.uniforms.tTexture.value=this.f);0===this.j.children.length?(this.F===Ka.Pc?(this.o=64,b=new THREE.SphereBufferGeometry(this.G,this.o,this.o)):b=new THREE.BoxBufferGeometry(this.G,this.G,this.G,this.o,this.o,this.o),this.c=new THREE.Mesh(b,
a),this.F===Ka.Pc&&this.c.rotation.set(0,Math.PI/2,0,"YXZ"),this.j.add(this.c)):(this.c=this.j.children[0],this.c.material.dispose());this.c.material=a;a.needsUpdate=!0};e.destroy=function(){this.Od();this.C=this.u=this.L=null;null!==this.f&&(this.f.dispose(),this.f=null);rb.prototype.destroy.call(this)};Object.defineProperty(Ya.prototype,"texture",{get:function(){return this.f}});function Xa(a,b){this.o=this.m=this.f=this.L=null;this.u=1;rb.call(this,a,b,"BackgroundShaderRenderer")}
Xa.prototype=Object.create(rb.prototype);e=Xa.prototype;e.constructor=Xa;e.Jc=function(){rb.prototype.Jc.call(this);this.fc();this.H=new THREE.OrthographicCamera(-1,1,1,-1,-1,1)};
e.Ti=function(a){this.L=a;if(B.T(a,"Image")||B.T(a,"Canvas"))this.f=new THREE.Texture,this.f.image=a.element;else if(B.T(a,["VideoHTML5","VideoDash"]))"safari"===N.mb.toLowerCase()&&1440<a.originalHeight&&(this.u=2),this.L.onQualityChange.has(this.Kc,this)&&this.L.onQualityChange.remove(this.Kc,this),this.L.onQualityChange.add(this.Kc,this),this.m=document.createElement("canvas"),this.m.width=a.originalWidth/this.u,this.m.height=a.originalHeight/this.u,this.o=this.m.getContext("2d"),this.f=new THREE.Texture(this.m);
...
e.render=function(a){if(null!==this.i.renderer){a=null;if(null!==this.f&&null!==this.m&&null!==this.o&&null!==this.L&&null!==this.L.element){var b=this.L.element;b instanceof HTMLVideoElement&&b.readyState===HTMLMediaElement.HAVE_ENOUGH_DATA&&this.o&&(this.o.drawImage(b,0,0,b.videoWidth,b.videoHeight,0,0,this.m.width,this.m.height),this.f.needsUpdate=!0,this.log("texture update done"))}rb.prototype.render.call(this,a)}};
e.fc=function(){var a=this.i.renderer.view.Gc,b=tb.eb(a.vertexShader),d=tb.eb(a.fragmentShader),a=new THREE.ShaderMaterial({uniforms:a.uniforms,vertexShader:b,fragmentShader:d,side:THREE.FrontSide});null!==this.f&&(a.uniforms.tTexture.value=this.f);0===this.j.children.length?(b=new THREE.PlaneBufferGeometry(2,2),this.c=new THREE.Mesh(b,a),this.j.add(this.c)):(this.c=this.j.children[0],this.c.material=null);this.c.material=a;a.needsUpdate=!0};
e.destroy=function(){this.Od();"undefined"!==typeof this.L.onQualityChange&&this.L.onQualityChange.has(this.Kc,this)&&this.L.onQualityChange.remove(this.Kc,this);this.o=this.m=this.L=null;null!==this.f&&(this.f.dispose(),this.f=null);rb.prototype.destroy.call(this)};Object.defineProperty(Xa.prototype,"texture",{get:function(){return this.f}});function ta(a){this.i=a;this.c=this.f=null;l.call(this,"PostProcessing");this.c={}}ta.prototype=Object.create(l.prototype);e=ta.prototype;e.constructor=ta;
...
Object.defineProperty(bb.prototype,"enabled",{get:function(){return this.c},set:function(a){this.c=a}});Object.defineProperty(bb.prototype,"name",{get:function(){return this.f}});var eb={Kd:"",ud:"background",Sb:"render",df:"global"};function fb(a,b){this.c="";THREE.TexturePass.call(this,a,b)}fb.prototype=Object.create(THREE.TexturePass.prototype);fb.prototype.constructor=fb;Object.defineProperty(fb.prototype,"position",{get:function(){return this.c},set:function(a){this.c=a}});
...
e=Za.prototype;e.constructor=Za;e.Gc=tb.screenToWorld.rectilinear;e.cc=tb.worldToScreen.rectilinear;e.uc=function(){wb.prototype.uc.call(this);this.c.fovMin=10;this.c.fovMax=170};e.pc=function(a){this.f=Math.tan(G.da(G.X(this.c.fov,this.c.fovMin,this.c.fovMax)/2));a.tProjectionScale.value=this.f};
e.worldToScreen=function(a,b){b=b||0;a=new THREE.Vector4(a.x,a.y,a.z,1);var d=G.Bg(this.c.modelView),d=G.be(d.yaw,d.pitch,d.roll,!0),d=d.transpose();a.applyMatrix4(d);if(0>a.z)return new THREE.Vector2(Infinity,Infinity);d=Math.max(Number.EPSILON,a.z);a=(new THREE.Vector2(a.x,a.y)).divideScalar(d);a.x/=(1+b)*this.f;a.y/=this.f;b=this.i.renderer.displayResolution;a.x=b.width/2*(a.x/b.ratio+1);a.y=b.height/2*(a.y/b.ratio+1);return new THREE.Vector2(Math.round(a.x),b.height-Math.round(a.y))};
...
e.Gn=function(){return null!==this.c&&0<this.c.length};e.lb=function(a){B.T(a,"Keyframe")&&(this.c.push(a),this.c=B.qd(this.c,"time"))};e.Bn=function(a){a=this.ge(a);return{previous:this.c[a.previous],next:this.c[a.next]||null}};e.ge=function(a){for(var b=-1,d=-1,g=this.c.length-1;0<=g;g--)if(a>=this.c[g].time){b=g;break}b!==this.c.length-1&&(d=b+1);return{previous:b,next:d}};e.Kj=function(a){a=this.Lj(a);return{previous:this.c[a.previous]||null,next:this.c[a.next]||null}};
e.Lj=function(a){a=this.ge(a);var b=0,d=a.next;0<a.previous&&(b=a.previous-1);a.next<this.c.length-2&&(d=a.next+1);return{previous:b,next:d}};e.vn=function(){for(;0<this.c.length;)this.c.pop().data=null;this.c=[]};e.destroy=function(){for(;0<this.c.length;)this.c.pop().data=null;this.c=null;l.prototype.destroy.call(this)};Object.defineProperty(xb.prototype,"keyframes",{get:function(){return this.c},set:function(a){B.Ga(a,"Keyframe")&&(this.c=B.qd(a,"time"))}});
...
function zb(a,b){this.i=a;this.ja=b||null;this.u=this.B=this.m=this.Ia=null;this.I=this.F=0;this.R=!1;this.f=null;this.N=0;this.U=!1;this.A=this.G=this.H=this.C=this.ba=this.S=null;l.call(this,"Animation");this.Ge()}zb.prototype=Object.create(l.prototype);e=zb.prototype;e.constructor=zb;e.Ge=function(){this.f=new Ab(this.i,this);this.f.onStart.add(this.Xm,this);this.f.onStop.add(this.Ym,this);this.f.onProgress.add(this.Fk,this);this.f.onComplete.add(this.Wm,this);this.i.tween.add(this.f);this.m=new xb};
function Bb(a,b){a=a.split(".");for(var d=0,g=a.length;d<g-1;d++)b=b[a[d]];return[b,a[d]]}
function Db(a,b){b=b||a.F;var d=a.m.ge(b||a.F);a.u=a.m.keyframes[d.next];a.B=a.m.keyframes[d.previous];if(null===a.u||-1===d.next)return!1;if(a.U){var g=a.m.Kj(b);if(null!==g.previous&&null!==g.next){b=(new THREE.Quaternion).copy(a.B.data.quaternion).normalize();var d=(new THREE.Quaternion).copy(a.u.data.quaternion).normalize(),h=(new THREE.Quaternion).copy(g.previous.data.quaternion).normalize(),g=(new THREE.Quaternion).copy(g.next.data.quaternion).normalize();a.S=H.Ig(h,b,d);a.ba=H.Ig(b,d,g)}}a.I=
a.u.time-a.B.time;a.f.Ze({tweenTime:1},a.I);a.N=0;a.f.start();return!0}e.Xm=function(){!0!==this.R&&(null!==this.C&&this.C.D(),this.R=!0)};e.Ym=function(){this.R=!1;null!==this.H&&this.H.D()};
e.Fk=function(){var a=this.N;if(null!==this.u){this.F=a*this.I+this.B.time;var b=[],d,g,h;Array.isArray(this.Ia.prop)||(this.Ia.prop=[this.Ia.prop]);h=this.Ia.prop.length;for(g=0;g<h;g++)b.push(Bb(this.Ia.prop[g],this.ja));if(!0===this.Ia.smooth&&"quaternion"===this.Ia.prop[0])d=b[0],d[0].quaternion=H.vk(this.B.data.quaternion,this.S,this.ba,this.u.data.quaternion,a);else if("quaternion"===this.Ia.prop[0])d=b[0],d[0].quaternion=H.slerp(this.B.data.quaternion,this.u.data.quaternion,a);else{var k=this.f.easing(a),
n,v,x=0;for(g=0;g<h;g++){n=Bb(this.Ia.prop[g],this.B.data);v=Bb(this.Ia.prop[g],this.u.data);d=b[g];n=n[0][n[1]];v=v[0][v[1]];if(this.Ia.Wa&&this.Ia.Wa[g]){var E=this.Ia.Wa[g][0],Cb=this.Ia.Wa[g][1],x=Math.abs(E-Cb)/2;Math.abs(n-v)>x?(n=G.Wa(n+x,E,Cb),v=G.Wa(v+x,E,Cb)):x=0}d[0][d[1]]=(1-k)*n+k*v-x}}"function"===typeof this.Ia.Cj&&this.Ia.Cj.call(this,a)}null!==this.G&&this.G.D({progress:this.F/this.I})};e.Wm=function(){Db(this)||null!==this.A&&this.A.D()};
...
function Ib(a,b){this.i=a;this.c=null;this.W="";this.P=this.K=!0;this.o=null;this.R=this.M=!1;this.H=this.C=this.G=this.B=null;l.call(this,b||"Object3D");this.Re()}Ib.prototype=Object.create(l.prototype);e=Ib.prototype;e.constructor=Ib;e.Re=function(){this.o={};this.c=new THREE.Mesh;this.i.renderer.objects.register(this)};e.click=function(){this.log("click "+this.c.id);!0===B.T(this.o.onClick,"ActionEventDispatcher")&&this.o.onClick.D();null!==this.B&&this.B.D()};
e.Se=function(){this.log("over "+this.c.id);!0===B.T(this.o.onOver,"ActionEventDispatcher")&&this.o.onOver.D();null!==this.G&&this.G.D()};e.rd=function(){this.log("out "+this.c.id);!0===B.T(this.o.onOut,"ActionEventDispatcher")&&this.o.onOut.D();null!==this.C&&this.C.D()};
...
function Kb(a){var b=Jb(a,null);return B.ij(a.Z,b)}function Lb(a){return Kb(a).reduce(function(a,d){0>a.indexOf(d.fx)&&a.push(d.fx);return a},[])}e.register=function(a){this.Z.push(a)};e.unregister=function(a){this.Z.splice(this.Z.indexOf(a),1)};
e.mj=function(){var a=this.i.renderer.camera.main,b=Jb(this,null);if(0<b.length){for(var d=new THREE.Scene,g=0,h=b.length;g<h;g++)d.add(b[g].mesh);h=new ab(this.i,d,a,null);this.c.push(h)}b=Lb(this);d=0;for(g=b.length;d<g;d++){for(var h=b[d],k=Jb(this,h),n=new THREE.Scene,v=0,x=k.length;v<x;v++)n.add(k[v].mesh);h=new ab(this.i,n,a,this.i.postProcessing.fe(h));this.c.push(h)}};e.Ij=function(){return this.Z.filter(function(a){return!0===a.ready&&!0===a.interactive})};
e.Fj=function(a){for(var b=0,d=this.Z.length;b<d;b++)if(this.Z[b].mesh===a)return this.Z[b];return null};e.Te=function(){for(var a=this.c.length;a--;)this.c.pop().destroy()};e.destroy=function(){this.Te();this.i=this.c=null;l.prototype.destroy.call(this)};Object.defineProperty(Ra.prototype,"all",{get:function(){return this.Z}});Object.defineProperty(Ra.prototype,"renderScenes",{get:function(){return this.c}});function Mb(a){this.i=a;this.c=this.f=null;l.call(this,"Raycaster")}Mb.prototype=Object.create(l.prototype);
...
function Ob(a,b,d){var g=a.i.renderer.canvasResolution;d=d||{x:g.width/2,y:g.height/2};var h=a.i.renderer.camera,k=(new THREE.Vector2(d.x/g.width,1-d.y/g.height)).multiplyScalar(2).addScalar(-1),g=a.i.renderer.objects.Ij();d=0;for(var n=g.length;d<n;d++)g[d].hovered=!1;d=null;a.f.setFromCamera(k,h.main);h=[];k=0;for(n=g.length;k<n;k++)h.push(g[k].mesh);for(g=a.f.intersectObjects(h);null===d&&0<g.length;){var h=g.shift(),k=h.object,v=h.uv,h=a.i.renderer.objects.Fj(k);if(!1===k.material.transparent)d=
...
function Sb(a,b){b.data.center=b.data.center||{x:b.data.x,y:b.data.y};var d=new Uint8Array(4);a.i.renderer.webGLRenderer.readRenderTargetPixels(a.ja,b.data.center.x/b.data.target.width*a.ja.width,(1-b.data.center.y/b.data.target.height)*a.ja.height,1,1,d);b=new THREE.Color(d[0],d[1],d[2]);a:{a=a.i.renderer.objects.all;for(var d=0,g=a.length;d<g;d++)if(a[d].mesh.id===((b.r&255)<<16|((b.g&255)<<8)+(b.b&255))){b=a[d];break a}b=null}return b}e.bd=function(a){a=Sb(this,a);null!==a&&a.click()};
e.Ud=function(a){a=Sb(this,a);null===a?null!==this.c&&(this.c.rd(),this.c=null):a!==this.c&&(null!==this.c&&this.c.rd(),a.Se(),this.c=a)};e.start=function(){this.i.canvas.pointer.enabled=!0;!1===this.i.canvas.pointer.onClick.has(this.bd,this)&&this.i.canvas.pointer.onClick.add(this.bd,this);!1===this.i.canvas.pointer.onMove.has(this.Ud,this)&&this.i.canvas.pointer.onMove.add(this.Ud,this)};
e.stop=function(){this.i.canvas.pointer.onClick.has(this.bd,this)&&this.i.canvas.pointer.onClick.remove(this.bd,this);this.i.canvas.pointer.onMove.has(this.Ud,this)&&this.i.canvas.pointer.onMove.remove(this.Ud,this)};e.click=function(){null!==this.c&&this.i.canvas.pointer.onClick.has(this.bd,this)&&this.c.click()};e.setSize=function(a){null!==this.ja&&this.ja.setSize(a.width,a.height)};e.ph=function(){this.c=null};
...
e.Pk=function(){var a=this.i.story.scene;a.onUnloadStart.ca(this.dn,this);"undefined"!==typeof a.config.hotspots&&this.ha(a.config.hotspots)};e.dn=function(){this.Me()};e.boot=function(){this.i.story.onSceneLoadStart.add(this.Pk,this)};e.An=function(a){return this.c.filter(function(b){return b.type===a})};e.ha=function(a){for(var b=0,d=a.length;b<d;b++){var g=a[b],h=null;switch(g.type||Tb.Ef){case Tb.Ef:h=new Ub(this.i,g)}null!==h&&this.c.push(h)}};
e.ej=function(a){if(null!==a.tracks&&"undefined"!==typeof a.tracks){a=a.tracks;for(var b=0,d=a.length;b<d;b++)new Vb(a[b])}};e.update=function(){for(var a=0,b=this.c.length;a<b;a++)this.c[a].update()};e.Me=function(){for(var a=this.c.length;a--;)this.c.pop().destroy()};e.destroy=function(){this.Me();this.c=this.i=null;l.prototype.destroy.call(this)};Object.defineProperty(qa.prototype,"all",{get:function(){return this.c}});Object.defineProperty(qa.prototype,"count",{get:function(){return this.c}});
...
e.Re=function(){Ib.prototype.Re.call(this);this.f=new Wb;this.u=new Xb(this.i,this.f);this.m=new Yb(this.i);if("undefined"!==typeof this.A&&null!==this.A){var a=this.A;this.O=a.uid;this.Ya=a.tags;ba(this);this.j=a.type;this.N=a.name;this.K=a.visible;this.U=a.facingCenter||!1;"undefined"!==typeof a.transform&&this.f.load(a.transform);"undefined"!==typeof a.animation&&(this.u.load(a.animation),this.u.onProgress.add(this.Yi,this));this.m.onReady.add(this.Ci,this);var b;"undefined"!==typeof a.material?
b=a.material:b=Zb.pi;!0===this.Xc&&(b=B.ab(b,Zb.$h));this.m.load(b);"undefined"!==typeof a.sound&&(this.F=new $b(this.i),this.F.load(a.sound,a.transform));"string"===typeof a.fx&&(this.W=a.fx);if("object"===typeof a.events){var a=a.events,d;for(d in a)b=new ac(this.i),b.c(a[d]),this.o[d]=b}}this.J=this.Ok.bind(this);this.I=this.vm.bind(this)};
e.Ok=function(a,b,d,g,h,k){this.log(k);a=this.i.renderer.webGLRenderer.getContext();this.i.renderer.view.pc(h.uniforms);"HotspotMaterial"===h.name?this.m.type===bc.Cd?h.uniforms.tColor.value=new THREE.Color(this.m.color):h.uniforms.tTexture.value=this.m.c:"PickingMaterial"===h.name&&h.program&&(b=this.ba,a.useProgram(h.program.program),h.program.getUniforms().map.tColor.setValue(a,b),h.uniforms.tColor.value=b)};e.vm=function(){};
e.Ci=function(){this.c.material=this.m.material;if("undefined"!==typeof this.A.geometry&&"string"===typeof this.A.geometry.type){var a=this.A.geometry.options;switch(this.A.geometry.type){case cc.Yh:var b=this.c,a=a||{},a=new THREE.BoxBufferGeometry(a.width||100,a.height||100,a.depth||100,a.widthSegments||8,a.heightSegments||8,a.depthSegments||8);b.geometry=a;break;case cc.mi:b=this.c;a=a||{};a=new THREE.SphereBufferGeometry(a.radius||10,a.widthSegments||64,a.heightSegments||64,a.phiStart||0,a.phiLength||
2*Math.PI,a.thetaStart||0,a.thetaLength||2*Math.PI);b.geometry=a;break;case cc.Zh:b=this.c;a=a||{};a=new THREE.CylinderBufferGeometry(a.radiusTop||10,a.radiusBottom||10,a.height||20,a.radiusSegments||32,a.heightSegments||1,a.openEnded||!1,a.thetaStart||0,a.thetaLength||2*Math.PI);b.geometry=a;break;case cc.ji:this.c.geometry=dc(a);break;default:this.c.geometry=dc()}}else this.c.geometry=dc();this.c.geometry.scale(this.f.scale.x,this.f.scale.y,this.f.scale.z);this.c.material=this.m.material;this.c.c=
this.A;this.c.f=this.i.renderer.view instanceof Za;this.Yi();this.R=!0;null!==this.H&&this.H.D();this.ba=Rb(this.c);this.c.onBeforeRender=this.J;this.c.onAfterRender=this.I;!0===this.u.autoPlay&&this.u.play()};
...
G.da(this.f.rotation.z),"YXZ");this.c.scale.x=G.X(this.f.scale.x,1E-6,1E5);this.c.scale.y=G.X(this.f.scale.y,1E-6,1E5);this.c.scale.z=G.X(this.f.scale.z,1E-6,1E5)};e.update=function(){null!==this.m&&this.m.update();null!==this.F&&this.F.update()};
e.destroy=function(){this.m.onReady.remove(this.Ci,this);this.I=this.J=null;null!==this.f&&(this.f.destroy(),this.f=null);null!==this.u&&(this.u.destroy(),this.u=null);null!==this.m&&(this.m.destroy(),this.m=null);null!==this.F&&(this.F.destroy(),this.F=null);Ib.prototype.destroy.call(this)};Object.defineProperty(Ub.prototype,"type",{get:function(){return this.j}});Object.defineProperty(Ub.prototype,"name",{get:function(){return this.N}});Object.defineProperty(Ub.prototype,"animation",{get:function(){return this.u}});
function $b(a){this.i=a;this.c=this.u=this.f=null;this.C=0;this.A=1;this.G=!1;this.H=0;this.B=!1;this.m={x:0,y:0,z:200};this.o=360;l.call(this,"HotspotSound")}$b.prototype=Object.create(l.prototype);e=$b.prototype;e.constructor=$b;e.Qk=function(){this.log("Sound load complete");null!==this.f&&this.f.D()};
...
var bc={IMAGE:"image",ki:"plugin",Cd:"graphics"},Zb={pi:{color:"#ffffff",opacity:0,transparent:!1},$h:{color:"#00ff00",opacity:.8,transparent:!1}};e=Yb.prototype;
e.im=function(a){a=a.emitter;this.log("Texture load complete (Image) : "+a.element.src);this.L=a;this.c=new THREE.Texture(a.element);this.c.image.crossOrigin="anonymous";this.c.wrapS=THREE.ClampToEdgeWrapping;this.c.wrapT=THREE.ClampToEdgeWrapping;this.c.minFilter=THREE.LinearFilter;this.c.magFilter=THREE.LinearFilter;this.c.needsUpdate=!0;this.log("Map new texture from image");ec(this)};
e.Ki=function(a){a=a.data;a.uid===this.u.plugin&&(this.i.plugins.onInstanceCreate.remove(this.Ki,this),fc(this,a))};function fc(a,b){!0===b.instanceReady?gc(a,b):b.onInstanceReady.ca(a.$m,a)}e.$m=function(a){a=a.emitter;if(null===a.instance||!1===a.instanceReady)throw Error("Plugin instance not available");gc(this,a)};
...
e.Ne=function(){null!==this.f&&(this.f.dispose(),this.f=null);var a=B.clone(this.i.renderer.view.cc.mapping);this.j===bc.Cd&&(a.fragmentShader=vb.wts_frag_color,a.uniforms.tColor={type:"c",value:new THREE.Color(2105376)});a.uniforms.tOpacity={type:"f",value:this.o};var b=tb.eb(a.vertexShader),d=tb.eb(a.fragmentShader);this.f=new THREE.RawShaderMaterial({fragmentShader:d,vertexShader:b,uniforms:a.uniforms,side:THREE.DoubleSide,name:"HotspotMaterial"});null!==this.c&&(this.f.transparent=this.A,this.f.needsUpdate=
!0);null!==this.m&&this.m.D()};function ec(a){!0===a.i.renderer.viewReady&&a.Ne();a.i.renderer.onViewReady.add(a.Ne,a)}
e.load=function(a){a=this.u=a;this.o="number"===typeof a.opacity?G.X(a.opacity,0,1):1;this.A="boolean"===typeof a.transparent?a.transparent:!1;this.C="string"===typeof a.color?a.color:16777215;this.G="boolean"===typeof a.update?a.update:!1;"undefined"!==typeof a.image&&null!==a.image?(a=a.image,this.j=bc.IMAGE,this.L=new ic(this.i,a),this.L.onLoadComplete.ca(this.im,this)):"undefined"!==typeof a.plugin&&null!==a.plugin?(a=a.plugin,this.j=bc.ki,a=this.i.plugins.get(a),"undefined"===typeof a||null===
a?this.i.plugins.onInstanceCreate.add(this.Ki,this):fc(this,a)):(this.j=bc.Cd,ec(this))};e.update=function(){this.f&&this.f.uniforms&&(this.f.uniforms.tTexture.value=this.c,this.f.uniforms.tOpacity.value=this.o);null!==this.c&&!0===this.G&&(this.c.needsUpdate=!0)};
e.destroy=function(){this.i.renderer.onViewReady.remove(this.Ne,this);null!==this.c&&(this.c.dispose(),this.c=null);null!==this.f&&(this.f.dispose(),this.f=null);this.j===bc.IMAGE&&null!==this.L&&this.L.destroy();this.L=null;null!==this.m&&(this.m.destroy(),this.m=null);this.i=null;l.prototype.destroy.call(this)};Object.defineProperty(Yb.prototype,"type",{get:function(){return this.j}});Object.defineProperty(Yb.prototype,"texture",{get:function(){return this.c}});
...
g.instruction.smooth=a.smooth;g.onComplete.add(this.Ub,this);g.onProgress.add(this.Le,this);v=0;for(x=a.keyframes.length;v<x;v++)b=a.keyframes[v].time+d,h=a.keyframes[v].data.position,"undefined"!==typeof h&&null!==h&&("number"===typeof h.x||"number"===typeof h.y||"number"===typeof h.z||"number"!==typeof h.radius&&"number"!==typeof h.theta&&"number"!==typeof h.phi?(k="undefined"!==typeof h.x&&null!==h.x?h.x:Fb(this,b,a.keyframes,"x",g.tween.easing,"position"),n="undefined"!==typeof h.y&&null!==h.y?
h.y:Fb(this,b,a.keyframes,"y",g.tween.easing,"position"),h="undefined"!==typeof h.z&&null!==h.z?h.z:Fb(this,b,a.keyframes,"z",g.tween.easing,"position")):(k="number"===typeof h.radius?h.radius:Fb(this,b,a.keyframes,"radius",g.tween.easing,"position"),n="number"===typeof h.theta?G.da(h.theta):G.da(Fb(this,b,a.keyframes,"theta",g.tween.easing,"position")),h="number"===typeof h.phi?G.da(h.phi):G.da(Fb(this,b,a.keyframes,"phi",g.tween.easing,"position")),n=G.Wa(Math.PI-n,-Math.PI,Math.PI),h=(new THREE.Vector3).setFromSpherical(B.Ce(k,
n,h)),k=h.x,n=h.y,h=h.z),b=new yb(b+d,{position:{x:k,y:n,z:h}}),g.timeline.lb(b));if(0<g.timeline.keyframes.length&&0<g.timeline.keyframes[0].time||0<d)v={position:B.clone(this.ja.position)},b=new yb(0,v),g.timeline.lb(b);this.c.push(g);g=new zb(this.i,this.ja);g.tween.easing=a.easing;g.instruction=this.j[2];g.instruction.smooth=a.smooth;g.onComplete.add(this.Ub,this);g.onProgress.add(this.Le,this);v=0;for(x=a.keyframes.length;v<x;v++)b=a.keyframes[v].time+d,h=a.keyframes[v].data.scale,"undefined"!==
...
function mc(a,b){var d=Math.tan(G.da(a.upDegrees)),g=Math.tan(G.da(a.downDegrees)),h=Math.tan(G.da(a.leftDegrees)),k=Math.tan(G.da(a.rightDegrees));a=2/(h+k);var h=(h-k)*a*.5,k=2/(d+g),d=(d-g)*k*.5,g=new THREE.Matrix4,n=g.elements;n[0]=a;n[1]=0;n[2]=-h;n[3]=0;n[4]=0;n[5]=k;n[6]=d;n[7]=0;n[8]=0;n[9]=0;n[10]=b.far/(b.near-b.far);n[11]=b.far*b.near/(b.near-b.far);n[12]=0;n[13]=0;n[14]=-1;n[15]=0;g.transpose();return g}
function nc(a){a.A=G.be(a.I,a.F,a.K,!1);a.G=a.A.clone().transpose();a.o=H.lc(a.I,a.F,a.K)}function oc(a){a.A=H.xk(a.o);a.G=a.A.clone().transpose();var b=H.Be(a.o),d=b.pitch,g=b.roll,h=G.nb;pc(a,b.yaw,h);qc(a,d,h);rc(a,g,h);sc(a,null,h)}function tc(a){null!==a.m&&a.m.D(null,!0)}function pc(a,b,d){if("number"!==typeof b||!0===isNaN(b))return!1;d=d===G.Na||d===G.nb?d:G.nb;b=d===G.Na?G.da(b):b;b=G.Wa(b,-Math.PI,Math.PI);b=G.X(b,a.V,a.S);d=a.I!==b;a.I=b;return d}
function qc(a,b,d){if("number"!==typeof b||!0===isNaN(b))return!1;d=d===G.Na||d===G.nb?d:G.nb;b=d===G.Na?G.da(b):b;b=G.Wa(b,-Math.PI,Math.PI);b=G.X(b,a.M,a.W);d=a.F!==b;a.F=b;return d}function rc(a,b,d){if("number"!==typeof b||!0===isNaN(b))return!1;d=d===G.Na||d===G.nb?d:G.nb;b=d===G.Na?G.da(b):b;b=G.Wa(b,-Math.PI,Math.PI);b=G.X(b,a.ba,a.P);d=a.K!==b;a.K=b;return d}
function sc(a,b,d){if("number"!==typeof b||!0===isNaN(b))return!1;d=d===G.Na||d===G.nb?d:G.nb;b=d===G.Na?G.da(b):b;b=G.X(b,a.N,a.J);d=a.H!==b;a.H=b;return d}
L.prototype.load=function(a){a=this.R=B.ab(kc,a);this.B=a.parallax;this.U=50*this.B;this.V=G.da(a.yaw.min);this.S=G.da(a.yaw.max);pc(this,a.yaw["default"],G.Na);this.M=G.da(a.pitch.min);this.W=G.da(a.pitch.max);qc(this,a.pitch["default"],G.Na);this.ba=G.da(a.roll.min);this.P=G.da(a.roll.max);rc(this,a.roll["default"],G.Na);"undefined"!==typeof a.fov.min&&(this.N=G.da(a.fov.min));"undefined"!==typeof a.fov.max&&(this.J=G.da(a.fov.max));sc(this,a.fov["default"],G.Na);nc(this);tc(this);this.u.load(a.gaze)};
L.prototype.fk=function(a,b,d,g,h,k,n){"number"===typeof h&&h?(a=new uc({easing:{default:n||"LINEAR",start:0},keyframes:[{time:h,data:{yaw:a,pitch:b,roll:d,fov:g}}]}),this.animation.play(a.uid)):(h=G.Na,pc(this,a,h),qc(this,b,h),rc(this,d,h),sc(this,g,h),nc(this),tc(this))};
L.prototype.update=function(){if(null!==this.c){var a=(new THREE.Matrix4).copy(this.G);this.B&&a.multiply((new THREE.Matrix4).makeTranslation(0,0,-this.U));this.c.quaternion.setFromRotationMatrix(a);this.c.matrixWorld=a;this.c.matrixWorldInverse.getInverse(a);this.c.fov=G.$b(this.H);this.c.aspect=this.i.renderer.displayResolution.ratio;this.c.updateProjectionMatrix()}if(!0===this.i.renderer.display.presentingVR){this.u.update();var a=this.i.renderer.display,b=a.Hj();null!==b&&(this.o=b,oc(this));
var b=a.vrDisplay.getEyeParameters("left"),d=a.vrDisplay.getEyeParameters("right");this.c.matrixWorld.decompose(this.j.position,this.j.quaternion,this.j.scale);this.j.matrixWorld=(new THREE.Matrix4).makeRotationFromQuaternion(this.c.quaternion);this.c.matrixWorld.decompose(this.f.position,this.f.quaternion,this.f.scale);this.f.matrixWorld=(new THREE.Matrix4).makeRotationFromQuaternion(this.c.quaternion);this.j.matrixWorld.elements[12]=this.c.matrixWorld.elements[12]+b.offset[0];this.j.matrixWorld.elements[13]=
...
Object.defineProperty(L.prototype,"fovMin",{get:function(){return G.$b(this.N)},set:function(a){this.N=G.da(a)}});Object.defineProperty(L.prototype,"fovMax",{get:function(){return G.$b(this.J)},set:function(a){this.J=G.da(a)}});Object.defineProperty(L.prototype,"quaternion",{get:function(){return this.o},set:function(a){this.o=a;oc(this);tc(this)}});Object.defineProperty(L.prototype,"animation",{get:function(){null===this.C&&(this.C=new vc(this.i,this));return this.C}});
Object.defineProperty(L.prototype,"parallax",{get:function(){return this.B},set:function(a){this.B=G.X(a,0,1);tc(this)}});Object.defineProperty(L.prototype,"modelView",{get:function(){return this.A}});Object.defineProperty(L.prototype,"modelViewInverse",{get:function(){return this.G}});Object.defineProperty(L.prototype,"main",{get:function(){null===this.c&&lc(this);return this.c}});Object.defineProperty(L.prototype,"perspectiveCameraRadius",{get:function(){return this.U}});
Object.defineProperty(L.prototype,"left",{get:function(){return this.j}});Object.defineProperty(L.prototype,"right",{get:function(){return this.f}});Object.defineProperty(L.prototype,"gaze",{get:function(){return this.u}});Object.defineProperty(L.prototype,"onCameraChange",{get:function(){null===this.m&&(this.m=new q(this));return this.m}});function vc(a,b){Eb.call(this,a,b,"CameraAnimation");wc(this)}vc.prototype=Object.create(Eb.prototype);vc.prototype.constructor=vc;
function wc(a){a.j=[{prop:"quaternion",smooth:!0,Cj:function(){!0===this.Ia.cancelRoll&&(this.ja.quaternion=H.cancelRoll(this.ja.quaternion))},cancelRoll:!0},{prop:"fov",smooth:!1}]}
...
function zc(a){var b=new THREE.MeshBasicMaterial({color:a.f.progress.color,opacity:a.f.progress.opacity,transparent:!0,side:THREE.DoubleSide}),b=new THREE.Mesh(yc(a.f.progress.innerRadius,a.f.progress.outerRadius,32,1,Math.PI/2,a.o/100*G.ri),b);b.name="progress";b.rotateY(Math.PI);a.c.add(b)}function Ac(a,b){for(var d=null,g=0,h=a.c.children.length;g<h;g++)a.c.children[g].name===b&&(d=a.c.children[g]);null!==d&&(a.c.remove(d),d.geometry.dispose(),d.material.dispose())}
e.gn=function(){this.stop();this.i.renderer.pickingManager.click()};e.load=function(a){this.f=a;Ac(this,"progress");Ac(this,"cursor");xc(this);!0===this.A&&this.o&&zc(this)};e.start=function(){this.log("startGazeAnimation");this.A=!0;this.o=0;Ac(this,"progress");zc(this);null!==this.m&&(this.m.stop(),this.u=this.m.add(2E3,this.gn,this),this.m.start())};
...
e.Yg=function(a){!1!==this.i.controllers.enabled&&(this.i.canvas.pointer.onPanMove.add(this.He,this),this.log("_panStartHandler ("+a.data.velocityX.toFixed(2)+", "+a.data.velocityY.toFixed(2)+")"),this.C=!0,this.o=new THREE.Vector2(a.data.center.x,a.data.center.y),this.G.copy(this.o),this.m.set(0,0),null!==this.j&&this.j.D(),this.i.controllers.se(this))};e.He=function(a){!1!==this.i.controllers.enabled&&this.G.set(a.data.center.x,a.data.center.y)};
e.Xg=function(){this.i.canvas.pointer.onPanMove.remove(this.He,this);this.log("_panEndHandler");this.C=!1;this.m.set(0,0);this.o.set(0,0);this.G.copy(this.o);null!==this.f&&this.f.D();this.i.controllers.re(this)};e.$g=function(a){!1!==this.i.controllers.enabled&&(this.i.canvas.pointer.onPinchMove.add(this.Zg,this),this.log("_pinchStartHandler "+a))};e.Zg=function(a){!1!==this.i.controllers.enabled&&this.log("_pinchMoveHandler "+a.data.pinch)};
e.Ie=function(a){this.i.canvas.pointer.onPinchMove.remove(this.Zg,this);this.log("_pinchEndHandler "+a)};e.ah=function(a){if(!1!==this.i.controllers.enabled){a.data.preventDefault();var b=(this.B.invert?1:-1)/this.B.hardness,d=1;if(a.data.deltaMode)switch(a.data.deltaMode){case 1:d=33.3;break;case 2:d=self.innerHeight;break;default:d=1}a.data.deltaY&&(b*=a.data.deltaY*d/5);this.c.fov=this.c.fov-b;this.log("_wheelHandler (fov:"+this.c.fov+")")}};
e.enable=function(){Gc.prototype.enable.call(this);this.i.canvas.pointer.onPanStart.add(this.Yg,this);this.i.canvas.pointer.onPanEnd.add(this.Xg,this);this.i.canvas.pointer.onPinchStart.add(this.$g,this);this.i.canvas.pointer.onPinchEnd.add(this.Ie,this);this.i.canvas.pointer.onWheel.add(this.ah,this)};
e.Gb=function(){Gc.prototype.Gb.call(this);this.i.canvas.pointer.onPanStart.remove(this.Yg,this);this.i.canvas.pointer.onPanMove.remove(this.He,this);this.i.canvas.pointer.onPanEnd.remove(this.Xg,this);this.i.canvas.pointer.onPinchStart.remove(this.$g,this);this.i.canvas.pointer.onPinchMove.remove(this.Ie,this);this.i.canvas.pointer.onPinchEnd.remove(this.Ie,this);this.i.canvas.pointer.onWheel.remove(this.ah,this)};
...
[90,38],this.Vd,this.Xd,this.Wd,[83,40],this,"up"),this.m.push(a),a=new P(this.i,[83,40],this.Vd,this.Xd,this.Wd,[90,38],this,"down"),this.m.push(a),a=new P(this.i,107,this.Zi,this.aj,this.$i,109,this,"plus"),this.m.push(a),a=new P(this.i,109,this.Zi,this.aj,this.$i,107,this,"minus"),this.m.push(a));if(!0===Array.isArray(b.bindings))for(var a=0,d=b.bindings.length;a<d;a++){var g=b.bindings[a],h=g.in,k=g.out,n=g.name,g=g.events;!1===B.T(h,"number")&&!1===B.Ga(h,"number")?this.warn("Can't add custom keyboard binding, keys in are invalid!"):
"object"!==typeof g&&null===g?this.warn("Can't add custom keyboard binding, events are invalid!"):(h=new P(this.i,h,g.onDown,g.onUp,g.onHold,k,this,n),this.m.push(h))}!0===this.A&&this.enable()};e.Vd=function(a){if(!1!==this.i.controllers.enabled){this.C=!0;switch(a.name){case "left":case "right":this.u.setX(0);break;case "up":case "down":this.u.setY(0)}null!==this.j&&this.j.D();this.i.controllers.se(this)}};
e.Wd=function(a){if(!1!==this.i.controllers.enabled)switch(a.name){case "left":this.o.setX(this.o.x-5);break;case "right":this.o.setX(this.o.x+5);break;case "up":this.o.setY(this.o.y-5);break;case "down":this.o.setY(this.o.y+5)}};e.Xd=function(a){this.C=!1;switch(a.name){case "left":case "right":this.u.setX(0);this.o.setX(0);break;case "up":case "down":this.u.setY(0),this.o.setY(0)}null!==this.f&&this.f.D();this.i.controllers.re(this)};
e.Zi=function(a){!1!==this.i.controllers.enabled&&(this.C=!0,Lc(this,a),null!==this.j&&this.j.D(),this.i.controllers.se(this))};e.$i=function(a){Lc(this,a)};e.aj=function(){this.C=!1;null!==this.f&&this.f.D();this.i.controllers.re(this)};function Lc(a,b){var d=(a.F.invert?1:-1)/a.F.hardness;switch(b.name){case "minus":d*=10;break;case "plus":d*=-10}a.c.fov=a.c.fov-d}e.enable=function(){Gc.prototype.enable.call(this);for(var a,b=0,d=this.m.length;b<d;b++)a=this.m[b],this.i.keyboard.Qf(a)};
...
e.boot=function(){this.c=[];if(!0===N.Pg)try{"function"===typeof window.AudioContext?this.f=new window.AudioContext:this.f=new window.webkitAudioContext}catch(a){this.f=null,this.m=!1}!0===N.Rf&&null===this.f&&(this.m=!1,this.I=!0);null!==this.f&&(this.o="undefined"===typeof this.f.createGain?this.f.createGainNode():this.f.createGain(),this.K=this.f.createAnalyser(),this.K.connect(this.o),this.o.gain.value=this.j,this.o.connect(this.f.destination),this.f.listener.setOrientation(0,0,-1,0,1,0));this.i.story.onSceneLoadStart.add(this.Lh,
this)};e.Lh=function(){if("undefined"!==typeof this.i.story.scene.config.audio){var a=B.ab(this.J,this.i.story.scene.config.audio);Mc(this,a)}else Mc(this,this.J);!1===this.R?null!==this.u&&this.u.D():null!==this.A&&this.A.D()};
...
e.destroy=function(){this.i.story.onSceneLoadStart.remove(this.Lh,this);this.J=this.i=null;for(var a=this.c.length;a--;)this.c[a].destroy();this.o=this.K=this.f=this.c=null;null!==this.C&&(this.C.destroy(),this.C=null);null!==this.G&&(this.G.destroy(),this.G=null);null!==this.H&&(this.H.destroy(),this.H=null);null!==this.u&&(this.u.destroy(),this.u=null);null!==this.A&&(this.A.destroy(),this.A=null);l.prototype.destroy.call(this)};Object.defineProperty(u.prototype,"context",{get:function(){return this.f}});
...
Object.defineProperty(u.prototype,"useAudioTag",{get:function(){return this.I},set:function(a){"boolean"===typeof a&&(this.I=a,this.m=!a)}});Object.defineProperty(u.prototype,"enabled",{get:function(){return this.R}});Object.defineProperty(u.prototype,"muted",{get:function(){return this.B},set:function(a){"boolean"===typeof a&&(!0===a?this.bb():this.Mh())}});
...
this.la=!1);this.O=this.ga;ba(this);!0===this.i.audio.useWebAudio&&(this.f=this.i.audio.context,this.Ca=this.i.audio.inputNode,this.H="undefined"===typeof this.f.createGain?this.f.createGainNode():this.f.createGain(),this.H.gain.value=this.C*this.i.audio.volume,this.H.connect(this.Ca));if(!0===this.i.audio.useAudioTag||!0===Pc(this))!0===this.i.cache.has(A.pb,this.ga)&&this.Oh(this.i.cache.get(A.pb,this.ga)),this.i.audio.onVolumeChange.add(this.Ph,this);this.i.audio.onDisable.add(this.Nh,this);""!==
this.j&&(this.i.load.sound(this.ga,this.j,this.Oh,this,Pc(this)),null!==this.M&&this.M.D());this.i.audio.add(this)}M.prototype=Object.create(l.prototype);e=M.prototype;e.constructor=M;
e.Oh=function(a){this.I=a;this.fa=!0;null!==this.P&&this.P.D();!0===this.i.audio.useWebAudio?(a=this.I)&&!1===this.wa&&(this.ra=this.ti.bind(this),this.sa=this.cm.bind(this),!0===Pc(this)?(this.ma=Omnitone.createFOADecoder(this.f,a.data,{channelMap:this.Fa}),this.ma.initialize().then(this.ra,this.sa)):this.f.decodeAudioData(a.data,this.ra,this.sa)):(Qc(this),this.ti(null))};e.cm=function(){null!==this.I&&(this.I.data=null,this.wa=!1)};
function Qc(a){null!==a.xa&&a.xa.D();null!==a.R&&a.R.D();null!==a.U&&a.U.D()}e.ti=function(a){if(null===this.I)this.log("$_Sound._decodeComplete error, sound file is null");else{a&&(this.I.data=a);this.wa=!0;Qc(this);if(!0===this.i.audio.useAudioTag||!0===Pc(this))this.c=this.i.cache.get(A.pb,this.ga),Rc(this),this.o=0,this.c.data.duration&&(this.o=this.c.data.duration,this.K=Math.ceil(1E3*this.o));!0===this.ya&&this.play(this.A,this.N,!0)}};e.Ph=function(){Rc(this)};
function Rc(a){null===a.c||!0!==a.i.audio.useAudioTag&&!0!==Pc(a)||(a.c.data.volume=G.X(a.C,0,1)*a.i.audio.volume)}e.Nh=function(){!0===this.u?this.pause():!1===this.paused&&this.stop()};function Sc(a){a.A=0;a.ya=!1;a.u=!1;a.B=!1}
...
this.F=this.i.clock.time),b=G.pd(a/1E3),"undefined"===typeof this.c.start?this.c.noteGrainOn(0,b%this.o,this.o):this.c.start(0,b%this.o,this.o),this.u=!0,this.A=a,this.Aa++,null!==this.G&&this.G.D();else{this.log("Sound is not decoded yet");this.ya=!0;return}else if(!0===this.i.audio.useAudioTag||!0===Pc(this))this.o?Infinity===this.o&&(this.c.data.loop=!0):(this.o=this.c.data.duration,this.K=Math.ceil(1E3*this.o)),!isNaN(a)&&this.K&&a<this.K?(this.c.data.currentTime=G.pd(a/1E3),this.F=this.i.clock.time-
a):(a=0,this.c.data.currentTime=a,this.F=this.i.clock.time),this.c.data.play(),this.u=!0,this.A=a,this.Aa++,null!==this.G&&this.G.D();this.i.audio.Sf()}}};e.stop=function(a){null!==this.c?(Uc(this,!0),this.F=this.za=this.i.clock.time,this.B=this.u=this.ya=!1,null!==this.oa&&!0===a&&this.oa.D(),this.i.audio.Tf()):!1!==this.fa&&!0===this.wa||Sc(this)};
function Uc(a,b){if(!0===a.i.audio.useWebAudio&&!1===Pc(a)){if("undefined"===typeof a.c.stop)a.c.noteOff(0);else try{a.c.stop(0)}catch(d){}a.c.disconnect(0);!0===b&&(a.A=0)}else if(!0===a.i.audio.useAudioTag||!0===Pc(a))a.c.data.pause(),!0===b&&(a.A=0,a.c.data.currentTime=0)}e.pause=function(){!0===this.u&&null!==this.c?(Uc(this,!1),this.B=!0,this.za=this.i.clock.time,this.u=this.ya=!1,null!==this.S&&this.S.D(),this.i.audio.Tf()):!1!==this.fa&&!0===this.wa||Sc(this)};
e.resume=function(){if(!1!==this.i.audio.enabled&&!1!==this.J)if(!0===this.B||!1===this.u)if(null===this.c)this.play(this.A,this.N,!0);else{this.F=this.i.clock.time-(this.za-this.F);this.A=this.i.clock.time-this.F;var a=G.pd(this.A/1E3);if(!0===this.i.audio.useWebAudio&&!1===Pc(this)){this.c=this.f.createBufferSource();this.c.buffer=this.ia;!0===this.$?Tc(this,!0):this.c.connect(this.H);var b=Math.ceil((this.K-this.A)/1E3);"undefined"===typeof this.c.start?this.c.noteGrainOn(0,a%this.o,b):this.c.start(0,
a%this.o,b)}else if(!0===this.i.audio.useAudioTag||!0===Pc(this))this.c.data.currentTime=G.pd(a/1E3),this.c.data.play();this.u=!0;this.B=!1;null!==this.V&&this.V.D();this.i.audio.Sf()}else if(!1===this.fa||!1===this.wa)Sc(this),this.ya=!0};
...
e.Qh=function(){!1!==this.ea&&!1!==this.i.audio.enabled&&!1!==this.J&&(this.ea=!1,this.C=this.pa,!0===this.i.audio.useWebAudio&&!1===Pc(this)?this.H.gain.value=this.pa:!0!==this.i.audio.useAudioTag&&!0!==Pc(this)||null===this.c||(this.c.data.volume=this.pa),null!==this.na&&this.na.D())};
e.destroy=function(){this.stop();!0!==this.i.audio.useAudioTag&&!0!==Pc(this)||this.i.audio.onVolumeChange.remove(this.Ph,this);this.i.audio.onDisable.remove(this.Nh,this);this.i.audio.remove(this);this.sa=this.ra=this.m=this.H=this.Ca=this.f=this.ia=this.c=this.I=this.i=null;null!==this.xa&&(this.xa.destroy(),this.xa=null);null!==this.M&&(this.M.destroy(),this.M=null);null!==this.P&&(this.P.destroy(),this.P=null);null!==this.R&&(this.R.destroy(),this.R=null);null!==this.U&&(this.U.destroy(),this.U=
...
Object.defineProperty(M.prototype,"ambisonic",{get:function(){return this.la}});Object.defineProperty(M.prototype,"duration",{get:function(){return this.o}});Object.defineProperty(M.prototype,"muted",{get:function(){return this.ea||this.i.audio.bb},set:function(a){"boolean"===typeof a&&(!0===a?this.bb():this.Qh())}});
...
this.f=this.N;null!==this.C&&this.C.D()}Q.prototype=Object.create(l.prototype);e=Q.prototype;e.constructor=Q;e.Zd=function(){0<this.c.length&&this.c.indexOf(this.f)+1===this.c.length&&(!1===this.F||!0===this.track.loop)?this.f=this.c[0]:this.nd()};e.dl=function(){null!==this.A&&this.A.D()};e.fl=function(){null!==this.H&&this.H.D()};e.cl=function(){null!==this.u&&this.u.D()};e.el=function(){null!==this.G&&this.G.D()};e.bl=function(){null!==this.o&&this.o.D()};e.gl=function(){return!!this.c.length};
...
function Xc(a,b){return null!==b&&!0===p.T(b,"Playlist")?(null!==a.playlist&&a.playlist.uid===b?null!==a.playlist.track&&"undefined"!==typeof a.playlist.track.uid&&""!==a.playlist.track.uid?!0===a.paused?a.resume():!1===a.playing&&a.play(b,!0):(a.stop(),a.play(b,!0)):(a.stop(),a.play(b,!0)),!0):!1}function Wc(a){!0===a.playing?a.pause():a.stop()}e.Yk=function(){null!==this.H&&this.H.D();null!==this.playlist&&Q.prototype.dl.call(this.playlist)};
e.$k=function(){null!==this.F&&this.F.D();null!==this.playlist&&Q.prototype.fl.call(this.playlist)};e.Xk=function(){null!==this.G&&this.G.D();null!==this.playlist&&Q.prototype.cl.call(this.playlist)};e.Zk=function(){null!==this.B&&this.B.D();null!==this.playlist&&Q.prototype.el.call(this.playlist)};e.Wk=function(){null!==this.C&&this.C.D();null!==this.playlist&&Q.prototype.bl.call(this.playlist)};e.add=function(a){this.c.push(a)};e.sh=function(a){this.u.push(a)};e.Hn=function(){return!!this.c.length};
e.al=function(){return!!this.u.length};e.play=function(a,b){var d;if("string"===typeof a&&p.T(a,"Playlist"))d=a;else if(B.T(a,"Playlist"))d=a.uid;else if("number"===typeof a&&0<=a&&a<this.c.length)d=this.c[a].uid;else if(""!==this.j)d=this.j;else if("undefined"===typeof a||""===a)d=this.c[0].uid;"undefined"!==typeof d&&(!0===this.playing&&this.stop(),this.j=d,!0===this.m&&(this.o=!1,this.playlist.play(null,b),this.log("$_PlaylistManager.play(); [uid: "+this.j+"]")))};
e.stop=function(){null!==this.playlist&&this.playlist.stop()};e.pause=function(){null!==this.playlist&&!0===this.playlist.playing&&(this.o=!0,this.playlist.pause())};e.resume=function(){if(null!==this.playlist&&!0===this.m&&!0===this.playlist.paused){var a=this.o;this.o=!1;!0===a&&this.f!==this.j?Xc(this,this.f):this.playlist.resume()}};e.nd=function(){null!==this.playlist&&!0===this.m&&this.playlist.nd()};e.xe=function(){null!==this.playlist&&!0===this.m&&this.playlist.xe()};
e.destroy=function(){this.stop();this.i.audio.onEnable.remove(this.wi,this);this.i.story.onSceneLoadStart.remove(this.rh,this);this.K=this.i=null;for(var a=this.c.length;a--;)this.c[a].destroy();this.c=null;for(a=this.u.length;a--;)this.u[a].destroy();this.u=null;l.prototype.destroy.call(this)};Object.defineProperty(z.prototype,"playlists",{get:function(){return this.c}});Object.defineProperty(z.prototype,"tracks",{get:function(){return this.u}});
...
function sa(a){this.i=a;this.j=this.c=null;this.M=this.W=this.P=!1;this.J=-1;this.K=this.o=null;l.call(this,"Director");this.Ge()}sa.prototype=Object.create(l.prototype);e=sa.prototype;e.constructor=sa;e.Ge=function(){this.o=this.i.clock.create(!1);this.i.story.onSceneLoadComplete.add(this.Si,this);this.i.onReady.add(this.bh,this)};e.load=function(a){if(null!==a.tracks&&Array.isArray(a.tracks))for(var b=0,d=a.tracks.length;b<d;b++)new uc(a.tracks[b])};
e.bh=function(){this.i.controllers.onControlStart.add(this.Zc,this);this.i.controllers.onControlEnd.add(this.Yc,this)};
e.Si=function(){var a=this.i.story.scene;this.stop();Zc(this);this.c=null;this.j=[];"undefined"!==typeof a.config.director&&(a=a.config.director.animation,"undefined"!==typeof a&&null!==a&&!1!==a.enabled&&(this.P="boolean"===typeof a.loop?a.loop:!1,this.W="boolean"===typeof a.random?a.random:!1,this.M="boolean"===typeof a.stoppable?a.stoppable:!1,this.J="number"===typeof a.idleTime?a.idleTime:0,null!==a.tracks&&B.Ga(a.tracks,"string")&&(this.j=!0===this.W?B.od(a.tracks):a.tracks),this.i.renderer.camera.animation.onComplete.add(this.Hi,
this),"undefined"!==typeof this.i.story.scene.config.media&&this.i.story.scene.config.media.type===Ja.VIDEO&&(this.i.renderer.media.displayObject.onPause.add(this.Yd,this),this.i.renderer.media.displayObject.onWaiting.add(this.Wb,this),this.i.renderer.media.displayObject.onStalled.add(this.Wb,this),this.i.renderer.media.displayObject.onEnded.add(this.xi,this),this.i.renderer.media.displayObject.onCurrentTimeChange.add(this.Wi,this),document.addEventListener(N.Lg,null)),"number"===typeof a.delay&&
(this.K=this.o.add(a.delay,this.Kf,this),this.o.start())))};e.Yd=function(){this.stop();this.i.renderer.media.displayObject.onPause.remove(this.Yd,this);this.i.renderer.media.displayObject.onPlay.add(this.Mf,this);this.i.controllers.onControlStart.remove(this.Zc,this);this.i.controllers.onControlEnd.remove(this.Yc,this)};
e.Mf=function(){null!==this.c&&this.play(this.c);this.i.renderer.media.displayObject.onPause.add(this.Yd,this);this.i.renderer.media.displayObject.onPlay.remove(this.Mf,this);this.i.controllers.onControlStart.add(this.Zc,this);this.i.controllers.onControlEnd.add(this.Yc,this)};
e.Wb=function(){this.stop();this.i.renderer.media.displayObject.onWaiting.remove(this.Wb,this);this.i.renderer.media.displayObject.onStalled.remove(this.Wb,this);this.i.renderer.media.displayObject.onPlaying.add(this.Nf,this);this.i.controllers.onControlStart.remove(this.Zc,this);this.i.controllers.onControlEnd.remove(this.Yc,this)};
e.Nf=function(){null!==this.c&&this.play(this.c);this.i.renderer.media.displayObject.onPlaying.remove(this.Nf,this);this.i.renderer.media.displayObject.onWaiting.add(this.Wb,this);this.i.renderer.media.displayObject.onStalled.add(this.Wb,this);this.i.controllers.onControlStart.add(this.Zc,this);this.i.controllers.onControlEnd.add(this.Yc,this)};e.xi=function(){!0===this.i.renderer.media.displayObject.loop&&this.Si()};e.Zc=function(){null!==this.c&&!0===this.M&&this.stop();this.o.stop(!0)};
e.Yc=function(){null!==this.K&&this.o.remove(this.K);null!==this.c&&!0===this.M&&(null===this.c&&"number"===typeof this.i.story.scene.config.director.animation.delay?(this.K=this.o.add(this.i.story.scene.config.director.animation.delay,this.Kf,this),this.o.start()):"number"===typeof this.J&&-1<this.J&&(this.K=this.o.add(this.J,this.Kf,this),this.o.start()))};
e.Hi=function(){if(1<this.j.length){var a=this.j.indexOf(this.c)+1;if(a<this.j.length){this.play(a);return}}!0===this.P&&(!0===this.W&&(this.j=B.od(this.j)),this.play(0))};e.Kf=function(){this.play(this.c);this.o.stop(!0)};
e.Wi=function(a){this.stop();this.c=null;"number"===typeof a?a*=1E3:"number"===typeof a.data?a=1E3*a.data:a=this.i.renderer.media.displayObject.currentTimeMS;var b=0,d,g;g=p.get(this.j[0]);if(g.duration>a)this.c=g.uid;else for(var h=1,k=this.j.length-1;h<k;h++){d=g;g=p.get(this.j[h]);if(d.duration+b<a&&g.duration+d.duration+b>a){this.c=g.uid;break}b+=d.duration}null===this.c?(a=g.keyframes[g.keyframes.length-1].data,this.i.renderer.camera.fk(a.yaw,a.pitch,a.roll,a.fov)):this.i.renderer.camera.animation.play(this.c)};
...
function Zc(a){a.i.renderer.camera.animation.onComplete.remove(a.Hi,a);"undefined"!==typeof a.i.story.scene.config.media&&a.i.story.scene.config.media.type===Ja.VIDEO&&(a.i.renderer.media.displayObject.onPlay.remove(a.Mf,a),a.i.renderer.media.displayObject.onPause.remove(a.Yd,a),a.i.renderer.media.displayObject.onWaiting.remove(a.Wb,a),a.i.renderer.media.displayObject.onStalled.remove(a.Wb,a),a.i.renderer.media.displayObject.onPlaying.remove(a.Nf,a),a.i.renderer.media.displayObject.onEnded.remove(a.xi,
a),a.i.renderer.media.displayObject.onCurrentTimeChange.remove(a.Wi,a))}e.destroy=function(){Zc(this);this.i.onReady.remove(this.bh,this);this.c=this.j=this.i=null;l.prototype.destroy.call(this)};function uc(a){this.G=this.o=!1;Hb.call(this,"DirectorTrack");this.j(a)}uc.prototype=Object.create(Hb.prototype);uc.prototype.constructor=uc;uc.prototype.j=function(a){this.o=a.smooth;this.G=a.cancelRoll;Hb.prototype.j.call(this,a)};Object.defineProperty(uc.prototype,"smooth",{get:function(){return this.o}});
...
$c.prototype.yb=function(){var a=bd(this,this.ja);if(null!==a){if(null!==this.c){var b=this.c;if("undefined"!==typeof a[b.name])switch("undefined"===typeof b.operation&&(b.operation=ad.Bf),b.operation){case ad.Bf:a[b.name]=b.value;break;case ad.Xh:a[b.name]+=b.value;break;case ad.ni:a[b.name]-=b.value;break;case ad.gi:a[b.name]*=b.value;break;case ad.bi:a[b.name]/=b.value;break;case ad.oi:a[b.name]=!a[b.name]}}if(null!==this.f&&(b=this.f,"function"===typeof a[b.name])){var d="undefined"!==typeof b.args?
...
function cd(a){a.A=B.ab(a.G.defaultConfig,a.H,a.K);a.J=a.A.options||{};a.hb=a.A.data||{};a.I=a.A.actions||{};for(var b in a.j)a.j[b].destroy(),a.j[b]=null;b=a.A.events;a.j={};var d,g;for(g in b)d=new ac(a.i),d.c(b[g]),a.j[g]=d}e.Zj=function(){!0===this.G.loaded?dd(this):this.G.onLoadComplete.ca(this.gm,this)};e.gm=function(){dd(this)};
function dd(a){a.log("Plugin._instantiatePlugin(); "+a.O);var b=a.H;"string"===typeof b.parent&&(a.m=b.parent);a.U="boolean"===typeof b.keep?b.keep:!0;a.N="boolean"===typeof b.reset?b.reset:!0;null===a.F&&!0===B.Ga(b.scenes,"string")&&(a.F=b.scenes);cd(a);a.c=a.G.Gj(a);a.c.boot.call(a.c);null!==a.o&&a.o.D()}e.Un=function(){this.R=!0;null!==this.u&&this.u.D()};e.update=function(){null!==this.c&&"function"===typeof this.c.update&&this.c.update.call(this.c)};
e.qk=function(){cd(this);null!==this.c&&("function"===typeof this.c.reset?this.c.reset.call(this.c):this.warn("There is no reset function on plugin "+this.G.uid))};
...
7)||"https://"===String(a[x]).substring(0,8)?a[x]:this.o+a[x],"css"===Da(d).extension?this.i.load.nj(d,this.Bi,this):this.i.load.Fg(d,this.Bi,this)}}this.log("$_Plugin._manifestLoadComplete();")};
...
k.engine+" doesn't exist";k=new R(h.i,n,k,"number"===typeof k.index?k.index:h.c.size);k.onInstanceCreate.ca(h.Am,h);h.c.add(k);k.Zj()}}}function ld(a,b){if("undefined"!==typeof b)for(var d=0,g=b.length;d<g;d++){var h=!1!==b[d].enabled?!0:!1,k=a.de(b[d].instance),n=null;!0===h&&(n=b[d]);null!==k&&(k.contextualConfig=n)}}e.Am=function(a){a=a.emitter;null!==this.f&&this.f.D(a)};e.boot=function(){this.j=new md;this.c=new md;this.i.story.onSceneLoadStart.add(this.hl,this)};
e.ha=function(a){this.o=a;this.m="boolean"===typeof a.enabled?a.enabled:!0;this.u="string"===typeof a.prefix?a.prefix:"./plugins/"};e.de=function(a){for(var b,d=0,g=this.c.size;d<g;d++)if(b=this.c.get(d),b.uid===a)return b;return null};e.Ej=function(a){a=this.c.get(a);return"undefined"!==typeof a?a:null};e.get=function(a){var b=null;"string"===typeof a?b=this.de(a):"number"===typeof a&&(b=this.Ej(a));return b};e.remove=function(a){a=this.get(a);a.destroy();this.c.remove(a)};
...
e.co=function(a){a=new za(this.i,a);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};e.eo=function(a){a=new S(this.i,a);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};e.sound=function(a,b){a=new M(this.i,a,b);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};e.un=function(a){a=new t(this.i,a);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};e.jl=function(a){a=new T(this.i,a);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};
e.image=function(a,b){var d=a;"string"===typeof a&&(d={key:null,url:a});d.key=this.Vb.uid+"-"+d.key;!1!==b&&(d.url=this.Vb.fullUrl+d.url);a=new I(this.i,d);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};e.ao=function(a,b){a.key=this.Vb.uid+"-"+a.key;!1!==b&&(a.url=this.Vb.fullUrl+a.url,a.frames=this.Vb.fullUrl+a.frames);a=new nd(this.i,a);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};e.il=function(a){a=new od(this.i,a);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};
e.ll=function(a,b,d,g,h){var k;"undefined"!==typeof d&&d.toLowerCase()===Ma.af?k=new J(this.i,a,b,g):k=new K(this.i,a,b,g,h);k.onDestroy.ca(this.kb,this);this.Z.push(k);return k};e.canvas=function(){var a=new ia(this.i);a.onDestroy.ca(this.kb,this);this.Z.push(a);return a};e.kl=function(a){a=new Ab(this.i,a);a.onDestroy.ca(this.kb,this);this.i.tween.add(a);this.Z.push(a);return a};e.rj=function(){this.log("destroyAllObjects();");for(var a=this.Z.length;a--;)this.Z[a].destroy()};
e.destroy=function(){this.rj();this.Z=this.Vb=this.i=null;l.prototype.destroy.call(this)};
var N=function(a){a=a();a.prototype=Object.create(null);a.prototype.constructor=a;a.prototype.Zl=function(){if(/Playstation Vita/.test(this.aa))this.cb="Playstation Vita",this.Mg=!0;else if(/Xbox/.test(this.aa))this.cb="Xbox",this.Vg=!0;else if(/Kindle/.test(this.aa)||/\bKF[A-Z][A-Z]+/.test(this.aa)||/Silk.*Mobile Safari/.test(this.aa))this.cb="Kindle",this.pg=!0;else if(/Windows Phone/i.test(this.aa)||/IEMobile/i.test(this.aa))this.cb="Windows Phone",this.Fe=!0,/Windows Phone (\d+)/.test(this.aa)&&
(this.Zb=parseInt(RegExp.$1,10));else if(/Android/.test(this.aa))this.cb="Android",this.fj=!0,/Android ([\.\_\d]+)/.test(this.aa)&&(this.Zb=parseInt(RegExp.$1,10));else if(/CrOS/.test(this.aa))this.cb="Chrome OS",this.Vf=!0;else if(/iP[ao]d|iPhone/i.test(this.aa))this.cb="iOS",this.Fc=!0,/OS (\d+)/.test(navigator.appVersion)&&(this.Zb=parseInt(RegExp.$1,10));else if(/(Linux|X11)/.test(this.aa))this.cb="Linux",this.qg=!0;else if(/Mac OS X/.test(this.aa))this.cb="Mac OS X",this.tg=!0,/Mac OS X (10[\.\_\d]+)/.test(this.aa)&&
(this.Zb=parseInt(RegExp.$1,10));else if(/Windows/.test(this.aa)||/WPDesktop/i.test(this.aa))/WPDesktop/i.test(this.aa)?(this.cb="Windows Phone",this.Fe=!0):(this.cb="Windows",this.Ug=!0),/(Windows 10.0|Windows NT 10.0)/.test(this.aa)?this.Zb=10:/(Windows 8.1|Windows NT 6.3)/.test(this.aa)||/(Windows 8|Windows NT 6.2)/.test(this.aa)?this.Zb=8:/(Windows 7|Windows NT 6.1)/.test(this.aa)&&(this.Zb=7)};a.prototype.Ql=function(){this.jd="undefined"!==typeof document.documentMode;this.ae=!1===this.jd&&
!0===!!window.StyleMedia;this.cg="undefined"!==typeof window.InstallTrigger;this.opera=!0===!!window.opr||0<=this.aa.indexOf(" OPR/")||0<=this.aa.indexOf("Opera");this.Cg=0<Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor");this.chrome=!1===this.jd&&!1===this.ae&&!1===this.opera&&(!0===!!window.chrome||0<=this.aa.indexOf("CriOS"));if(this.ae)this.mb="Edge",/Edge\/(\d+)/.test(this.aa)&&(this.$a=this.tj=parseInt(RegExp.$1,10));else if(this.chrome)this.mb="Chrome",/CriOS\/(\d+)/.test(this.aa)?
this.$a=this.Wf=parseInt(RegExp.$1,10):/Chrome\/(\d+)/.test(this.aa)&&(this.$a=this.Wf=parseInt(RegExp.$1,10));else if(this.cg)this.mb="Firefox",/Firefox\D+(\d+)/.test(this.aa)&&(this.$a=this.xj=parseInt(RegExp.$1,10));else if(this.pg)/Silk/.test(this.aa)&&(this.mb="Silk",this.Hg=!0);else if(this.jd)this.mb="Internet Explorer",/MSIE (\d+\.\d+);/.test(this.aa)?this.$a=this.lg=parseInt(RegExp.$1,10):/Trident\/(\d+\.\d+)(.*)rv:(\d+\.\d+)/.test(this.aa)&&(this.$a=this.lg=parseInt(RegExp.$3,10));else if(this.opera)this.mb=
"Opera",/OPR\/(\d+)/.test(this.aa)?this.$a=this.te=parseInt(RegExp.$1,10):0<=this.aa.indexOf("Opera/")?/Version\/(\d+)/.test(this.aa)&&(this.$a=this.te=parseInt(RegExp.$1,10)):/Opera (\d+)/.test(this.aa)&&(this.$a=this.te=parseInt(RegExp.$1,10));else if(this.Cg)this.mb="Safari",/version\/(\d+(\.\d+)?)/i.test(this.aa)&&(this.$a=this.sk=parseInt(RegExp.$1,10));else{var a=this.aa.match(/Android.*AppleWebKit\/([\d.]+)/);a&&537>a[1]&&(this.mb="Android Stock",this.ak=!0,this.$a=this.gj=parseFloat(this.aa.slice(this.aa.indexOf("Android")+
8)))}navigator.j&&(this.Ek=!0);this.pk="CSS1Compat"===document.compatMode?!1:!0};a.prototype.Sl=function(){this.nc=window.devicePixelRatio||1;this.Xj=!0===this.Fc&&-1!==this.aa.toLowerCase().indexOf("iphone");this.Yj=!0===this.Fc&&-1!==this.aa.toLowerCase().indexOf("ipod");this.kg=!0===this.Fc&&-1!==this.aa.toLowerCase().indexOf("ipad");this.rk=2<=this.nc&&!0===this.Fc;this.Ug&&!this.Fe||this.tg||this.qg&&!this.Hg||this.Vf?this.Dc=!0:/Mobi/i.test(this.aa)&&!1===this.kg?this.qe=!0:this.Jg=!0;if(/TV/i.test(this.aa)||
!0===this.Mg||!0===this.Vg||this.Dc&&/Windows NT/i.test(this.aa)&&/Touch/i.test(this.aa))this.kk=!0,this.Dc=this.Jg=this.qe=!1};a.prototype.am=function(){var a=document.createElement("video");try{"function"===typeof a.canPlayType&&(a.canPlayType('video/ogg; codecs="theora"').replace(/^no$/,"")&&(this.yg=!0),a.canPlayType('video/mp4; codecs="avc1.42E01E"').replace(/^no$/,"")&&(this.wg=this.gg=!0),a.canPlayType('video/webm; codecs="vp8, vorbis"').replace(/^no$/,"")&&(this.Tg=!0),a.canPlayType('video/webm; codecs="vp9"').replace(/^no$/,
"")&&(this.Ng=!0),a.canPlayType('application/x-mpegURL; codecs="avc1.42E01E"').replace(/^no$/,"")&&(this.jg=!0))}catch(d){}};a.prototype.Ol=function(){this.Rf="undefined"!==typeof window.Audio;this.Pg="undefined"!==typeof window.AudioContext||"undefined"!==typeof window.webkitAudioContext;var a=document.createElement("audio");try{if("function"===typeof a.canPlayType){a.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/,"")&&(this.xg=!0);a.canPlayType("audio/mpeg;").replace(/^no$/,"")&&(this.ug=
!0);if(a.canPlayType('audio/ogg; codecs="opus"').replace(/^no$/,"")||a.canPlayType("audio/opus;").replace(/^no$/,""))this.ue=!0;a.canPlayType('audio/wav; codecs="1"').replace(/^no$/,"")&&(this.Og=!0);a.canPlayType("audio/aac;").replace(/^no$/,"")&&(this.Pf=!0);if(a.canPlayType("audio/x-m4a;")||a.canPlayType("audio/m4a;")||a.canPlayType("audio/aac;").replace(/^no$/,""))this.sg=!0;if(a.canPlayType("audio/x-mp4;")||a.canPlayType("audio/mp4;")||a.canPlayType("audio/aac;").replace(/^no$/,""))this.vg=!0;
a.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/,"")&&(this.Rg=this.Sg=!0)}}catch(d){}};a.prototype.Tl=function(){this.Kg="undefined"!==typeof navigator.Kg||"undefined"!==typeof navigator.o||"undefined"!==typeof navigator.c||"undefined"!==typeof navigator.f;this.Uf="function"===typeof navigator.getBattery};a.prototype.Vl=function(){this.canvas="undefined"!==typeof window.CanvasRenderingContext2D;if(!0===this.canvas){this.kj="function"===typeof document.createElement("canvas").getContext("2d").fillText;
var a=document.createElement("canvas").getContext("2d");a.rect(0,0,10,10);a.rect(2,2,6,6);this.lj=!1===a.isPointInPath(5,5,"evenodd")}try{this.localStorage="object"===typeof window.localStorage&&"function"===typeof window.localStorage.getItem}catch(g){this.localStorage=!1}this.hk="function"===typeof window.MediaSource;this.uj="function"===typeof window.HTMLMediaElement&&"function"===typeof window.O&&"function"===typeof window.f&&"function"===typeof navigator.O;this.applicationCache="object"===typeof window.applicationCache;
this.addEventListener="function"===typeof window.addEventListener;this.raf="function"===typeof window.requestAnimationFrame||"function"===typeof window.webkitRequestAnimationFrame||"function"===typeof window.mozRequestAnimationFrame;try{var d=document.createElement("canvas");d.f=!1;this.Qg="function"===typeof d.getContext&&"undefined"!==typeof window.WebGLRenderingContext&&!(!d.getContext("webgl")&&!d.getContext("experimental-webgl"))}catch(g){this.Qg=!1}this.Ee="function"===typeof navigator.getVRDisplays?
!0:!1;this.JSON="object"===typeof window.JSON&&"function"===typeof window.JSON.parse&&"function"===typeof window.JSON.stringify;this.geolocation="object"===typeof navigator.geolocation;this.history="object"===typeof window.history&&"function"===typeof window.history.pushState;this.wk="function"===typeof document.createElementNS&&"function"===typeof document.createElementNS("http://www.w3.org/2000/svg","svg").c;this.contextMenu="undefined"!==typeof document.documentElement.contextMenu&&"function"===
typeof window.HTMLMenuItemElement};a.prototype.Ul=function(){this.ck=/^https/i.test(window.location.protocol);try{this.ng=window.self!==window.top}catch(b){this.ng=!0}};a.prototype.Yl=function(){this.yk="undefined"!==typeof window.ontouchstart||"undefined"!==typeof window.c&&document instanceof window.c||"number"===typeof navigator.maxTouchPoints&&0<navigator.maxTouchPoints||"number"===typeof navigator.msMaxTouchPoints&&0<navigator.msMaxTouchPoints;if("undefined"!==typeof window.j||"undefined"!==
typeof window.m)this.zk=!(!MouseEvent.f||!MouseEvent.c);this.Dj="function"===typeof navigator.getGamepads||"function"===typeof navigator.webkitGetGamepads};a.prototype.Wl=function(){for(var a="requestFullscreen requestFullScreen webkitRequestFullscreen webkitRequestFullScreen mozRequestFullScreen mozRequestFullscreen msRequestFullscreen msRequestFullScreen".split(" "),d="cancelFullscreen cancelFullScreen exitFullscreen exitFullScreen webkitCancelFullscreen webkitCancelFullScreen webkitExitFullscreen webkitExitFullScreen mozCancelFullscreen mozCancelFullScreen mozExitFullscreen mozExitFullScreen msCancelFullscreen msCancelFullScreen msExitFullscreen msExitFullScreen".split(" "),
g=document.createElement("div"),h=0,k=a.length;h<k;h++)if(g[a[h]]){this.requestFullscreen=a[h];break}a=0;for(g=d.length;a<g;a++)if(document[d[a]]){this.exitFullscreen=d[a];break}"function"===typeof window.Element&&Element.ALLOW_KEYBOARD_INPUT&&(this.Bj=!0);d=["fullscreenElement","mozFullScreenElement","webkitFullscreenElement","msFullscreenElement"];a=0;for(g=d.length;a<g;a++)if("undefined"!==typeof document[d[a]]){this.fullscreenElement=d[a];break}d=["fullscreenEnabled","mozFullScreenEnabled","webkitFullscreenEnabled",
"msFullscreenEnabled"];a=0;for(g=d.length;a<g;a++)if("undefined"!==typeof document[d[a]]){this.fullscreenEnabled=d[a];break}};a.prototype.Pl=function(){for(var a=["visibilitychange","mozvisibilitychange","webkitvisibilitychange","msvisibilitychange"],d=["hidden","mozHidden","webkitHidden","msHidden"],g=0,h=d.length;g<h;g++)if("undefined"!==typeof document[d[g]]){this.visibilityState=d[g];this.Lg=a[g];break}a=["orientation","mozOrientation","msOrientation"];d=0;for(g=a.length;d<g;d++)if("string"===
typeof screen[a[d]]){this.orientation=a[d];break}this.tk="object"===typeof screen.orientation&&"string"===typeof screen.orientation.type&&"function"===typeof screen.orientation.lock;a=["lockOrientation","mozLockOrientation","msLockOrientation"];d=["unlockOrientation","mozUnlockOrientation","msUnlockOrientation"];g=0;for(h=a.length;g<h;g++)if("function"===typeof screen[a[g]]){this.ek=a[g];this.Ak=d[g];break}this.file="undefined"!==typeof window.File&&"undefined"!==typeof window.FileReader&&"undefined"!==
typeof window.FileList&&"undefined"!==typeof window.Blob;this.wj="undefined"!==typeof window.requestFileSystem||"undefined"!==typeof window.webkitRequestFileSystem;this.nk="undefined"!==typeof document.f||"undefined"!==typeof document.c||"undefined"!==typeof document.O};a.prototype.Rl=function(){var a=document.createElement("a").style;a.cssText="pointer-events:auto";this.dd="auto"===a.pointerEvents;a.cssText="background-color:rgba(150,255,150,.5)";this.qj=-1<(""+a.backgroundColor).indexOf("rgba");
...
this.oj="undefined"!==typeof d&&0<d.length&&"none"!==d};a.prototype.em=function(a){null!==a.rotationRate&&"undefined"!==typeof a.rotationRate.alpha&&"undefined"!==typeof a.rotationRate.beta&&"undefined"!==typeof a.rotationRate.gamma&&(this.Zf=!0);"undefined"!==typeof a.acceleration&&"undefined"!==typeof a.acceleration.x&&"undefined"!==typeof a.acceleration.y&&"undefined"!==typeof a.acceleration.z&&(this.Yf=!0);this.Li();"function"!==typeof this.Bc&&this.Gf()};a.prototype.fm=function(a){"undefined"!==
typeof a.alpha&&"undefined"!==typeof a.beta&&"undefined"!==typeof a.gamma&&(this.ag=!0);this.Mi();"function"!==typeof this.Ac&&this.Gf()};a.prototype.Li=function(){window.removeEventListener("devicemotion",this.Ac,!1);this.Ac=null};a.prototype.Mi=function(){window.removeEventListener("deviceorientation",this.Bc,!1);this.Bc=null};a.prototype.Xl=function(){this.Xf="undefined"!==typeof window.DeviceMotionEvent;this.$f="undefined"!==typeof window.DeviceOrientationEvent;window.addEventListener("deviceorientation",
this.Bc,!1);window.addEventListener("devicemotion",this.Ac,!1)};a.prototype.$l=function(){var a=document.createElement("div");a.style.width="1in";a.style.height="1in";document.body.appendChild(a);this.sj=a.offsetWidth;document.body.removeChild(a);this.qe?(this.Eg=Math.floor(Math.min(window.screen.width,window.screen.height)*this.nc),this.Dg=Math.floor(Math.max(window.screen.width,window.screen.height)*this.nc)):(this.Eg=Math.floor(Math.max(window.screen.width,window.screen.height)*this.nc),this.Dg=
Math.floor(Math.min(window.screen.width,window.screen.height)*this.nc))};a.prototype.Nl=function(){this.aa=navigator.userAgent;this.language=navigator.languages&&navigator.languages[0]||navigator.language||navigator.m||"";this.Zl();this.Ql();this.Sl();this.Ol();this.am();this.Tl();this.Vl();this.Ul();this.Pl();this.Wl();this.Yl();this.Rl();this.Ac=this.em.bind(this);this.Bc=this.fm.bind(this);this.Xl();this.$l();!1===this.Xf&&!1===this.$f&&this.Gf()};a.prototype.Gf=function(){"function"===typeof this.Ac&&
this.Li();"function"===typeof this.Bc&&this.Mi();!0===this.Zf&&!0===this.Yf&&!0===this.ag&&(this.Qj=!0);this.ready=!0;Object.freeze(N)};a.prototype.rn=function(a){return"mp3"===a&&!0===this.ug||"ogg"===a&&(!0===this.xg||!0===this.ue)||"m4a"===a&&!0===this.sg||"mp4"===a&&!0===this.vg||"opus"===a&&!0===this.ue||"wav"===a&&!0===this.Og||"aac"===a&&!0===this.Pf||"webm"===a&&!0===this.Sg||"weba"===a&&!0===this.Rg?!0:!1};a.prototype.sn=function(a){if("webm"!==a||!0!==this.Tg&&!0!==this.Ng)if("mp4"!==a||
!0!==this.wg&&!0!==this.gg){if(("ogg"===a||"ogv"===a)&&!0===this.yg||"mpeg"===a&&!0===this.jg)return!0}else return!0;else return!0;return!1};a.prototype.Pn=function(){return navigator.getBattery().then(function(a){return this.Uf&&!a.charging&&.2>=a.level}.bind(this),function(){return!1})};return new a}(function(){return function(){this.ready=!1;this.cb=this.language=this.aa="";this.Zb=0;this.cg=this.Fe=this.Ug=this.tg=this.qg=this.Fc=this.Vf=this.fj=this.pg=this.Vg=this.Mg=!1;this.xj=0;this.chrome=
!1;this.Wf=0;this.jd=!1;this.lg=0;this.opera=!1;this.te=0;this.ae=!1;this.tj=0;this.Cg=!1;this.sk=0;this.Hg=!1;this.mb="";this.$a=0;this.ak=this.Ek=!1;this.gj=0;this.pk=!1;this.fullscreenElement=this.exitFullscreen=this.requestFullscreen=this.fullscreenEnabled="";this.kg=this.Yj=this.rk=this.Xj=this.Bj=!1;this.nc=1;this.ng=this.ck=this.wk=this.history=this.JSON=this.uj=this.hk=this.contextMenu=this.nk=this.geolocation=this.applicationCache=this.localStorage=this.wj=this.file=this.Ee=this.Qg=this.raf=
this.addEventListener=this.kj=this.lj=this.canvas=this.jg=this.Ng=this.Tg=this.wg=this.gg=this.yg=this.Rg=this.Sg=this.Pf=this.vg=this.sg=this.Og=this.ue=this.ug=this.xg=this.Pg=this.Rf=this.zk=this.Dj=this.yk=this.kk=this.qe=this.Jg=this.Dc=this.Uf=this.Kg=!1;this.Lg=this.visibilityState="";this.ag=this.Zf=this.Yf=this.$f=this.Xf=this.Qj=this.pj=this.dd=this.qj=this.oj=!1;this.Bc=this.Ac=null;this.Dg=this.Eg=this.sj=0;this.tk=!1;this.Ak=this.ek=this.orientation="";this.Nl()}});
...
e.kh=function(){this.log("_updateState");var a=window.history.state,b;null===a?b=!1:(b="undefined"!==typeof a.scene&&"string"===typeof a.scene.uid,b=!0===("undefined"!==typeof a.viewer&&"string"===typeof a.viewer.uid)&&!0===b);b&&(b=p.get(a.scene.uid),a.locale=this.i.i18n.locale,window.history.replaceState(a,b.name,pd(b)))};
function pd(a){for(var b=/(?:#|&)(\w+)=(\w+)/g,d=window.location.hash,g=b.exec(d),h="";null!==g;)"uid"!==g[1]&&(h+="&"+g[1]+"="+g[2]),g=b.exec(d);return"#"+a.slug+"&uid="+a.uid+h}e.Ei=function(a){if(null!==a.state){var b=p.get(a.state.viewer.uid);b.history.log("_onPopStateHandler");b.story.scene=a.state.scene.uid}};
e.ha=function(a){this.c="boolean"===typeof a.enabled?a.enabled:!0;!0===this.c&&(this.i.story.onSceneLoadStart.add(this.lh,this),this.i.i18n.onLocaleChangeComplete.add(this.kh,this),window.addEventListener("popstate",this.Ei,!1))};e.destroy=function(){this.i.story.onSceneLoadStart.remove(this.lh,this);this.i.i18n.onLocaleChangeComplete.remove(this.kh,this);window.removeEventListener("popstate",this.Ei,!1);this.i=null;l.prototype.destroy.call(this)};Object.defineProperty(na.prototype,"enabled",{get:function(){return this.c}});
...
Object.defineProperty(q.prototype,"active",{get:function(){return this.f},set:function(a){this.f=!!a}});function td(a,b){this.f=a;this.c=b||null}td.prototype.constructor=td;Object.defineProperty(td.prototype,"emitter",{get:function(){return this.f}});Object.defineProperty(td.prototype,"data",{get:function(){return this.c}});function rd(a,b,d,g,h){this.j=a;this.c=b;this.f=g||null;this.o=d||!1;this.Of=h||0;this.m=0;this.O=!1}e=rd.prototype;e.constructor=rd;
e.zi=function(a){this.c.call(this.f,new td(this.j.emitter,a));this.m++;!0===this.o&&this.nh();this.O=!1};e.yb=function(a,b){null!==this.c&&(!0===b&&!1===this.O?(this.O=!0,window.setTimeout(this.zi.bind(this,a),0)):!0!==b&&this.zi(a))};e.nh=function(){return this.j.remove(this.c,this.f)};e.destroy=function(){this.f=this.c=this.j=null};Object.defineProperty(rd.prototype,"listener",{get:function(){return this.c}});Object.defineProperty(rd.prototype,"context",{get:function(){return this.f}});
Object.defineProperty(rd.prototype,"priority",{get:function(){return this.Of}});Object.defineProperty(rd.prototype,"callCount",{get:function(){return this.m}});function ma(a){this.i=a;this.c=null;this.f=-1;this.o="";this.u=!0;this.j=this.m=null;l.call(this,"LocaleManager");this.log("$_LocaleManager._boot();");this.c=new md}ma.prototype=Object.create(l.prototype);e=ma.prototype;e.constructor=ma;
e.ha=function(a){this.u="boolean"===typeof a.enabled?a.enabled:!0;"undefined"!==typeof a.auto&&!0===a.auto&&""!==N.language?this.o=N.language:"string"===typeof a["default"]&&(this.o=a["default"]);if(!1===this.u)this.warn("$_LocaleManager: locale management is deactivated");else if("undefined"!==typeof a.locales){for(var b=!1,d=0,g=a.locales.length;d<g;d++){var h;var k=a.locales[d],n=ud(this,k.uid);-1===n?(h=new vd(this.i),h.f.add(this.qm,this),n=this.c.add(h)-1):h=this.c.get(n);h.ha(k);n===this.f||
this.o.toLowerCase()===k.uid.toLowerCase()?(h.rg(),-1===this.f&&wd(this,n),h=!0):h=!1;!0===h&&(b=!0)}!1===b&&(-1===ud(this,this.o)&&(this.o=a.locales[0].uid),wd(this,ud(this,a.locales[0].uid)))}};function ud(a,b){for(var d,g=0,h=a.c.size;g<h;g++)if(d=a.c.get(g),d.uid.toLowerCase()===b.toLowerCase())return g;return-1}
function wd(a,b){if(0>b||b>=a.c.size)throw"The locale you are trying to set doesn't exist";a.f===b?a.warn("$_LocaleManager: You're trying to set a locale that is already the actual locale"):(a.f=b,null!==a.m&&a.m.D(),a.c.get(a.f).rg())}e.qm=function(){this.log("$_LocaleManager._localeAllFilesLoaded();");null!==this.j&&this.j.D()};
...
e.rg=function(){if(!0===yd(this))return this.f.D(),!0;for(var a,b=0,d=this.c.size;b<d;b++)a=this.c.get(b),!1===a.zb&&!1===a.loaded&&!1===a.zb&&!1===a.loaded&&(a.zb=!0,this.i.load.json(a.key,a.url,this.om,this))};function xd(a,b){for(var d,g=0,h=a.c.size;g<h;g++)if(d=a.c.get(g),d.key===b)return d;return null}e.om=function(a){a=xd(this,a.key);a.zb=!1;a.loaded=!0;this.log("loadFileComplete(); "+a.key);this.j.D();!0===yd(this)&&this.f.D()};
...
Object.defineProperty(vd.prototype,"name",{get:function(){return this.m}});function ua(a){this.i=a;this.j=!0;this.o=this.m=this.f=this.c=null;l.call(this,"Keyboard");this.c=[];this.f=[];this.m=this.lm.bind(this);this.o=this.mm.bind(this);window.addEventListener("keydown",this.m,!1);window.addEventListener("keyup",this.o,!1)}ua.prototype=Object.create(l.prototype);e=ua.prototype;e.constructor=ua;
e.lm=function(a){if(!1!==this.j){var b=a.keyCode;this.log("keyDown "+b);-1===this.f.indexOf(b)?(this.f.push(b),b=!0):b=!1;!0===b&&zd(this,a)}};
e.mm=function(a){if(!1!==this.j){var b=a.keyCode;this.log("keyUp "+b);b=this.f.indexOf(b);-1!==b?(this.f.splice(b,1),b=!0):b=!1;if(!0===b)a:if(b=a.keyCode,!0!==this.og(b))for(var b=this.eg(b),d,g=0,h=b.length;g<h;g++){d=b[g];for(var k=0,n=this.f.length;k<n;k++)if(d.je(this.f[k]))break a;d.Bk(a);k=0;for(n=this.f.length;k<n;k++)if(d.hg(this.f[k])){var v=new KeyboardEvent("keydown",{oo:this.f[k],ctrlKey:a.ctrlKey,shiftKey:a.shiftKey,altKey:a.altKey});zd(this,v)}}}};
function Ad(a,b){if(null===a.c||!a.c.length)return-1;if("object"===typeof b&&"KeyBinding"===b.type)return a.c.indexOf(b);if("number"===typeof b)for(var d=0,g=a.c.length;d<g;d++)if(!0===a.c[d].je(b))return d;return-1}function zd(a,b){var d=b.keyCode;if(!0!==a.og(d)){a=a.eg(d);for(var g=0,h=a.length;g<h;g++)d=a[g],!1===d.pressed&&d.mh(b)}}e.update=function(){for(var a,b=0,d=this.c.length;b<d;b++)if(a=this.c[b],!0===a.pressed){if(!0===a.hasToWaitToHold&&!1===a.downComplete)break;a.Wj()}};
e.On=function(a){return-1!==this.f.indexOf(a)};e.og=function(a){for(var b,d=0,g=this.c.length;d<g;d++)if(b=this.c[d],!0===b.pressed&&!0===b.hg(a))return!0;return!1};e.Qf=function(a){if("object"!==typeof a&&"KeyBinding"!==a.type)return!1;if(-1===Ad(this,a))return this.c.push(a),!0;this.warn("Trying to add a duplicate key binding on keyboard!");return!1};e.ye=function(a){a=Ad(this,a);return-1!==a?(this.c[a].destroy(),this.c.splice(a,1),!0):!1};e.En=function(a){return-1!==Ad(this,a)};
e.eg=function(a){for(var b=[],d=0,g=this.c.length;d<g;d++)!0===this.c[d].je(a)&&b.push(this.c[d]);return b};e.destroy=function(){this.i=null;window.removeEventListener("keydown",this.m,!1);window.removeEventListener("keyup",this.o,!1);for(var a=this.c.length;a--;)this.ye(this.c[a]);this.o=this.m=this.c=null;l.prototype.destroy.call(this)};Object.defineProperty(ua.prototype,"enabled",{get:function(){return this.j},set:function(a){this.j=!!a}});
function P(a,b,d,g,h,k,n,v){this.i=a;this.G=b||[];this.o=d||null;this.C=g||null;this.u=h||null;this.A=k||null;this.f=n||this;this.I=v||"";this.If=this.H=this.K=!1;this.F=this.B=this.$c=0;this.m=this.j=this.c=null;l.call(this,"KeyBinding");if(!0===B.T(this.o,"string")||B.Ga(this.o,"string"))this.c=new ac(this.i),this.c.c(this.o);if(!0===B.T(this.u,"string")||B.Ga(this.u,"string"))this.j=new ac(this.i),this.j.c(this.u);if(!0===B.T(this.C,"string")||B.Ga(this.C,"string"))this.m=new ac(this.i),this.m.c(this.C)}
P.prototype=Object.create(l.prototype);e=P.prototype;e.constructor=P;e.je=function(a){return"number"===typeof this.G&&this.G===a?!0:"function"===typeof this.G.indexOf?-1!==this.G.indexOf(a):!1};e.hg=function(a){if(null!==this.A){if("number"===typeof this.A&&this.A===a)return!0;if("function"===typeof this.A.indexOf)return-1!==this.A.indexOf(a)}return!1};e.mh=function(a){this.log("down");this.$c++;this.H=!0;"function"===typeof this.o?this.o.call(this.f,this,a):null!==this.c&&this.c.D()};
e.jo=function(){this.K=!0;var a=this.$c;return function(){this.log("downCompleteCallback "+a+" "+this.$c);a===this.$c&&(this.If=!0)}.bind(this)};e.Bk=function(a){this.log("up");this.F++;this.If=this.H=!1;"function"===typeof this.C?this.C.call(this.f,this,a):null!==this.m&&this.m.D()};e.Wj=function(){this.log("hold");this.B++;"function"===typeof this.u?this.u.call(this.f,this):null!==this.j&&this.j.D()};
e.destroy=function(){this.f=this.A=this.u=this.C=this.o=this.G=null;null!==this.c&&(this.c.destroy(),this.c=null);null!==this.j&&(this.j.destroy(),this.j=null);null!==this.m&&(this.m.destroy(),this.m=null);l.prototype.destroy.call(this)};Object.defineProperty(P.prototype,"name",{get:function(){return this.I}});Object.defineProperty(P.prototype,"pressed",{get:function(){return this.H}});Object.defineProperty(P.prototype,"downCount",{get:function(){return this.$c}});
Object.defineProperty(P.prototype,"upCount",{get:function(){return this.F}});Object.defineProperty(P.prototype,"holdCount",{get:function(){return this.B}});Object.defineProperty(P.prototype,"hasToWaitToHold",{get:function(){return this.K}});Object.defineProperty(P.prototype,"downComplete",{get:function(){return this.If}});
...
function Dd(a,b){null!==a.f&&(null!==a.f&&(a.f.pointer.onPanStart.remove(a.ih,a),a.f.pointer.onPanMove.remove(a.hh,a),a.f.pointer.onPanEnd.remove(a.gh,a)),a.f=null);a.f=b;a.f.pointer.enabled=!0;a.f.pointer.onPanStart.add(a.ih,a);a.f.pointer.onPanMove.add(a.hh,a);a.f.pointer.onPanEnd.add(a.gh,a)}
...
null,this.L.right=null,this.L.bottom=null,this.L.left=null,this.G={x:a.pageX,y:a.pageY},this.N=this.L.alpha,this.L.alpha=this.F,null!==this.o&&this.o.D())};e.gh=function(){this.log("_panEndHandler");!0===this.H&&(this.H=!1,null!==this.u&&this.u.D(),!0===this.B&&null!==this.m?(this.K=!0,this.m.Ze({x:this.I.x,y:this.I.y},this.R,this.U).start()):this.L.alpha=this.N,this.G=this.I=null)};
...
Object.defineProperty(Bd.prototype,"reverting",{get:function(){return this.K}});Object.defineProperty(Bd.prototype,"revert",{get:function(){return this.B},set:function(a){this.B=!!a;!0===this.B&&null===this.m?(this.m=new Ab(this.L.viewer,this.L),this.m.onComplete.add(this.Oi,this),this.L.viewer.tween.add(this.m)):!1===this.B&&null!==this.m&&(this.L.viewer.tween.remove(this.m),this.m.onComplete.remove(this.Oi,this),this.m.destroy(),this.m=null)}});
...
function U(a){this.L=a;this.c=!1;this.$=Ed.DEFAULT;this.Ua=null;this.sd=[];this.P=this.f=this.j=this.m=this.A=this.u=this.W=this.N=this.R=this.U=this.B=this.F=this.K=this.C=this.G=this.H=this.I=this.J=this.o=this.M=this.ba=this.S=this.ya=this.xa=this.na=this.oa=this.wa=this.va=this.V=null;l.call(this,"Pointer");this.Ua=new Hammer.Manager(this.L.dom);this.Ua.set({enable:!1})}U.prototype=Object.create(l.prototype);e=U.prototype;e.constructor=U;
function Fd(a,b,d,g){for(var h,k=0,n=a.sd.length;k<n;k++)if(h=a.sd[k],h.event===b&&h.qn===d&&h.type===g)return k;return-1}function Gd(a,b,d,g){if(-1===Fd(a,b,d,g))if(a.sd.push({event:b,qn:d,type:g}),g===V.Ra)a.L.dom.addEventListener(b,Hammer.bindFn(d,a));else if(g===V.ka)a.Ua.on(b,Hammer.bindFn(d,a))}function Hd(a,b,d){return function(){var g=Fd(this,a,b,d);-1!==g&&(this.sd.splice(g,1),d===V.Ra?this.L.dom.removeEventListener(a,b):d===V.ka&&this.Ua.off(a))}}
e.Xi=function(a){null!==this.M&&!0===this.c&&this.M.D(a)};e.vi=function(a){null!==this.o&&!0===this.c&&this.o.D(a)};e.Dh=function(a){null!==this.J&&!0===this.c&&this.J.D(a)};e.Ch=function(a){null!==this.I&&!0===this.c&&this.I.D(a)};e.yh=function(a){null!==this.H&&!0===this.c&&this.H.D(a)};e.xh=function(a){null!==this.G&&!0===this.c&&this.G.D(a)};e.wh=function(a){null!==this.C&&!0===this.c&&this.C.D(a)};e.Bh=function(a){null!==this.K&&!0===this.c&&this.K.D(a)};
e.Ah=function(a){null!==this.F&&!0===this.c&&this.F.D(a)};e.zh=function(a){null!==this.B&&!0===this.c&&this.B.D(a)};e.Ri=function(a){null!==this.U&&!0===this.c&&this.U.D(a)};e.Qi=function(a){null!==this.R&&!0===this.c&&this.R.D(a)};e.Pi=function(a){null!==this.N&&!0===this.c&&this.N.D(a)};e.Vi=function(a){null!==this.W&&!0===this.c&&this.W.D(a)};e.yi=function(a){null!==this.u&&!0===this.c&&this.u.D(a)};e.Ai=function(a){null!==this.A&&!0===this.c&&this.A.D(a)};
e.Ji=function(a){null!==this.m&&!0===this.c&&this.m.D(a)};e.Ii=function(a){null!==this.j&&!0===this.c&&this.j.D(a)};e.Di=function(a){null!==this.f&&!0===this.c&&this.f.D(a)};e.Eh=function(a){null!==this.P&&!0===this.c&&this.P.D(a)};
e.enable=function(){!0===N.dd&&(this.L.dom.style.pointerEvents="auto");this.Ua.set({enable:!0});null===this.V&&(this.V=new Hammer.Tap,this.Ua.add(this.V));null===this.va&&(this.va=(new Hammer.Tap({event:U.events.Bd,ro:2})).recognizeWith(this.V),this.Ua.add(this.va));null===this.wa&&(this.wa=(new Hammer.Press).recognizeWith(this.V),this.Ua.add(this.wa));null===this.oa&&(this.oa=new Hammer.Pan,this.Ua.add(this.oa));null===this.na&&(this.na=new Hammer.Pinch,this.Ua.add(this.na));null===this.xa&&(this.xa=
(new Hammer.Rotate).recognizeWith(this.na),this.Ua.add(this.xa));null===this.ya&&(this.ya=(new Hammer.Swipe).recognizeWith(this.oa),this.Ua.add(this.ya));this.c=!0;null!==this.S&&this.S.D()};e.Ue=function(){!0===N.dd&&(this.L.dom.style.pointerEvents="none");this.c=!1;this.Ua.set({enable:!1});null!==this.ba&&this.ba.D()};
e.destroy=function(){this.Ue();this.ya=this.xa=this.na=this.oa=this.wa=this.va=this.V=null;null!==this.S&&(this.S.destroy(),this.S=null);null!==this.ba&&(this.ba.destroy(),this.ba=null);null!==this.M&&(this.M.destroy(),this.M=null);null!==this.o&&(this.o.destroy(),this.o=null);null!==this.J&&(this.J.destroy(),this.J=null);null!==this.I&&(this.I.destroy(),this.I=null);null!==this.H&&(this.H.destroy(),this.H=null);null!==this.G&&(this.G.destroy(),this.G=null);null!==this.C&&(this.C.destroy(),this.C=
...
null);null!==this.f&&(this.f.destroy(),this.f=null);null!==this.P&&(this.P.destroy(),this.P=null);this.L=null;l.prototype.destroy.call(this)};Object.defineProperty(U.prototype,"enabled",{get:function(){return this.c},set:function(a){!0===!!a?this.enable():this.Ue()}});Object.defineProperty(U.prototype,"cursor",{get:function(){return this.$},set:function(a){this.L.dom.style.cursor=a;if(a!==this.L.dom.style.cursor||""===this.L.dom.style.cursor)this.L.dom.style.cursor="-webkit-"+a;this.$=a}});
Object.defineProperty(U.prototype,"onEnable",{get:function(){null===this.S&&(this.S=new q(this));return this.S}});Object.defineProperty(U.prototype,"onDisable",{get:function(){null===this.ba&&(this.ba=new q(this));return this.ba}});Object.defineProperty(U.prototype,"onTap",{get:function(){null===this.M&&(this.M=new q(this.L),this.M.onDestroy.ca(Hd(U.events.Df,this.Xi,V.ka),this),Gd(this,U.events.Df,this.Xi,V.ka));return this.M}});Object.defineProperty(U.prototype,"onClick",{get:function(){return this.onTap}});
Object.defineProperty(U.prototype,"onDoubleTap",{get:function(){null===this.o&&(this.o=new q(this.L),this.o.onDestroy.ca(Hd(U.events.Bd,this.vi,V.ka),this),Gd(this,U.events.Bd,this.vi,V.ka));return this.o}});Object.defineProperty(U.prototype,"onDoubleClick",{get:function(){return this.onDoubleTap}});Object.defineProperty(U.prototype,"onPressStart",{get:function(){null===this.J&&(this.J=new q(this.L),this.J.onDestroy.ca(Hd(U.events.xf,this.Dh,V.ka),this),Gd(this,U.events.xf,this.Dh,V.ka));return this.J}});
Object.defineProperty(U.prototype,"onDown",{get:function(){return this.onPressStart}});Object.defineProperty(U.prototype,"onPressEnd",{get:function(){null===this.I&&(this.I=new q(this.L),this.I.onDestroy.ca(Hd(U.events.wf,this.Ch,V.ka),this),Gd(this,U.events.wf,this.Ch,V.ka));return this.I}});Object.defineProperty(U.prototype,"onUp",{get:function(){return this.onPressEnd}});
Object.defineProperty(U.prototype,"onPanStart",{get:function(){null===this.H&&(this.H=new q(this.L),this.H.onDestroy.ca(Hd(U.events.rf,this.yh,V.ka),this),Gd(this,U.events.rf,this.yh,V.ka));return this.H}});Object.defineProperty(U.prototype,"onPanMove",{get:function(){null===this.G&&(this.G=new q(this.L),this.G.onDestroy.ca(Hd(U.events.qf,this.xh,V.ka),this),Gd(this,U.events.qf,this.xh,V.ka));return this.G}});
Object.defineProperty(U.prototype,"onPanEnd",{get:function(){null===this.C&&(this.C=new q(this.L),this.C.onDestroy.ca(Hd(U.events.pf,this.wh,V.ka),this),Gd(this,U.events.pf,this.wh,V.ka));return this.C}});Object.defineProperty(U.prototype,"onPinchStart",{get:function(){null===this.K&&(this.K=new q(this.L),this.K.onDestroy.ca(Hd(U.events.vf,this.Bh,V.ka),this),Gd(this,U.events.vf,this.Bh,V.ka));return this.K}});
Object.defineProperty(U.prototype,"onPinchMove",{get:function(){null===this.F&&(this.F=new q(this.L),this.F.onDestroy.ca(Hd(U.events.uf,this.Ah,V.ka),this),Gd(this,U.events.uf,this.Ah,V.ka));return this.F}});Object.defineProperty(U.prototype,"onPinchEnd",{get:function(){null===this.B&&(this.B=new q(this.L),this.B.onDestroy.ca(Hd(U.events.tf,this.zh,V.ka),this),Gd(this,U.events.tf,this.zh,V.ka));return this.B}});
Object.defineProperty(U.prototype,"onRotateStart",{get:function(){null===this.U&&(this.U=new q(this.L),this.U.onDestroy.ca(Hd(U.events.Af,this.Ri,V.ka),this),Gd(this,U.events.Af,this.Ri,V.ka));return this.U}});Object.defineProperty(U.prototype,"onRotateMove",{get:function(){null===this.R&&(this.R=new q(this.L),this.R.onDestroy.ca(Hd(U.events.zf,this.Qi,V.ka),this),Gd(this,U.events.zf,this.Qi,V.ka));return this.R}});
Object.defineProperty(U.prototype,"onRotateEnd",{get:function(){null===this.N&&(this.N=new q(this.L),this.N.onDestroy.ca(Hd(U.events.yf,this.Pi,V.ka),this),Gd(this,U.events.yf,this.Pi,V.ka));return this.N}});Object.defineProperty(U.prototype,"onSwipe",{get:function(){null===this.W&&(this.W=new q(this.L),this.W.onDestroy.ca(Hd(U.events.Cf,this.Vi,V.ka),this),Gd(this,U.events.Cf,this.Vi,V.ka));return this.W}});
Object.defineProperty(U.prototype,"onEnter",{get:function(){null===this.u&&(this.u=new q(this.L),this.u.onDestroy.ca(Hd(U.events.cf,this.yi,V.Ra),this),Gd(this,U.events.cf,this.yi,V.Ra));return this.u}});Object.defineProperty(U.prototype,"onLeave",{get:function(){null===this.A&&(this.A=new q(this.L),this.A.onDestroy.ca(Hd(U.events.kf,this.Ai,V.Ra),this),Gd(this,U.events.kf,this.Ai,V.Ra));return this.A}});
Object.defineProperty(U.prototype,"onOver",{get:function(){null===this.m&&(this.m=new q(this.L),this.m.onDestroy.ca(Hd(U.events.nf,this.Ji,V.Ra),this),Gd(this,U.events.nf,this.Ji,V.Ra));return this.m}});Object.defineProperty(U.prototype,"onOut",{get:function(){null===this.j&&(this.j=new q(this.L),this.j.onDestroy.ca(Hd(U.events.mf,this.Ii,V.Ra),this),Gd(this,U.events.mf,this.Ii,V.Ra));return this.j}});
Object.defineProperty(U.prototype,"onMove",{get:function(){null===this.f&&(this.f=new q(this.L),this.f.onDestroy.ca(Hd(U.events.lf,this.Di,V.Ra),this),Gd(this,U.events.lf,this.Di,V.Ra));return this.f}});Object.defineProperty(U.prototype,"onWheel",{get:function(){null===this.P&&(this.P=new q(this.L),this.P.onDestroy.ca(Hd(U.events.Ff,this.Eh,V.Ra),this),Gd(this,U.events.Ff,this.Eh,V.Ra));return this.P}});var V={Ra:0,ka:1};U.events={};U.events.Df="tap";U.events.Bd="doubletap";U.events.xf="press";
U.events.wf="pressup";U.events.rf="panstart";U.events.qf="panmove";U.events.pf="panend";U.events.vf="pinchstart";U.events.uf="pinchmove";U.events.tf="pinchend";U.events.Af="rotatestart";U.events.zf="rotatemove";U.events.yf="rotateend";U.events.Cf="swipe";U.events.cf="mouseenter";U.events.kf="mouseleave";U.events.nf="mouseover";U.events.mf="mouseout";U.events.lf="mousemove";U.events.Ff="wheel";var Ed={DEFAULT:"default",Za:"pointer",Cl:"grab",Dl:"grabbing"};
function ga(a){this.i=a;this.Z=[];this.f=[];this.j=this.c=null;l.call(this,"DisplayList");this.c=this.hm.bind(this);document.addEventListener("fullscreenchange",this.c,!1);document.addEventListener("mozfullscreenchange",this.c,!1);document.addEventListener("webkitfullscreenchange",this.c,!1);document.addEventListener("MSFullscreenChange",this.c,!1)}ga.prototype=Object.create(l.prototype);e=ga.prototype;e.constructor=ga;
...
function T(a,b,d){this.i=a;this.c=b||null;this.m=null;this.me=0;this.bf="";this.H=this.G=0;this.Kb=!1;this.u=0;this.C="px";this.na=1;this.o=0;this.A="px";this.oa=1;this.zc=this.xc=!1;this.va=this.Ib=this.ya=this.Rb=null;this.le=1;this.oe=0;this.wc=this.yc=null;this.Uc="";this.Wc="solid";this.N=0;this.Vc="rgb(0, 0, 0)";this.we=0;this.R=!1;this.td="";this.hb=null;this.ne=!1;this.W=!0;this.xa=null;this.ba=!1;this.Pb=this.Ob=this.Mc=this.hd=this.Lb=this.Mb=this.K=this.Nb=this.Qb=this.wa=this.U=null;l.call(this,
d||"DisplayObject");this.Ea()}T.prototype=Object.create(l.prototype);e=T.prototype;e.constructor=T;
e.Ea=function(){!0!==this.ne&&("undefined"===typeof this.c||null===this.c?this.c=document.createElement("div"):(this.u=ha.Pj(this.c),this.C=ha.Nj(this.c),this.o=ha.Oj(this.c),this.A=ha.Mj(this.c)),this.c.style.width=this.u+""+this.C,this.c.style.height=this.o+""+this.A,this.c.style.display="block",this.c.style.position="relative",this.c.style.margin="0px",this.c.style.padding="0px",this.c.style.top=this.H+"px",this.c.style.left=this.G+"px",this.c.style.overflow="hidden",this.c.style.boxSizing="border-box",
!0===N.dd&&(this.c.style.pointerEvents="none"),this.c.style.O="none",this.c.style.webkitUserSelect="none",this.c.style.c="none",this.c.style.f="none",this.c.style.j="none",this.c.style.borderStyle=this.Wc,this.c.style.borderWidth=this.N+"px",this.c.style.borderColor=this.Vc,this.c.style.background=this.Uc,this.xa=[],"DisplayObject"===this.Ta&&(this.i.display.register(this),Jd(this),Kd(this)))};function Jd(a){!0!==a.ne&&(a.log("_notifyReady"),a.ne=!0,null!==a.wa&&a.wa.D())}
e.Sd=function(){this.log("_notifyAddedToDom");null!==this.Lb&&this.Lb.D()};e.ic=function(){this.log("_notifyShow");!1!==this.ld()&&null!==this.hd&&!0===this.visible&&this.hd.D()};e.Td=function(){this.log("_notifyHide");null!==this.Mc&&!1===this.visible&&this.Mc.D()};e.Lf=function(){null!==this.Nb&&this.Nb.D()};e.ta=function(a){Ld(this);null!==this.Qb&&this.Qb.D(a)};
...
function Kd(a){a.log("_applyPending");a.W=!1;if(null!==a.xa&&0!==a.xa.length){a.ba=!0;for(var b=0,d=a.xa.length;b<d;b++)a[a.xa[b].prop]=a.xa[b].value;a.ba=!1;a.xa=[]}}e.fh=function(){this.c.style.display="block";this.ic()};e.Vj=function(){this.c.style.display="none";this.Td()};e.ho=function(){this.visible=!this.visible};
e.Ab=function(a){!0===a&&(this.R=!0,!0===this.W&&Nd(this,"maximized",!0));null!==this.m&&(this.Kb=!1,a=this.pixelWidth,this.u=this.m.innerWidth,this.C="px",this.c.style.width=this.m.innerWidth+"px",this.c.width=this.m.innerWidth,a!==this.pixelWidth&&this.ta({property:"width"}),a=this.pixelHeight,this.o=this.m.innerHeight,this.A="px",this.c.style.height=this.m.innerHeight+"px",this.c.height=this.m.innerHeight,a!==this.pixelHeight&&this.ta({property:"height"}))};e.ld=function(){return ha.has(this.c)};
e.eh=function(a,b){null!==a&&"undefined"!==typeof a&&(this.width=a);null!==b&&"undefined"!==typeof b&&(this.height=b)};e.zj=function(){if(!0===document[N.fullscreenEnabled]&&!1===this.kd())this.c[N.requestFullscreen]()};e.Aj=function(){if(!0===document[N.fullscreenEnabled]&&!0===this.kd())document[N.exitFullscreen]()};e.kd=function(){return document[N.fullscreenElement]===this.c};
...
this.Ob=null),null!==this.Pb&&(this.Pb.destroy(),this.Pb=null),this.i=this.hb=this.c=null,l.prototype.destroy.call(this))};Object.defineProperty(T.prototype,"viewer",{get:function(){return this.i}});Object.defineProperty(T.prototype,"dom",{get:function(){return this.c}});Object.defineProperty(T.prototype,"id",{get:function(){return this.bf},set:function(a){this.bf=a;this.c.id=this.bf}});Object.defineProperty(T.prototype,"ready",{get:function(){return this.ne}});
Object.defineProperty(T.prototype,"parent",{get:function(){return this.m},set:function(a){"object"===typeof a&&!1!==Array.isArray(a.children)&&a!==this.m&&(this.m=a,this.c.style.position="absolute",!0===this.R&&this.Ab(this.R),Md(this,"both"),Ld(this),null!==this.Mb&&this.Mb.D(),!0===this.m.ld()&&(this.Sd(),this.ic()))}});Object.defineProperty(T.prototype,"visible",{get:function(){return"block"===this.c.style.display},set:function(a){"boolean"===typeof a&&(!0===a?this.fh():this.Vj())}});
...
Object.defineProperty(T.prototype,"onShow",{get:function(){null===this.hd&&(this.hd=new q(this));return this.hd}});Object.defineProperty(T.prototype,"onHide",{get:function(){null===this.Mc&&(this.Mc=new q(this));return this.Mc}});Object.defineProperty(T.prototype,"onFullscreenEnter",{get:function(){null===this.Ob&&(this.Ob=new q(this));return this.Ob}});Object.defineProperty(T.prototype,"onFullscreenExit",{get:function(){null===this.Pb&&(this.Pb=new q(this));return this.Pb}});
function t(a,b,d,g){this.f=[];this.M="undefined"!==typeof g?g:null;this.B=null;this.Jf=!1;this.fa="hidden";T.call(this,a,b,d||"DisplayObjectContainer")}t.prototype=Object.create(T.prototype);e=t.prototype;e.constructor=t;
...
e.Xb=function(a){if(a===this)throw"You can't add a $_DisplayObjectContainer to itself!";var b=a;a instanceof Element&&(b=new T(a));this.c.appendChild(b.dom);b.parent=this;a=this.f.push(b)-1;null===b.index&&(b.index=a)};e.mn=function(a,b){var d=a;a instanceof Element&&(d=new T(a));this.c.appendChild(d.dom);d.parent=this;this.f.splice(b,0,d);d.index=b;b=0;for(d=this.f.length;b<d;b++)a=this.f[b],a.index=b};
e.yj=function(){var a=this.f;if(0<a.length){this.Jf=!0;for(var b=0,d=a.length;b<d;b++)if(!0===a[b].ld()&&!0===a[b].visible){var g=Math.max(a[b].width+a[b].x,a[b].width+a[b].left,a[b].width+a[b].right),h=Math.max(a[b].height+a[b].y,a[b].height+a[b].top,a[b].height+a[b].bottom);g>this.pixelWidth&&(this.width=g);h>this.pixelHeight&&(this.height=h)}}null!==this.parent&&!0===B.T(this.parent,"DisplayObjectContainer")&&!0===this.parent.Jf&&this.parent.yj()};
e.removeChild=function(a,b){a=Od(this,a);-1!==a&&this.Ag(a,b)};e.Ag=function(a,b){if(0<=a&&a<this.f.length){var d=this.f[a];this.f.splice(a,1);this.c.removeChild(d.dom);"undefined"!==typeof b&&!0!==b||d.destroy();!0!==this.Jf||this.f.length||(this.height=this.width=0)}};e.dh=function(a){for(var b=this.f.length;b--;)this.Ag(b,a)};e.Jk=function(a){return-1!==Od(this,a)};e.destroy=function(){this.dh(!1);this.B=this.M=this.f=null;T.prototype.destroy.call(this)};
...
e.ta=function(a){var b=a.property;-1!==b.toLowerCase().indexOf("width")&&"autoWidth"!==b&&(this.qa=!1);-1!==b.toLowerCase().indexOf("height")&&"autoHeight"!==b&&(this.pa=!1);null!==this.B&&(this.F===Qd.CSS?(Rd(this),Sd(this)):this.F===Qd.Jb&&null!==this.f&&this.ad(this.f),!0===this.Kb&&(-1!==b.toLowerCase().indexOf("width")?(b=this.pixelWidth/this.f.w,b!==this.na&&(this.na=b,!0===this.Kb&&(this.oa=b,this.height=this.f.h*this.oa))):-1!==b.toLowerCase().indexOf("height")&&(b=this.pixelHeight/this.f.h,
b!==this.oa&&(this.oa=b,!0===this.Kb&&(this.na=b,this.width=this.f.w*this.na)))),T.prototype.ta.call(this,a))};e.Lf=function(){this.F===Qd.CSS?this.c.style.backgroundPosition=-this.N+"px "+-this.N+"px":this.F===Qd.Jb&&(this.j.style.top=-this.N+"px",this.j.style.left=-this.N+"px");T.prototype.Lf.call(this)};e.Pe=function(){var a=this.M+"_"+this.i.i18n.locale;if(a!==this.sa&&(this.sa=a,!0===this.i.i18n.xb(this.ga))){var b=this.V.value;this.P=!1;this.i.load.image(a,b,this.Rd,this)}};
function Td(a,b){a.f=b;!0===a.qa&&(a.u=a.f.w,a.C="px",a.c.style.width=a.pixelWidth+"px");!0===a.pa&&(a.o=a.f.h,a.A="px",a.c.style.height=a.pixelHeight+"px");a.F===Qd.CSS?(Rd(a),Sd(a)):a.F===Qd.Jb&&a.ad(a.f)}e.ad=function(a){if(null!==this.B&&!1!==this.$){this.j.width=this.innerWidth;this.j.height=this.innerHeight;var b=this.j.getContext("2d");b.clearRect(0,0,this.innerWidth,this.innerHeight);b.drawImage(this.B,a.x,a.y,a.w,a.h,0,0,this.innerWidth,this.innerHeight)}};
...
e.pm=function(a){"undefined"!==typeof a.data.frames?this.ea=a.data.frames:this.warn("No frames found in file!");this.la=!0;Ud(this)};function Ud(a){if(!0!==a.P&&!0===a.$&&!0===a.la){a.P=!0;var b;null!==a.f?b=a.f:null!==a.ea?b=a.ea[0].frame:b={x:0,y:0,w:a.B.naturalWidth,h:a.B.naturalHeight};Td(a,b);Ld(a);Kd(a);null!==a.J&&a.J.D()}}
...
this.fa&&"string"===typeof this.ga){this.V=new za(this.i,this.ga);!1===this.i.i18n.onLocaleChangeComplete.has(this.Pe,this)&&this.i.i18n.onLocaleChangeComplete.add(this.Pe,this);var d=this.i.i18n.locale;""!==d&&(a=this.M+"_"+d);!0===this.i.i18n.xb(this.ga)&&(b=this.V.value)}""!==b?(this.P=!1,this.i.load.image(a,b,this.Rd,this)):this.$=!0;"string"===typeof this.ma&&""!==this.ma?(a=this.ma,this.P=!1,this.i.load.json(this.M+"-frames",a,this.pm,this)):this.la=!0};
e.De=function(){this.c.style.backgroundImage="";this.B=null};
e.destroy=function(a){if(!1!==this.ib){null!==this.V&&(this.V.destroy(),this.V=null,this.i.i18n.onLocaleChangeComplete.remove(this.Pe,this));null!==this.S&&(this.S.destroy(),this.S=null);null!==this.J&&(this.J.destroy(),this.J=null);this.B=null;if("undefined"===typeof a||!0===a)if(!0===this.fa){a=this.i.i18n.locales;for(var b,d=0,g=a.length;d<g;d++)b=this.M+"_"+a[d],this.i.cache.remove(A.IMAGE,b)}else this.i.cache.remove(A.IMAGE,this.M);T.prototype.destroy.call(this)}};
...
e.ad=function(a){this.log(a);this.F!==Qd.Jb?this.warn("Invalid render mode for "+this.Ta):null!==this.B&&!1!==this.$&&(this.u=this.j.width=this.I.width*this.na,this.c.style.width=this.j.width+"px",this.o=this.j.height=this.I.height*this.oa,this.c.style.height=this.j.height+"px",a=this.j.getContext("2d"),a.clearRect(0,0,this.j.width,this.j.height),a.drawImage(this.B,0,0,this.I.width,this.I.height,0,0,this.j.width,this.j.height))};e.destroy=function(){this.I=null;I.prototype.destroy.call(this)};
...
e.Ea=function(){T.prototype.Ea.call(this);this.S=this.nm.bind(this);this.f=document.createElement("iframe");this.f.style.width="100%";this.f.style.height="100%";this.f.style.border=0;this.f.style.overflow="hidden";this.f.addEventListener("load",this.S,null!==this&&!!this);this.f.setAttribute("allowFullScreen","");this.c.appendChild(this.f);null!==this.V&&this.load(this.V);this.i.display.register(this);Jd(this);Kd(this)};
e.Oe=function(){this.log("_localeChangeComplete");!0===this.i.i18n.xb(this.B)&&Xd(this,this.J.value)};function Xd(a,b){a.log("_loadIframe url: "+b);a.P=!1;null!==a.I&&a.I.D();a.j=b;a.f.src=a.j}e.nm=function(){""!==this.j&&(this.log("_loadCompleteHandler url: "+this.j),this.P=!0,null!==this.F&&this.F.D())};function Yd(a){!1===a.i.i18n.onLocaleChangeComplete.has(a.Oe,a)&&a.i.i18n.onLocaleChangeComplete.add(a.Oe,a)}
...
e.destroy=function(){!1!==this.ib&&(null!==this.J&&(this.J.destroy(),this.J=null,this.i.i18n.onLocaleChangeComplete.remove(this.Oe,this)),null!==this.I&&(this.I.destroy(),this.I=null),null!==this.F&&(this.F.destroy(),this.F=null),this.S=this.f=null,T.prototype.destroy.call(this))};
...
e.Ea=function(){T.prototype.Ea.call(this);this.ma=this.bm.bind(this);this.la=this.Ml.bind(this);this.ia=this.Ll.bind(this);this.Fa=document.createElement("span");this.c.appendChild(this.Fa);"undefined"!==typeof this.fa&&null!==this.fa&&this.load(this.fa);this.i.display.register(this);Jd(this);Kd(this)};
...
function be(a){!1===a.i.i18n.onLocaleChangeComplete.has(a.Xe,a)&&a.i.i18n.onLocaleChangeComplete.add(a.Xe,a)}e.Xe=function(){this.log("_localeChangeComplete");!0===this.i.i18n.xb(this.F)&&(this.value=this.I.value)};
e.bm=function(){!0===this.M&&null===this.f&&(this.f=document.createElement("textarea"),this.f.style.position="absolute",this.f.style.top="0px",this.f.style.left="0px",this.f.style.width="100%",this.f.style.height="100%",this.f.style.resize="none",this.f.style.margin="0px",this.f.style.padding="0px",this.f.style.overflowX="hidden",this.f.style.overflowY="auto",this.f.style.boxSizing="border-box",this.f.value=this.V,this.f.addEventListener("input",this.la,!1),this.f.addEventListener("blur",this.ia,
!1),this.c.appendChild(this.f),this.f.focus())};e.Ml=function(){$d(this,this.f.value)};e.Ll=function(){this.Hf()};e.Hf=function(){null!==this.f&&(this.f.removeEventListener("input",this.la,!1),this.f.removeEventListener("blur",this.ia,!1),this.c.removeChild(this.f),this.f=null)};
...
this.value=a);!0===this.j&&"string"===typeof this.F&&""!==this.F&&(ae(this),be(this))};e.destroy=function(){!1!==this.ib&&(null!==this.I&&(this.I.destroy(),this.I=null,this.i.i18n.onLocaleChangeComplete.remove(this.Xe,this)),this.Hf(),null!==this.B&&(this.B.destroy(),this.B=null),null!==this.J&&(this.J.destroy(),this.J=null),T.prototype.destroy.call(this))};
...
Object.defineProperty(S.prototype,"editable",{get:function(){return this.M},set:function(a){a=!!a;this.M!==a&&(this.M=a,!1===this.M?(this.c.removeEventListener("click",this.ma,null!==this&&!!this),this.i.keyboard.ye(this.$),this.$=null,this.pointer.enabled=!0,this.c.style.cursor="text"):(this.c.addEventListener("click",this.ma,null!==this&&!!this),this.$=new P(this.i,[13,27],this.Hf,null,null,null,this),this.i.keyboard.Qf(this.$),this.c.style.cursor="default"))}});
...
e.constructor=od;
e.Ea=function(){t.prototype.Ea.call(this);this.I="out";this.J=new I(this.i);this.J.onLoadComplete.add(this.Pd,this);this.J.onResize.add(this.Qd,this);this.Xb(this.J);this.j=new S(this.i);this.j.onLoadComplete.add(this.Pd,this);this.j.onResize.add(this.Qd,this);this.j.autoWidth=!0;this.j.autoHeight=!0;this.Xb(this.j);this.pointer.enabled=!0;this.pointer.cursor=Ed.Za;this.pointer.onEnter.add(this.tm,this);this.pointer.onLeave.add(this.um,this);this.pointer.onPressStart.add(this.Ik,this);this.pointer.onPressEnd.add(this.Hk,
this);this.i.display.register(this);Jd(this);Kd(this);this.i.i18n.onLocaleChangeComplete.add(this.Wg,this);this.load(this.ga)};e.tm=function(){ce(this,"over")};e.um=function(){ce(this,"out")};e.Ik=function(){ce(this,"down")};e.Hk=function(){ce(this,"over")};e.Wg=function(){ce(this,this.I)};e.Pd=function(a){this.log("_itemLoadComplete "+a.emitter.className);this.ea++;2===this.ea&&(this.log("_allItemsLoaded"),de(this),ee(this))};e.Qd=function(){de(this);ee(this)};function fe(a,b){a.P=b;ce(a,a.I)}
function ce(a,b){a.I=b;b=a.F[a.P];a.ea=0;var d=b.Rj(a.I);a.background=b.Qa("background",a.I);a.borderStyle=b.Qa("borderStyle",a.I);a.borderColor=b.Qa("borderColor",a.I);a.borderRadius=b.Qa("borderRadius",a.I);a.borderWidth=b.Qa("borderWidth",a.I);a.V=b.Qa("autoWidth",a.I);a.S=b.Qa("autoHeight",a.I);var g=b.Qa("label",a.I);"undefined"!==typeof g&&a.j.load(g);!0===d&&a.J.load(b.Qa("image",a.I))}
...
e.load=function(a){if("undefined"!==typeof a&&null!==a){if(!0===B.Ga(a.skins,"ButtonSkin"))for(var b=0,d=a.skins.length;b<d;b++)this.jc(a.skins[b]);else if("object"===typeof a.skins&&0<a.skins.length)for(var d=0,g=a.skins.length;d<g;d++)b=new ge(a.skins[d].name,a.skins[d].states),this.jc(b);B.T(a.skin,"ButtonSkin")?this.jc(a.skin):"object"===typeof a.skin&&(b=new ge(a.skin.name,a.skin.states),this.jc(b));!0===B.T(a["default"],"string")&&!0===this.Sj(a["default"])&&(this.$=a["default"])}a=this.F||
{};Object.keys(a).length||(b=new ge("default"),this.jc(b));""===this.$&&(this.$=this.F[Object.keys(a)[0]].name);fe(this,this.$)};e.jc=function(a,b){if(!1===B.T(a,"ButtonSkin"))throw"$_Button: Invalid button skin!";a.Gg("out");this.F[a.name]=a;!0===b&&fe(this,a.name)};e.uk=function(a){"string"===typeof a&&!0===B.T(this.F[a],"ButtonSkin")?fe(this,a):!0===B.T(a,"ButtonSkin")&&(this.F[a.name]===a?fe(this,a.name):"undefined"!==typeof this.F[a.name]&&null!==this.F[a.name]||this.jc(a,!0))};
e.Sj=function(a){return"undefined"!==typeof this.F[a]};e.io=function(){this.F[this.P].Gg("out");fe(this,this.P)};
...
borderRadius:5,borderWidth:2,autoWidth:!0,autoHeight:!0,align:"left",padding:5,spacing:0,first:"image",image:le,label:me};ge.prototype.Gg=function(a){"undefined"!==typeof this.c[a]&&(this.f=this.c[a])};ge.prototype.Qa=function(a,b){b=B.he(this.c,b+"."+a,B.he(this.f,a,B.he(ke,a)));"object"===typeof b&&(b=B.kc(this.f[a],b));return b};ge.prototype.Rj=function(a){a=this.Qa("image",a);return"undefined"!==typeof a&&"string"===typeof a.url&&""!==a.url};
...
e.Ea=function(){T.prototype.Ea.call(this);!0===this.Bb&&!1===oe(this)&&(this.log("$_VideoHTML5: can't manage ambisonic sound without Google Chrome Omnitone library and WebAudio API."),this.Bb=!1);this.O=this.Rc;ba(this);this.S=this.Km.bind(this);this.tb=this.Lm.bind(this);this.vb=this.Nm.bind(this);this.ub=this.Mm.bind(this);this.sb=this.Jm.bind(this);this.wb=this.Om.bind(this);this.rb=this.Im.bind(this);this.Fb=this.Pm.bind(this);this.j=this.zm.bind(this);this.Pa=this.i.clock.create(!1);this.gb=
this.i.clock.create(!1);this.gb.Ye(500,this.Kl,this);this.i.audio.onVolumeChange.add(this.Vh,this);this.i.audio.onDisable.add(this.Uh,this);this.V=new q(this,!0);null!==this.ac&&this.load(this.ac);this.i.display.register(this,oe(this));Jd(this);Kd(this)};e.ta=function(a){var b=pe(this);null!==b&&null!==b.element&&(b.element.setAttribute("width",this.pixelWidth),b.element.setAttribute("height",this.pixelHeight));T.prototype.ta.call(this,a)};
...
k;d.lastTimeStamp=0;d.requestCount++;g=a.F[a.B];-1<a.I&&(d.element.addEventListener("loadstart",a.tb,!1),d.element.addEventListener("error",a.S,!1));h=document.createElement("source");h.addEventListener("error",a.S,!1);h.src=g.url;h.type=g.mimeType;d.element.appendChild(h);a.ec=a.ui.bind(a);!0===oe(a)?(a.f=a.i.audio.context,a.Eb=Omnitone.createFOADecoder(a.f,d.element,{channelMap:a.Ic}),a.dc=a.dm.bind(a),a.Eb.initialize().then(a.ec,a.dc)):a.ui();-1===a.I?(a.log("No current video, set directly the current index"),
ye(a,b)):(a.Pa.add(2E4,a.an,a),a.Pa.start())}}e.ui=function(){-1===this.B?pe(this).element.load():se(this).element.load()};e.dm=function(){this.log("FOA decoder could not be initialized")};e.Lm=function(){var a=se(this).element;this.log("_onRequestLoadStart [readyState: "+a.readyState+"]");a.removeEventListener("loadstart",this.tb,!1);a.addEventListener("loadedmetadata",this.vb,!1)};
e.Nm=function(){var a=se(this).element;this.log("_onRequestLoadedMetaData [readyState: "+a.readyState+"]");a.removeEventListener("loadedmetadata",this.vb,!1);a.addEventListener("loadeddata",this.ub,!1)};e.Mm=function(){var a=se(this).element;this.log("_onRequestLoadedData [readyState: "+a.readyState+"]");a.removeEventListener("loadeddata",this.ub,!1);!0===N.Dc?(a.addEventListener("play",this.sb,!1),a.play()):ye(this,this.B,!0)};
e.Jm=function(){var a=se(this).element;this.log("_onRequestCanPlayBeforeSeek [readyState: "+a.readyState+"]");a.pause();a.removeEventListener("play",this.sb,!1);a.addEventListener("seeked",this.wb,!1);var b=this.currentTime;a.currentTime=!0===this.P&&!1===this.qb?b+6:b};
e.Om=function(){var a=se(this).element;this.log("_onRequestSeeked [readyState: "+a.readyState+"]");a.removeEventListener("seeked",this.wb,!1);4===a.readyState?(a.removeEventListener("error",this.S,!1),ze(this)):a.addEventListener("canplay",this.rb,!1)};e.Im=function(){var a=se(this).element;this.log("_onRequestCanPlayAfterSeek [readyState: "+a.readyState+"]");a.removeEventListener("canplay",this.rb,!1);a.removeEventListener("error",this.S,!1);ze(this)};
function ze(a){var b=pe(a);null!==b&&null!==b.element&&!1===a.qb&&(a.log("Current video listen to seek, wait both video to sync"),b.element.addEventListener("seeked",a.Fb,!1),a.Pa.Ye(10,a.jn,a));for(var b=se(a).element,d,g=0,h=b.children.length;g<h;g++)d=b.children[g],d.removeEventListener("error",a.S,!1);!0===a.qb&&ye(a,a.B)}e.Pm=function(){this.log("_onRequestSeekedWhileSync "+this.currentTime);var a=this.B;Ae(this,!1);ve(this,a)};
e.jn=function(){this.log("_videoSyncTimerLoop "+this.B);var a=se(this);null!==a&&this.currentTime>=a.element.currentTime&&this.currentTime<a.element.currentTime+.05&&ye(this,this.B)};e.an=function(){this.log("_requestTimeOutHandler");Ae(this,!0)};e.Km=function(a){this.log("_onRequestError");this.log(a);Ae(this,!0)};
...
function we(a){var b=se(a),d;null!==b&&(d=b.element,d.removeEventListener("loadstart",a.tb,!1),d.removeEventListener("loadedmetadata",a.vb,!1),d.removeEventListener("loadeddata",a.ub,!1),d.removeEventListener("play",a.sb,!1),d.removeEventListener("seeked",a.wb,!1),d.removeEventListener("canplay",a.rb,!1),d.removeEventListener("error",a.S,!1),b=qe(a,b),-1!==b&&ue(a,b),a.B=-1)}e.Vh=function(){Be(this)};
function Be(a,b){b=b||pe(a);null!==b&&null!==b.element&&!0===a.i.audio.enabled&&(b.element.volume=a.fb*a.i.audio.volume)}e.Uh=function(){var a=pe(this);null!==a&&null!==a.element&&!1===this.i.audio.enabled&&(a.element.volume=0)};
e.zm=function(a){var b=pe(this).element;this.log(a.type+" [readyState: "+b.readyState+"]");switch(a.type){case "loadstart":null!==this.la&&this.la.D(a);break;case "durationchange":null!==this.fa&&1===b.readyState&&this.fa.D(a);break;case "loadedmetadata":this.rc=!0;null!==this.pa&&this.pa.D(a);break;case "loadeddata":null!==this.ma&&this.ma.D(a);break;case "progress":null!==this.Aa&&this.Aa.D(a);break;case "canplay":this.Db=!0;null!==this.$&&this.$.D(a);break;case "canplaythrough":this.Db=!0;null!==
...
lastTimeStamp:0},b[g]=d;this.J=b;ve(this,0)};e.play=function(a,b){this.currentTime=a;this.loop=b;a=pe(this);null!==a&&null!==a.element&&(a.element.play(),this.P=!0,this.tc++)};e.pause=function(){var a=pe(this);null!==a&&null!==a.element&&(a.element.pause(),this.P=!1)};e.stop=function(){var a=pe(this);null!==a&&null!==a.element&&(a.element.pause(),a.element.currentTime=0,this.P=!1)};e.zl=function(){!0===this.P||!1===this.i.audio.enabled?this.pause():this.play()};
e.bb=function(){!0!==this.Sa&&!1!==this.i.audio.enabled&&(this.Sa=!0,this.sc=this.fb,this.fb=0,Be(this),null!==this.qa&&this.qa.D())};e.Wh=function(a){!1!==this.Sa&&(a="number"===typeof a?a:this.sc,this.Sa=!1,this.fb=G.X(a,0,1),Be(this),null!==this.La&&this.La.D())};
...
Object.defineProperty(K.prototype,"volume",{get:function(){return this.fb},set:function(a){"number"===typeof a&&(this.fb=G.X(a,0,1),this.Sa=!1,Be(this))}});Object.defineProperty(K.prototype,"muted",{get:function(){return this.Sa},set:function(a){!0===!!a?this.bb():this.Wh()}});Object.defineProperty(K.prototype,"ambisonic",{get:function(){return this.Bb}});Object.defineProperty(K.prototype,"onLoadStart",{get:function(){null===this.la&&(this.la=new q(this));return this.la}});
...
function J(a,b,d,g){this.i=a;this.Hl=b;this.Qc=d||null;this.Sa="";this.Fa=null;this.Gl=g||ne.Hb;this.Oa="";this.j=null;this.Rc=!1;this.Ka=1;this.Ca=!1;this.hi=0;this.ei=!1;this.Xa=this.f=null;this.ff=this.ef=this.Ha=this.Pa=0;this.gb=this.Aa=this.tc=this.Ic=null;this.fb=this.Da=!1;this.di=this.ii=0;this.Bb=this.hf=this.bc=this.dc=this.Fb=this.qc=this.La=this.tb=this.ec=this.sc=this.rc=this.Db=this.Eb=this.rb=this.qb=this.sb=this.ac=this.vb=this.wb=this.ub=this.Ba=this.ma=this.B=this.Ja=this.la=this.pa=
...
e.Ea=function(){T.prototype.Ea.call(this);if("undefined"===typeof dashjs)throw"$_VideoDash._boot: Can't create MPEG-DASH video stream without dash.js Media Player.";this.O=this.Hl;ba(this);this.ub=this.Bm.bind(this);this.sb=this.xm.bind(this);this.wb=this.ul.bind(this);this.vb=this.Cm.bind(this);this.ac=this.Fm.bind(this);this.qb=this.wm.bind(this);this.rb=this.sl.bind(this);this.Eb=this.wl.bind(this);this.Db=this.vl.bind(this);this.rc=this.Um.bind(this);this.sc=this.Zm.bind(this);this.ec=this.Rm.bind(this);
this.tb=this.tl.bind(this);this.La=this.ym.bind(this);this.qc=this.Sm.bind(this);this.Fb=this.Em.bind(this);this.dc=this.Hm.bind(this);this.bc=this.Gm.bind(this);this.hf=this.Tm.bind(this);this.Bb=this.Dm.bind(this);this.i.audio.onVolumeChange.add(this.Sh,this);this.i.audio.onDisable.add(this.Rh,this);this.B=new q(this,!0);null!==this.Qc&&this.load(this.Qc);this.i.display.register(this);Jd(this);Kd(this)};
...
e.Bm=function(a){this.log("onLoadStart [readyState: "+this.j.element.readyState+"]");var b=this.Sa,d=this.f.getBitrateInfoListFor(Ee.VIDEO),g=[],h;if(null!==d){for(var k=0,n=d.length;k<n;k++)h=new De(b),h.id=d[k].qualityIndex,h.bitrate=d[k].bitrate,h.width=d[k].width,h.height=d[k].height,g.push(h);this.Fa=g;null!==this.B&&this.B.D(g)}else this.destroy();null!==this.S&&this.S.D(a)};e.Tm=function(a){this.log("_onSwitchCompleted [readyState: "+this.j.element.readyState+"]");this.Xa=a.toStreamInfo};
e.Dm=function(a){this.log("_onMetricsChangedHandler [readyState: "+this.j.element.readyState+"]");null===this.Ic&&(this.Ic=this.f.getMetricsFor(Ee.VIDEO));null===this.tc&&(this.tc=this.f.getMetricsFor(Ee.AUDIO));null===this.Aa&&(this.Aa=this.f.getDashMetrics());if(null!==this.Ba){var b;a.mediaType===Ee.VIDEO&&(b=Ge(this,Ee.VIDEO,this.Ic,this.Aa))&&(this.gb={videoBitrate:b.bitrate,videoIndex:b.index,videoPendingIndex:b.mk,videoMaxIndex:b.gk,videoBufferLength:b.jj,videoDroppedFrames:b.droppedFrames});
a.mediaType===Ee.AUDIO&&(b=Ge(this,Ee.AUDIO,this.tc,this.Aa))&&(this.gb={audioBitrate:b.bitrate,audioIndex:b.index,audioPendingIndex:b.mk,audioMaxIndex:b.gk,audioBufferLength:b.jj,audioDroppedFrames:b.droppedFrames});this.Ba.D(a)}};
function Ge(a,b,d,g){if(null!==d&&null!==g){var h=a.Xa.index,k,n,v,x,E,Cb;k=g.getCurrentRepresentationSwitch(d);null!==k&&(n=Math.round(g.getBandwidthForRepresentation(k.to,h)/1E3));if(isNaN(n)||void 0===n)n=0;b===Ee.VIDEO?(v=a.Pa+1,x=a.Ha+1):b===Ee.AUDIO&&(v=a.ef+1,x=a.ff+1);if(isNaN(v)||void 0===v)v=0;if(isNaN(x)||void 0===x)x=0;a=g.getMaxIndexForBufferType(b,h);if(isNaN(a)||void 0===a)a=0;b=g.getCurrentBufferLevel(d);null!==b&&(E=b.toPrecision(5));if(isNaN(E)||void 0===E)E=0;d=g.getCurrentDroppedFrames(d);
null!==d&&(Cb=d.droppedFrames);return{bitrate:n,index:v,mk:x,gk:a,jj:E,droppedFrames:Cb}}return null}e.Gm=function(a){this.log("onQualityChange [readyState: "+this.j.element.readyState+"]");a.mediaType===Ee.AUDIO?this.ff=this.ef=a.newQuality:a.mediaType===Ee.VIDEO&&(this.Ha=this.Pa=a.newQuality,null!==this.la&&this.la.D(this.Ha))};
e.Hm=function(a){this.log("onQualityRequest [readyState: "+this.j.element.readyState+"]");a.mediaType===Ee.AUDIO?(this.ef=a.oldQuality,this.ff=a.newQuality):a.mediaType===Ee.VIDEO&&(this.Pa=a.oldQuality,this.Ha=a.newQuality,null!==this.pa&&this.pa.D(this.Ha))};e.xm=function(a){var b=this.j.element;this.log("onDurationChange [readyState: "+b.readyState+"]");null!==this.J&&1===b.readyState&&this.J.D(a)};
e.ul=function(a){this.log("onLoadedMetaData [readyState: "+this.j.element.readyState+"]");this.ei=!0;null!==this.$&&this.$.D(a)};e.Cm=function(a){this.log("onLoadedData [readyState: "+this.j.element.readyState+"]");null!==this.V&&this.V.D(a)};e.Fm=function(a){null!==this.ia&&this.ia.D(a)};e.wm=function(a){this.log("onCanPlay [readyState: "+this.j.element.readyState+"]");this.fb=!0;null!==this.F&&this.F.D(a)};
e.sl=function(a){this.log("onCanPlayThrough [readyState: "+this.j.element.readyState+"]");this.fb=!0;null!==this.I&&this.I.D(a)};e.wl=function(a){this.log("onPlay [readyState: "+this.j.element.readyState+"]");null!==this.fa&&this.fa.D(a)};e.vl=function(a){this.log("onPause [readyState: "+this.j.element.readyState+"]");this.Da=!1;null!==this.ea&&this.ea.D(a)};e.Um=function(a){null!==this.sa&&this.sa.D(a)};
e.Zm=function(a){var b=this.j.element;this.log("onVolumeChange [readyState: "+b.readyState+"]");null!==this.za&&0!==b.readyState&&this.za.D(a)};e.Rm=function(a){this.log("onSeeked [readyState: "+this.j.element.readyState+"]");this.fb=!1;null!==this.qa&&this.qa.D(a)};e.tl=function(a){this.log("onEnded [readyState: "+this.j.element.readyState+"]");this.Da=!1;this.di++;!0===this.Rc&&this.play();null!==this.M&&this.M.D(a)};
e.ym=function(a){this.log("onError [readyState: "+this.j.element.readyState+"]");null!==this.P&&this.P.D(a)};e.Sm=function(a){this.log("onStalled [readyState: "+this.j.element.readyState+"]");null!==this.ra&&this.ra.D(a)};e.Em=function(a){this.log("onPlaying [readyState: "+this.j.element.readyState+"]");null!==this.ga&&this.ga.D(a)};e.Rh=function(){var a=this.j;null!==a&&null!==a.element&&!1===this.i.audio.enabled&&this.f.setVolume(0)};e.Sh=function(){He(this)};
...
this.bc),this.f.on(dashjs.MediaPlayer.events.QUALITY_CHANGE_REQUESTED,this.dc),this.f.on(dashjs.MediaPlayer.events.STREAM_INITIALIZED,this.ub),this.f.on(dashjs.MediaPlayer.events.PLAYBACK_PLAYING,this.Fb),this.f.on(dashjs.MediaPlayer.events.BUFFER_EMPTY,this.qc),this.f.on(dashjs.MediaPlayer.events.PERIOD_SWITCH_COMPLETED,this.hf),this.f.on(dashjs.MediaPlayer.events.METRIC_CHANGED,this.Bb),this.j.element.addEventListener("loadeddata",this.vb,!1),this.j.element.addEventListener("durationchange",this.sb,
!1),this.j.element.addEventListener("canplaythrough",this.rb,!1),this.j.element.addEventListener("volumechange",this.sc,!1),this.c.innerHTML="",this.c.appendChild(this.j.element));""===this.Oa&&Je(this,this.Gl)};e.play=function(a,b){this.currentTime=a;this.loop=b;null!==this.f&&!0===this.f.isReady()&&(this.f.play(),this.Da=!0,this.ii++)};e.pause=function(){null!==this.f&&!0===this.f.isReady()&&(this.f.pause(),this.Da=!1)};
e.stop=function(){null!==this.f&&!0===this.f.isReady()&&(this.f.pause(),this.f.seek(0),this.j.element.currentTime=0,this.Da=!1)};e.yl=function(){!0===this.Da||!1===this.i.audio.enabled?this.pause():this.play()};e.bb=function(){!0!==this.Ca&&!1!==this.i.audio.enabled&&(this.Ca=!0,this.hi=this.Ka,this.Ka=0,He(this))};e.Th=function(a){!1!==this.Ca&&(a="number"===typeof a?a:this.hi,this.Ca=!1,this.Ka=G.X(a,0,1),He(this))};e.xl=function(a){null!==this.f&&!0===this.f.isReady()&&this.f.enableBufferOccupancyABR(a)};
...
e.add=function(a,b,d){var g;(g="string"!==typeof b||""===b)||(g=Oe(this,a),g=!0===(!0===Qe(a,b)&&!0===g.has(b)));g&&(b=Pe(this,a,a+"-cache"));return!1===this.has(b,a)&&(a=Oe(this,a),null!==a)?(a.set(b,d),!0):!1};e.remove=function(a,b){return!0===this.has(a,b)&&(a=Oe(this,a),null!==a)?(a.Qe(b),!0):!1};e.destroy=function(){this.c=this.f=this.O=this.i=null};function Re(){}e=Re.prototype;e.key="";e.url="";e.type="";e.data=null;e.ko=null;e.zb=!1;e.Lk=!1;e.Kk="";e.constructor=Re;
function wa(a){this.i=a;l.call(this,"Loader")}wa.prototype=Object.create(l.prototype);e=wa.prototype;e.constructor=wa;e.json=function(a,b,d,g,h,k){var n=new Re;n.type="json";n.key=a;n.url=b;n.c=d;n.f=g;n.O=h;n.j=k;Se(this,n,"text",this.jm,this.km)};
e.jm=function(a,b){if(b.responseText){if(a.data=Object(JSON.parse(b.responseText)),!1===this.i.cache.has(A.JSON,a.key)?this.i.cache.add(A.JSON,a.key,a):this.log("$_Loader.json : JSON file already exists"),"function"===typeof a.c&&null!==a.f){b=a.c;var d=a.f;a.c=null;a.f=null;a.O=null;a.j=null;b.call(d,a)}}else throw"$_Loader.json : JSON file empty ?";};
e.km=function(a,b){if(b.responseText){if("function"===typeof a.O&&null!==a.j){b=a.O;var d=a.j;a.c=null;a.f=null;a.O=null;a.j=null;b.call(d,a)}}else throw"$_Loader.json : JSON file empty ?";};e.Rk=function(a,b,d,g,h,k){h=new Re;h.type="xml";h.key=a;h.url=b;h.c=d;h.f=g;h.O=d;h.j=k;Se(this,h,"document",this.kn,this.ln)};
e.kn=function(a,b){if(b.responseXML){if(a.data=b.responseXML,!1===this.i.cache.has(A.Tb,a.key)?this.i.cache.add(A.Tb,a.key,a):this.log("$_Loader.xml : XML file already exists"),"function"===typeof a.c&&null!==a.f){b=a.c;var d=a.f;a.c=null;a.f=null;a.O=null;a.j=null;b.call(d,a)}}else throw"$_Loader.xml : XML file empty ?";};
e.ln=function(a,b){if(b.responseXML){if("function"===typeof a.O&&null!==a.j){b=a.O;var d=a.j;a.c=null;a.f=null;a.O=null;a.j=null;b.call(d,a)}}else throw"$_Loader.xml : JSON file empty ?";};e.sound=function(a,b,d,g,h){var k=new Re;k.type="sound";k.key=a;k.url=b;k.c=d;k.f=g;!0===this.i.audio.useWebAudio&&!0!==h?Se(this,k,"arraybuffer",this.Ui):!0!==this.i.audio.useAudioTag&&!0!==h||Te(k,this.Ui,this)};
e.Ui=function(a,b){!0===this.i.audio.useWebAudio&&"undefined"!==typeof b&&(a.data=b.response);this.i.cache.add(A.pb,a.key,a);"function"===typeof a.c&&null!==a.f&&a.c.call(a.f,a)};
...
We.prototype.yb=function(){this.m.apply(this.o,this.j)};function xa(a){this.i=a;this.c=[];l.call(this,"TweenManager")}xa.prototype=Object.create(l.prototype);e=xa.prototype;e.constructor=xa;e.hn=function(a){this.remove(a.emitter)};e.add=function(a){this.c.push(a);a.onDestroy.ca(this.hn,this)};e.remove=function(a){a:{for(var b=0,d=this.c.length;b<d;b++)if(a===this.c[b]){a=b;break a}a=-1}-1!==a&&this.c.splice(a,1)};e.update=function(){for(var a=0,b=this.c.length;a<b;a++)this.c[a].update()};
...
e.Ze=function(a,b,d){null===this.f&&(this.f={});for(var g in a)this.f[g]={name:g,min:null,max:a[g],duration:"number"===typeof b?b:0,easing:"function"===typeof d?d:null,started:!1,complete:!1,startTime:null};return this};e.start=function(){this.H=Date.now();this.B=!0;this.A=this.G=!1;var a,b;for(b in this.f)a=this.f[b],a.min=this.C[b],a.max="string"===typeof this.f[b].max?a.min+parseInt(this.f[b].max,10):a.max,a.started=!0,a.startTime=this.H;null!==this.o&&this.o.D();return this};
...
!0);return d},clone:function(a){if(!(a instanceof Object))return a;var b=new a.constructor,d;for(d in a)b[d]=B.clone(a[d]);return b},Nn:function(a){return null!==a&&"object"===typeof a&&"string"===typeof a.className&&-1!==Id.indexOf(a.className)?!0:!1},T:function(a,b){if("string"===typeof b&&(null!==a&&"object"===typeof a&&"string"===typeof a.className&&a.className.toLowerCase()===b.toLowerCase()||typeof a===b.toLowerCase()))return!0;if(!0===Array.isArray(b)&&!0===B.Ga(b,"string"))for(var d=0,g=b.length;d<
g;d++)if(!0===B.T(a,b[d]))return!0;return!1},Qn:function(a,b,d){b=b.split(".");for(var g=0,h=b.length;g<h;g++){a=a[b[g]];if(g===h-1)return B.T(a,d);if("undefined"===typeof a)break}return!1},Ga:function(a,b){if("object"===typeof a&&!0===Array.isArray(a)){for(var d=0,g=a.length;d<g;d++)if(!1===B.T(a[d],b))return!1;return!0}return!1},he:function(a,b,d){b=b.split(".");for(var g=0,h=b.length;g<h;g++){a=a[b[g]];if("undefined"===typeof a)break;if(g===h-1)return a}return d},qd:function(a,b){var d=b.split("."),
g=d.length;a.sort(function(a,b){for(var h=0;h<g;)a=a[d[h]],b=b[d[h]],h++;return a<b?-1:a>b?1:0});return a},od:function(a){a=a.slice();for(var b,d,g=a.length-1;0<g;g--)d=~~(Math.random()*(g+1)),b=a[g],a[g]=a[d],a[d]=b;return a},pe:function(a,b,d){for(a=String(a);a.length<d;)a=b+a;return a},lk:function(a){a={input:a,hours:0,minutes:0,seconds:0};if("number"!==typeof a.input||isNaN(a.input))return a;a.Kn=parseInt(a.input/3600,10)%24;a.Sn=parseInt(a.input/60,10)%60;a.seconds=parseInt(a.input%60,10);return a},
wn:function(a,b){a=B.lk(a);var d="string"===typeof b?b:"H:M:S";b=0;-1!==d.indexOf("H")?b=2:-1!==d.indexOf("h")&&(b=1);var g=0;-1!==d.indexOf("M")?g=2:-1!==d.indexOf("m")&&(g=1);var h=0;-1!==d.indexOf("S")?h=2:-1!==d.indexOf("s")&&(h=1);d=d.toLowerCase();0<b&&(d=d.replace("h",B.pe(a.Kn,0,b)));0<g&&(d=d.replace("m",B.pe(a.Sn,0,g)));0<h&&(d=d.replace("s",B.pe(a.seconds,0,h)));return d},Ce:function(a,b,d){return new THREE.Spherical(a,Math.PI/2-d,b)},zn:function(a){return{radius:a.radius,theta:a.theta,
phi:Math.PI/2-a.phi}},ij:function(a,b){return a.filter(function(a){return 0>b.indexOf(a)})},Vn:function(a,b){return b>=a.length?null:a.splice(b,1)},endsWith:function(a,b){return"function"!==typeof String.prototype.endsWith?-1!==a.indexOf(b,a.length-b.length):a.endsWith(b)}},ha={fd:function(a,b){var d=window.getComputedStyle(a,null).getPropertyValue("display");a.style.display="none";b=window.getComputedStyle(a,null).getPropertyValue(b);a.style.display=d;return b},Nj:function(a){a=ha.fd(a,"width");
var b="px";-1<a.indexOf("%")&&(b="%");-1<a.indexOf("px")&&(b="px");return b},Pj:function(a){a=parseInt(ha.fd(a,"width"),10);return isNaN(a)?0:a},Mj:function(a){a=ha.fd(a,"height");var b="px";-1<a.indexOf("%")&&(b="%");-1<a.indexOf("px")&&(b="px");return b},Oj:function(a){a=parseInt(ha.fd(a,"height"),10);return isNaN(a)?0:a},has:function(a){return document.body.contains(a)},mg:function(a){return a instanceof HTMLElement},Cn:function(a){var b,d;d=["MouseEvent","PointerEvent","TouchEvent"];"object"===
...
e.Qe=function(a){if("undefined"!==typeof a&&void 0!==this.c[a])return delete this.c[a],--this.f};e.get=function(a){return this.c[a]};e.Uk=function(){var a=new md,b;for(b in this.c)a.add(b);return a.Ae()};e.Vk=function(){var a=new md,b;for(b in this.c)a.add(this.c[b]);return a.Ae()};e.Tk=function(){var a=new md,b;for(b in this.c){var d=[];d.push(b);d.push(this.c[b]);a.add(d)}return a.Ae()};e.Sk=function(){for(var a in this.c)this.Qe(a)};e.has=function(a){return 0<this.f&&void 0!==this.c[a]};
...
var Z={Xn:function(a,b,d){a/=255;b/=255;d/=255;var g=Math.max(a,b,d),h=Math.min(a,b,d),k,n=(g+h)/2;if(g===h)k=h=0;else{var v=g-h,h=.5<n?v/(2-g-h):v/(g+h);switch(g){case a:k=(b-d)/v+(b<d?6:0);break;case b:k=(d-a)/v+2;break;case d:k=(a-b)/v+4}k/=6}return{h:k,s:h,l:n}},Ln:function(a,b,d){if(b){var g=.5>d?d*(1+b):d+b-d*b,h=2*d-g;d=Z.ke(h,g,a+1/3);b=Z.ke(h,g,a);a=Z.ke(h,g,a-1/3)}else d=b=a=d;return{r:255*d,g:255*b,b:255*a}},ke:function(a,b,d){if(!(0>d||1<d)){if(d<1/6)return a+6*(b-a)*d;if(.5>d)return b;
if(d<2/3)return a+(b-a)*(2/3-d)*6}return a},Yn:function(a,b,d){a/=255;b/=255;d/=255;var g=Math.max(a,b,d),h=Math.min(a,b,d),k,n=g-h;if(g===h)k=0;else{switch(g){case a:k=(b-d)/n+(b<d?6:0);break;case b:k=(d-a)/n+2;break;case d:k=(a-b)/n+4}k/=6}return{h:k,s:g?n/g:0,v:g}},Mn:function(a,b,d){var g,h,k,n=Math.floor(6*a),v=6*a-n;a=d*(1-b);var x=d*(1-v*b);b=d*(1-(1-v)*b);switch(n%6){case 0:g=d;h=b;k=a;break;case 1:g=x;h=d;k=a;break;case 2:g=a;h=d;k=b;break;case 3:g=a;h=x;k=d;break;case 4:g=b;h=a;k=d;break;
case 5:g=d,h=a,k=x}return{r:255*g,g:255*h,b:255*k}},$d:function(a){a=a.toString(16);return 1===a.length?"0"+a:a},Wn:function(a,b,d){return"#"+Z.$d(a)+Z.$d(b)+Z.$d(d)},xn:function(a){a=a.split("(")[1].split(")")[0].split(",");var b={r:parseInt(a[0],10),g:parseInt(a[1],10),b:parseInt(a[2],10)};3<a.length&&(b.a=parseInt(a[3],10));return b},Jn:function(a){a=a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(a,d,g,h){return d+d+g+g+h+h});return(a=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(a))?
{r:parseInt(a[1],16),g:parseInt(a[2],16),b:parseInt(a[3],16)}:null},Zn:function(a){a=new THREE.Vector3(a.r,a.g,a.b);var b=(new THREE.Matrix3).set(.299,.587,.114,-.169,-.331,.5,.5,-.419,-.081),d=new THREE.Vector3(0,128,128);a.applyMatrix3(b).add(d);return{Y:a.x,Cr:a.y,Cb:a.z}},mo:function(a){a=new THREE.Vector3(a.Y,a.Cr,a.Cb);var b=new THREE.Vector3(0,-128,-128),d=(new THREE.Matrix3).set(1,0,1.4,1,-.343,-.711,1,1.765,0);a.add(b).applyMatrix3(d);return{r:a.x,g:a.y,b:a.z}},lo:function(a,b){var d=G.da(b);
...
r.prototype.destroy=r.prototype.destroy;w.prototype.boot=w.prototype.boot;w.prototype.load=w.prototype.load;w.prototype.hasScenes=w.prototype.ol;w.prototype.hasGroups=w.prototype.mc;w.prototype.nextScene=w.prototype.pl;w.prototype.previousScene=w.prototype.ql;w.prototype.notifySceneConfigLoadComplete=w.prototype.jk;w.prototype.loadScene=w.prototype.md;w.prototype.loadGroup=w.prototype.dk;w.prototype.destroy=w.prototype.destroy;D.prototype.load=D.prototype.load;D.prototype.hasChild=D.prototype.Je;
D.prototype.hasScene=D.prototype.Ec;D.prototype.hasGroup=D.prototype.gd;D.prototype.hasChildren=D.prototype.Fn;D.prototype.hasTypeOfChild=D.prototype.ig;D.prototype.hasScenes=D.prototype.Ke;D.prototype.hasGroups=D.prototype.mc;D.prototype.getChildrenUids=D.prototype.ed;D.prototype.getChildren=D.prototype.ee;D.prototype.nextScene=D.prototype.Mk;D.prototype.previousScene=D.prototype.Nk;D.prototype.destroy=D.prototype.destroy;C.prototype.addConfig=C.prototype.ha;C.prototype.load=C.prototype.load;
C.prototype.unload=C.prototype.De;C.prototype.hasGroup=C.prototype.gd;C.prototype.hasGroups=C.prototype.mc;C.prototype.destroy=C.prototype.destroy;F.prototype.extendConfiguration=F.prototype.vj;F.prototype.hasSoundSource=F.prototype.Tj;F.prototype.hasSoundTarget=F.prototype.Uj;F.prototype.isAmbisonic=F.prototype.$j;F.prototype.destroy=F.prototype.destroy;La.prototype.destroy=La.prototype.destroy;y.prototype.render=y.prototype.render;y.prototype.screenToWorld=y.prototype.screenToWorld;
y.prototype.worldToScreen=y.prototype.worldToScreen;y.prototype.enableVR=y.prototype.Kh;y.prototype.toggleVR=y.prototype.fo;y.prototype.setView=y.prototype.oc;y.prototype.destroy=y.prototype.destroy;ab.prototype.setSize=ab.prototype.setSize;ab.prototype.destroy=ab.prototype.destroy;Sa.prototype.enablePicking=Sa.prototype.bg;Sa.prototype.addBackground=Sa.prototype.bj;Sa.prototype.addRenderScenes=Sa.prototype.dj;Sa.prototype.addGlobalFx=Sa.prototype.cj;Sa.prototype.getShaderPassByUID=Sa.prototype.Dn;
Sa.prototype.setSize=Sa.prototype.setSize;Sa.prototype.render=Sa.prototype.render;Sa.prototype.clear=Sa.prototype.We;Sa.prototype.destroy=Sa.prototype.destroy;Qa.prototype.enableVR=Qa.prototype.Gh;Qa.prototype.getQuaternionFromPose=Qa.prototype.Hj;Qa.prototype.getRenderParams=Qa.prototype.Jj;Qa.prototype.setSize=Qa.prototype.setSize;Qa.prototype.submitFrame=Qa.prototype.Hh;Qa.prototype.destroy=Qa.prototype.destroy;rb.prototype.updateAfterViewChange=rb.prototype.fc;rb.prototype.setSize=rb.prototype.setSize;
rb.prototype.render=rb.prototype.render;rb.prototype.destroy=rb.prototype.destroy;Ya.prototype.render=Ya.prototype.render;Ya.prototype.updateAfterViewChange=Ya.prototype.fc;Ya.prototype.destroy=Ya.prototype.destroy;Xa.prototype.render=Xa.prototype.render;Xa.prototype.updateAfterViewChange=Xa.prototype.fc;Xa.prototype.destroy=Xa.prototype.destroy;ta.prototype.parseShaderPasses=ta.prototype.ve;ta.prototype.getFxSetByUID=ta.prototype.fe;ta.prototype.addConfig=ta.prototype.ha;ta.prototype.destroy=ta.prototype.destroy;
bb.prototype.destroy=bb.prototype.destroy;hb.prototype.render=hb.prototype.render;kb.prototype.destroy=kb.prototype.destroy;wb.prototype.shaderSTW=wb.prototype.Gc;wb.prototype.shaderWTS=wb.prototype.cc;wb.prototype.updateScreenToWorld=wb.prototype.pc;wb.prototype.worldToScreen=wb.prototype.worldToScreen;wb.prototype.screenToWorld=wb.prototype.screenToWorld;wb.prototype.destroy=wb.prototype.destroy;$a.prototype.shaderSTW=$a.prototype.Gc;$a.prototype.shaderWTS=$a.prototype.cc;
$a.prototype.updateScreenToWorld=$a.prototype.pc;$a.prototype.destroy=$a.prototype.destroy;Za.prototype.shaderSTW=Za.prototype.Gc;Za.prototype.shaderWTS=Za.prototype.cc;Za.prototype.updateScreenToWorld=Za.prototype.pc;Za.prototype.worldToScreen=Za.prototype.worldToScreen;Za.prototype.screenToWorld=Za.prototype.screenToWorld;Za.prototype.destroy=Za.prototype.destroy;xb.prototype.hasKeyframes=xb.prototype.Gn;xb.prototype.addKeyframe=xb.prototype.lb;xb.prototype.getKeyframes=xb.prototype.Bn;
xb.prototype.getKeyframesIndexes=xb.prototype.ge;xb.prototype.getSideKeyframes=xb.prototype.Kj;xb.prototype.getSideKeyframesIndexes=xb.prototype.Lj;xb.prototype.emptyKeyframes=xb.prototype.vn;xb.prototype.destroy=xb.prototype.destroy;zb.prototype.play=zb.prototype.play;zb.prototype.stop=zb.prototype.stop;zb.prototype.resume=zb.prototype.resume;zb.prototype.destroy=zb.prototype.destroy;Eb.prototype.stop=Eb.prototype.stop;Eb.prototype.resume=Eb.prototype.resume;Eb.prototype.destroy=Eb.prototype.destroy;
Hb.prototype.destroy=Hb.prototype.destroy;Ib.prototype.click=Ib.prototype.click;Ib.prototype.over=Ib.prototype.Se;Ib.prototype.out=Ib.prototype.rd;Ib.prototype.destroy=Ib.prototype.destroy;Ra.prototype.register=Ra.prototype.register;Ra.prototype.unregister=Ra.prototype.unregister;Ra.prototype.createRenderScenes=Ra.prototype.mj;Ra.prototype.getRaycastable=Ra.prototype.Ij;Ra.prototype.getByMesh=Ra.prototype.Fj;Ra.prototype.clear=Ra.prototype.Te;Ra.prototype.destroy=Ra.prototype.destroy;
Mb.prototype.start=Mb.prototype.start;Mb.prototype.stop=Mb.prototype.stop;Mb.prototype.click=Mb.prototype.click;Mb.prototype.clear=Mb.prototype.Fh;Qb.prototype.start=Qb.prototype.start;Qb.prototype.stop=Qb.prototype.stop;Qb.prototype.click=Qb.prototype.click;Qb.prototype.setSize=Qb.prototype.setSize;Qb.prototype.clear=Qb.prototype.ph;Qb.prototype.destroy=Qb.prototype.destroy;Pa.prototype.updateForViewType=Pa.prototype.Ck;Pa.prototype.clear=Pa.prototype.qh;Pa.prototype.setSize=Pa.prototype.setSize;
Pa.prototype.click=Pa.prototype.click;Pa.prototype.start=Pa.prototype.start;Pa.prototype.stop=Pa.prototype.stop;Pa.prototype.destroy=Pa.prototype.destroy;qa.prototype.boot=qa.prototype.boot;qa.prototype.getByType=qa.prototype.An;qa.prototype.addConfig=qa.prototype.ha;qa.prototype.addTracks=qa.prototype.ej;qa.prototype.update=qa.prototype.update;qa.prototype.clear=qa.prototype.Me;qa.prototype.destroy=qa.prototype.destroy;Ub.prototype.update=Ub.prototype.update;Ub.prototype.destroy=Ub.prototype.destroy;
$b.prototype.load=$b.prototype.load;$b.prototype.update=$b.prototype.update;$b.prototype.destroy=$b.prototype.destroy;Yb.prototype.load=Yb.prototype.load;Yb.prototype.update=Yb.prototype.update;Yb.prototype.destroy=Yb.prototype.destroy;Wb.prototype.load=Wb.prototype.load;Wb.prototype.destroy=Wb.prototype.destroy;Xb.prototype.load=Xb.prototype.load;Xb.prototype.play=Xb.prototype.play;L.prototype.load=L.prototype.load;L.prototype.lookAt=L.prototype.fk;L.prototype.update=L.prototype.update;
L.prototype.destroy=L.prototype.destroy;vc.prototype.play=vc.prototype.play;vc.prototype.destroy=vc.prototype.destroy;jc.prototype.load=jc.prototype.load;jc.prototype.start=jc.prototype.start;jc.prototype.stop=jc.prototype.stop;jc.prototype.update=jc.prototype.update;jc.prototype.destroy=jc.prototype.destroy;oa.prototype.notifyControlStart=oa.prototype.se;oa.prototype.notifyControlEnd=oa.prototype.re;oa.prototype.update=oa.prototype.update;oa.prototype.addConfig=oa.prototype.ha;
oa.prototype.destroy=oa.prototype.destroy;Gc.prototype.enable=Gc.prototype.enable;Gc.prototype.disable=Gc.prototype.Gb;Gc.prototype.destroy=Gc.prototype.destroy;Dc.prototype.enable=Dc.prototype.enable;Dc.prototype.disable=Dc.prototype.Gb;Dc.prototype.update=Dc.prototype.update;Dc.prototype.destroy=Dc.prototype.destroy;Fc.prototype.enable=Fc.prototype.enable;Fc.prototype.disable=Fc.prototype.Gb;Fc.prototype.update=Fc.prototype.update;Fc.prototype.destroy=Fc.prototype.destroy;u.prototype.boot=u.prototype.boot;
u.prototype.addConfig=u.prototype.ha;u.prototype.update=u.prototype.update;u.prototype.add=u.prototype.add;u.prototype.remove=u.prototype.remove;u.prototype.autoSuspend=u.prototype.Tf;u.prototype.autoResume=u.prototype.Sf;u.prototype.mute=u.prototype.bb;u.prototype.unmute=u.prototype.Mh;u.prototype.destroy=u.prototype.destroy;M.prototype.update=M.prototype.update;M.prototype.play=M.prototype.play;M.prototype.stop=M.prototype.stop;M.prototype.pause=M.prototype.pause;M.prototype.resume=M.prototype.resume;
M.prototype.mute=M.prototype.bb;M.prototype.unmute=M.prototype.Qh;M.prototype.destroy=M.prototype.destroy;Q.prototype.hasTracks=Q.prototype.gl;Q.prototype.play=Q.prototype.play;Q.prototype.stop=Q.prototype.stop;Q.prototype.pause=Q.prototype.pause;Q.prototype.resume=Q.prototype.resume;Q.prototype.nextTrack=Q.prototype.nd;Q.prototype.previousTrack=Q.prototype.xe;Q.prototype.destroy=Q.prototype.destroy;z.prototype.boot=z.prototype.boot;z.prototype.addConfig=z.prototype.ha;z.prototype.add=z.prototype.add;
z.prototype.addTrack=z.prototype.sh;z.prototype.hasPlaylists=z.prototype.Hn;z.prototype.hasTracks=z.prototype.al;z.prototype.play=z.prototype.play;z.prototype.stop=z.prototype.stop;z.prototype.pause=z.prototype.pause;z.prototype.resume=z.prototype.resume;z.prototype.nextTrack=z.prototype.nd;z.prototype.previousTrack=z.prototype.xe;z.prototype.destroy=z.prototype.destroy;Yc.prototype.play=Yc.prototype.play;Yc.prototype.stop=Yc.prototype.stop;Yc.prototype.pause=Yc.prototype.pause;
Yc.prototype.resume=Yc.prototype.resume;Yc.prototype.destroy=Yc.prototype.destroy;sa.prototype.load=sa.prototype.load;sa.prototype.play=sa.prototype.play;sa.prototype.stop=sa.prototype.stop;sa.prototype.destroy=sa.prototype.destroy;ac.prototype.addActions=ac.prototype.c;ac.prototype.dispatch=ac.prototype.D;ac.prototype.destroy=ac.prototype.destroy;$c.prototype.execute=$c.prototype.yb;$c.prototype.destroy=$c.prototype.destroy;ra.prototype.get=ra.prototype.get;ra.prototype.addConfig=ra.prototype.ha;
ra.prototype.destroy=ra.prototype.destroy;R.prototype.instantiate=R.prototype.Zj;R.prototype.notifyInstanceReady=R.prototype.Un;R.prototype.update=R.prototype.update;R.prototype.resetInstance=R.prototype.qk;R.prototype.destroy=R.prototype.destroy;fd.prototype.load=fd.prototype.load;fd.prototype.getNewInstance=fd.prototype.Gj;fd.prototype.destroy=fd.prototype.destroy;pa.prototype.boot=pa.prototype.boot;pa.prototype.addConfig=pa.prototype.ha;pa.prototype.getById=pa.prototype.de;
pa.prototype.getByIndex=pa.prototype.Ej;pa.prototype.get=pa.prototype.get;pa.prototype.remove=pa.prototype.remove;pa.prototype.update=pa.prototype.update;pa.prototype.render=pa.prototype.render;pa.prototype.destroy=pa.prototype.destroy;ed.prototype.string=ed.prototype.co;ed.prototype.textField=ed.prototype.eo;ed.prototype.sound=ed.prototype.sound;ed.prototype.displayObjectContainer=ed.prototype.un;ed.prototype.displayObject=ed.prototype.jl;ed.prototype.image=ed.prototype.image;
ed.prototype.sprite=ed.prototype.ao;ed.prototype.button=ed.prototype.il;ed.prototype.video=ed.prototype.ll;ed.prototype.canvas=ed.prototype.canvas;ed.prototype.tween=ed.prototype.kl;ed.prototype.destroyAllObjects=ed.prototype.rj;ed.prototype.destroy=ed.prototype.destroy;la.prototype.boot=la.prototype.boot;la.prototype.start=la.prototype.start;la.prototype.stop=la.prototype.stop;la.prototype.destroy=la.prototype.destroy;na.prototype.addConfig=na.prototype.ha;na.prototype.destroy=na.prototype.destroy;
q.prototype.add=q.prototype.add;q.prototype.addOnce=q.prototype.ca;q.prototype.remove=q.prototype.remove;q.prototype.has=q.prototype.has;q.prototype.dispatch=q.prototype.D;q.prototype.destroy=q.prototype.destroy;rd.prototype.execute=rd.prototype.yb;rd.prototype.detach=rd.prototype.nh;rd.prototype.destroy=rd.prototype.destroy;ma.prototype.addConfig=ma.prototype.ha;ma.prototype.getValue=ma.prototype.Yb;ma.prototype.hasValue=ma.prototype.xb;ma.prototype.destroy=ma.prototype.destroy;
za.prototype.destroy=za.prototype.destroy;vd.prototype.addConfig=vd.prototype.ha;vd.prototype.loadFiles=vd.prototype.rg;vd.prototype.getValue=vd.prototype.Yb;vd.prototype.hasValue=vd.prototype.xb;vd.prototype.getKey=vd.prototype.oh;vd.prototype.destroy=vd.prototype.destroy;ua.prototype.update=ua.prototype.update;ua.prototype.isKeyPressed=ua.prototype.On;ua.prototype.isKeyOut=ua.prototype.og;ua.prototype.addBinding=ua.prototype.Qf;ua.prototype.removeBinding=ua.prototype.ye;
ua.prototype.hasBinding=ua.prototype.En;ua.prototype.getBindings=ua.prototype.eg;ua.prototype.destroy=ua.prototype.destroy;P.prototype.hasKeyIn=P.prototype.je;P.prototype.hasKeyOut=P.prototype.hg;P.prototype.down=P.prototype.mh;P.prototype.waitToHold=P.prototype.jo;P.prototype.up=P.prototype.Bk;P.prototype.hold=P.prototype.Wj;P.prototype.destroy=P.prototype.destroy;Bd.prototype.enable=Bd.prototype.enable;Bd.prototype.disable=Bd.prototype.jh;Bd.prototype.destroy=Bd.prototype.destroy;
U.prototype.enable=U.prototype.enable;U.prototype.disable=U.prototype.Ue;U.prototype.destroy=U.prototype.destroy;ga.prototype.register=ga.prototype.register;ga.prototype.unregister=ga.prototype.unregister;ga.prototype.update=ga.prototype.update;ga.prototype.destroy=ga.prototype.destroy;T.prototype.show=T.prototype.fh;T.prototype.hide=T.prototype.Vj;T.prototype.toggleVisibility=T.prototype.ho;T.prototype.maximize=T.prototype.Ab;T.prototype.isInDom=T.prototype.ld;T.prototype.resize=T.prototype.eh;
T.prototype.fullscreenEnter=T.prototype.zj;T.prototype.fullscreenExit=T.prototype.Aj;T.prototype.isFullscreen=T.prototype.kd;T.prototype.destroy=T.prototype.destroy;t.prototype.update=t.prototype.update;t.prototype.addChild=t.prototype.Xb;t.prototype.addChildAt=t.prototype.mn;t.prototype.fitToContent=t.prototype.yj;t.prototype.removeChild=t.prototype.removeChild;t.prototype.removeChildAt=t.prototype.Ag;t.prototype.empty=t.prototype.dh;t.prototype.hasChild=t.prototype.Jk;t.prototype.destroy=t.prototype.destroy;
I.prototype.load=I.prototype.load;I.prototype.unload=I.prototype.De;I.prototype.destroy=I.prototype.destroy;ic.prototype.destroy=ic.prototype.destroy;nd.prototype.play=nd.prototype.play;nd.prototype.pause=nd.prototype.pause;nd.prototype.resume=nd.prototype.resume;nd.prototype.stop=nd.prototype.stop;nd.prototype.update=nd.prototype.update;nd.prototype.destroy=nd.prototype.destroy;Wd.prototype.load=Wd.prototype.load;Wd.prototype.destroy=Wd.prototype.destroy;S.prototype.load=S.prototype.load;
S.prototype.destroy=S.prototype.destroy;od.prototype.load=od.prototype.load;od.prototype.addSkin=od.prototype.jc;od.prototype.setSkin=od.prototype.uk;od.prototype.hasSkin=od.prototype.Sj;od.prototype.updateSkin=od.prototype.io;od.prototype.destroy=od.prototype.destroy;ge.prototype.setDefaultFromState=ge.prototype.Gg;ge.prototype.getProperty=ge.prototype.Qa;ge.prototype.hasImage=ge.prototype.Rj;ge.prototype.hasLabel=ge.prototype.m;K.prototype.update=K.prototype.update;K.prototype.load=K.prototype.load;
K.prototype.play=K.prototype.play;K.prototype.pause=K.prototype.pause;K.prototype.stop=K.prototype.stop;K.prototype.togglePlayback=K.prototype.zl;K.prototype.mute=K.prototype.bb;K.prototype.unmute=K.prototype.Wh;K.prototype.destroy=K.prototype.destroy;J.prototype.load=J.prototype.load;J.prototype.play=J.prototype.play;J.prototype.pause=J.prototype.pause;J.prototype.stop=J.prototype.stop;J.prototype.togglePlayback=J.prototype.yl;J.prototype.mute=J.prototype.bb;J.prototype.unmute=J.prototype.Th;
J.prototype.enableBufferOccupancyABR=J.prototype.xl;J.prototype.destroy=J.prototype.destroy;xe.prototype.getTimeRange=xe.prototype.j;xe.prototype.isInRanges=xe.prototype.bk;Vd.prototype.add=Vd.prototype.add;Vd.prototype.play=Vd.prototype.play;Vd.prototype.pause=Vd.prototype.pause;Vd.prototype.resume=Vd.prototype.resume;Vd.prototype.stop=Vd.prototype.stop;Vd.prototype.get=Vd.prototype.get;Vd.prototype.update=Vd.prototype.update;Vd.prototype.destroy=Vd.prototype.destroy;W.prototype.play=W.prototype.play;
W.prototype.pause=W.prototype.pause;W.prototype.resume=W.prototype.resume;W.prototype.stop=W.prototype.stop;W.prototype.update=W.prototype.update;W.prototype.destroy=W.prototype.destroy;va.prototype.has=va.prototype.has;va.prototype.get=va.prototype.get;va.prototype.add=va.prototype.add;va.prototype.remove=va.prototype.remove;va.prototype.destroy=va.prototype.destroy;Re.prototype.key=Re.prototype.key;Re.prototype.url=Re.prototype.url;Re.prototype.type=Re.prototype.type;Re.prototype.data=Re.prototype.data;
Re.prototype.xhr=Re.prototype.ko;Re.prototype.loading=Re.prototype.zb;Re.prototype.loaded=Re.prototype.Lk;Re.prototype.error=Re.prototype.Kk;wa.prototype.json=wa.prototype.json;wa.prototype.xml=wa.prototype.Rk;wa.prototype.sound=wa.prototype.sound;wa.prototype.image=wa.prototype.image;wa.prototype.script=wa.prototype.Fg;wa.prototype.css=wa.prototype.nj;wa.prototype.destroy=wa.prototype.destroy;ja.prototype.add=ja.prototype.add;ja.prototype.destroy=ja.prototype.destroy;ka.prototype.create=ka.prototype.create;
ka.prototype.add=ka.prototype.add;ka.prototype.update=ka.prototype.update;ka.prototype.destroy=ka.prototype.destroy;X.prototype.create=X.prototype.create;X.prototype.add=X.prototype.add;X.prototype.repeat=X.prototype.rl;X.prototype.loop=X.prototype.Ye;X.prototype.remove=X.prototype.remove;X.prototype.start=X.prototype.start;X.prototype.stop=X.prototype.stop;X.prototype.pause=X.prototype.pause;X.prototype.resume=X.prototype.resume;X.prototype.update=X.prototype.update;X.prototype.destroy=X.prototype.destroy;
We.prototype.execute=We.prototype.yb;xa.prototype.add=xa.prototype.add;xa.prototype.remove=xa.prototype.remove;xa.prototype.update=xa.prototype.update;xa.prototype.destroy=xa.prototype.destroy;Ab.prototype.to=Ab.prototype.Ze;Ab.prototype.start=Ab.prototype.start;Ab.prototype.stop=Ab.prototype.stop;Ab.prototype.update=Ab.prototype.update;Ab.prototype.destroy=Ab.prototype.destroy;Me.prototype.set=Me.prototype.set;Me.prototype["delete"]=Me.prototype.Qe;Me.prototype.get=Me.prototype.get;
Me.prototype.keys=Me.prototype.Uk;Me.prototype.values=Me.prototype.Vk;Me.prototype.entries=Me.prototype.Tk;Me.prototype.clear=Me.prototype.Sk;Me.prototype.has=Me.prototype.has;md.prototype.add=md.prototype.add;md.prototype.remove=md.prototype.remove;md.prototype.get=md.prototype.get;md.prototype.toArray=md.prototype.Ae;window.FORGE.Math=G;G.degToRad=G.da;G.radToDeg=G.$b;G.round10=G.pd;G.clamp=G.X;G.wrap=G.Wa;G.mix=G.Tn;G.smoothStep=G.$n;G.rotationMatrixToEuler=G.Bg;G.eulerToRotationMatrix=G.be;
window.FORGE.Quaternion=H;H.toEuler=H.Be;H.fromEuler=H.lc;H.toRotationMatrix=H.xk;H.fromRotationMatrix=H.yn;H.cancelRoll=H.cancelRoll;H.diffBetweenQuaternions=H.tn;H.angularDistance=H.hj;H.multiplyScalar=H.multiplyScalar;H.add=H.add;H.log=H.log;H.exp=H.exp;H.slerp=H.slerp;H.squad=H.bo;H.nlerpNoInvert=H.ik;H.slerpNoInvert=H.ze;H.squadNoInvert=H.vk;H.spline=H.Ig;bb.getUniqueName=ub;tb.parseIncludes=tb.eb;Qb.colorFrom3DObject=Rb;ge.isValid=function(a){return a?!0:!1};De.mimeTypeFromURL=Ke;
window.FORGE.Utils=B;B.parseSizeString=B.zg;B.extendSimpleObject=B.kc;B.extendMultipleObjects=B.ab;B.clone=B.clone;B.isDisplayObject=B.Nn;B.isTypeOf=B.T;B.isTypeOfRecursive=B.Qn;B.isArrayOf=B.Ga;B.getObjectProperty=B.he;B.sortArrayByProperty=B.qd;B.randomize=B.od;B.leftFill=B.pe;B.parseTime=B.lk;B.formatTime=B.wn;B.toTHREESpherical=B.Ce;B.fromTHREESpherical=B.zn;B.arrayByDifference=B.ij;B.removeItemFromArrayAtIndex=B.Vn;B.endsWith=B.endsWith;window.FORGE.Dom=ha;ha.getCssProperty=ha.fd;
ha.getUnitWidth=ha.Nj;ha.getValueWidth=ha.Pj;ha.getUnitHeight=ha.Mj;ha.getValueHeight=ha.Oj;ha.has=ha.has;ha.isHtmlElement=ha.mg;ha.getMouseEventOffset=ha.Cn;Xe.parse=Da;Xe.exists=function(a,b,d,g){var h=new XMLHttpRequest,k=null;h.onreadystatechange=function(){4===this.readyState&&200===this.status&&(clearTimeout(k),"function"===typeof b&&b.call(g))};h.onerror=function(a){console.log(a)};h.open("HEAD",a);h.send();k=window.setTimeout(function(){"function"===typeof d&&d.call(g)},500)};
Xe.isValid=function(a){return/((([A-Za-z]{3,9}:(?:\/\/)?)(?:[\-;:&=\+\$,\w]+@)?[A-Za-z0-9\.\-]+|(?:www\.|[\-;:&=\+\$,\w]+@)[A-Za-z0-9\.\-]+)((?:\/[\+~%\/\.\w\-]*)?\??(?:[\-\+=&;%@\.\w]*)#?(?:[\.\!\/\\\w]*))?)/.test(a)?!0:!1};window.FORGE.Color=Z;Z.rgbToHsl=Z.Xn;Z.hslToRgb=Z.Ln;Z.hueToRgb=Z.ke;Z.rgbToHsv=Z.Yn;Z.hsvToRgb=Z.Mn;Z.componentToHex=Z.$d;Z.rgbToHex=Z.Wn;Z.fromRgbaString=Z.xn;Z.hexToRgb=Z.Jn;Z.rgbToYcbcr=Z.Zn;Z.ycbcrToRgb=Z.mo;Z.ycbcrRotate=Z.lo;Z.distance=Z.distance;N.canPlayAudio=N.rn;
N.canPlayVideo=N.sn;N.isLowBattery=N.Pn;N.os=N.cb;N.vita=N.Mg;N.xbox=N.Vg;N.kindle=N.pg;N.windowsPhone=N.Fe;N.osVersion=N.Zb;N.android=N.fj;N.chromeOS=N.Vf;N.iOS=N.Fc;N.linux=N.qg;N.macOS=N.tg;N.windows=N.Ug;N.ie=N.jd;N.edge=N.ae;N.firefox=N.cg;N.opera=N.opera;N.safari=N.Cg;N.chrome=N.chrome;N.browser=N.mb;N.browserVersion=N.$a;N.edgeVersion=N.tj;N.chromeVersion=N.Wf;N.firefoxVersion=N.xj;N.silk=N.Hg;N.ieVersion=N.lg;N.operaVersion=N.te;N.safariVersion=N.sk;N.isAndroidStockBrowser=N.ak;
N.androidStockBrowserVersion=N.gj;N.webApp=N.Ek;N.quirksMode=N.pk;N.pixelRatio=N.nc;N.iPhone=N.Xj;N.iPod=N.Yj;N.iPad=N.kg;N.retina=N.rk;N.desktop=N.Dc;N.mobile=N.qe;N.tablet=N.Jg;N.other=N.kk;N.oggVideo=N.yg;N.h264Video=N.gg;N.mp4Video=N.wg;N.webmVideo=N.Tg;N.vp9Video=N.Ng;N.hlsVideo=N.jg;N.audioTag=N.Rf;N.webAudio=N.Pg;N.ogg=N.xg;N.mp3=N.ug;N.opus=N.ue;N.wav=N.Og;N.aac=N.Pf;N.m4a=N.sg;N.mp4=N.vg;N.webm=N.Sg;N.weba=N.Rg;N.vibrate=N.Kg;N.battery=N.Uf;N.canvas=N.canvas;N.canvasText=N.kj;
N.canvasWinding=N.lj;N.localStorage=N.localStorage;N.mediaSource=N.hk;N.encryptedMedia=N.uj;N.applicationCache=N.applicationCache;N.addEventListener=N.addEventListener;N.raf=N.po;N.webGL=N.Qg;N.webVR=N.Ee;N.geolocation=N.geolocation;N.history=N.history;N.svg=N.wk;N.contextMenu=N.contextMenu;N.isSecure=N.ck;N.isIframe=N.ng;N.touch=N.yk;N.touchForce=N.zk;N.gamepad=N.Dj;N.requestFullscreen=N.requestFullscreen;N.exitFullscreen=N.exitFullscreen;N.fullscreenKeyboard=N.Bj;N.fullscreenElement=N.fullscreenElement;
N.fullscreenEnabled=N.fullscreenEnabled;N.visibilityState=N.visibilityState;N.visibilityChange=N.Lg;N.orientation=N.orientation;N.screenOrientation=N.tk;N.lockOrientation=N.ek;N.unlockOrientation=N.Ak;N.file=N.file;N.fileSystem=N.wj;N.pointerLock=N.nk;N.cssPointerEvents=N.dd;N.cssRgba=N.qj;N.cssAnimation=N.pj;N.css3D=N.oj;N.deviceMotionRotationRate=N.Zf;N.deviceMotionAcceleration=N.Yf;N.deviceOrientationMagnetometer=N.ag;N.deviceMotion=N.Xf;N.deviceOrientation=N.$f;N.dpi=N.sj;N.screenWidth=N.Eg;
N.screenHeight=N.Dg;N.ua=N.aa;N.language=N.language;N.gyroscope=N.Qj;N.ready=N.ready;p.generate=p.dg;p.validate=p.Dk;p.register=p.register;p.unregister=p.unregister;p.getUids=p.fg;p.filterType=p.ce;p.get=p.get;p.isTypeOf=p.T;p.exists=p.Va;ca.register=ca.register;ca.getUids=ca.fg;ca.get=ca.get;ca.hasTypeOf=ca.In;ca.exists=ca.Va;window.FORGE.VIEWERS=aa;window.FORGE.VERSION="0.9.0";window.FORGE.DEBUG=!1;window.FORGE.WARNING=!1;r.DEFAULT_CONFIG=fa;window.FORGE.Math=G;G.DEGREES=G.Na;G.RADIANS=G.nb;
G.DEG2RAD=G.ai;G.RAD2DEG=G.li;G.TWOPI=G.ri;window.FORGE.MediaType=Ja;Ja.IMAGE=Ja.IMAGE;Ja.VIDEO=Ja.VIDEO;window.FORGE.MediaFormat=Ka;Ka.EQUIRECTANGULAR=Ka.Pc;Ka.CUBE=Ka.xd;Ka.FLAT=Ka.ci;Ka.HOTSPOT=Ka.El;window.FORGE.BackgroundType=Oa;Oa.UNDEFINED=Oa.Tc;Oa.SHADER=Oa.Gd;Oa.MESH=Oa.Sc;window.FORGE.EffectComposerType=cb;cb.MAIN=cb.fi;cb.RENDER=cb.Sb;cb.PICKING=cb.sf;window.FORGE.PassPosition=eb;eb.UNKNOWN=eb.Kd;eb.BACKGROUND=eb.ud;eb.RENDER=eb.Sb;eb.GLOBAL=eb.df;window.FORGE.ViewType=Na;
Na.UNDEFINED=Na.Tc;Na.RECTILINEAR=Na.ob;Na.GOPRO=Na.gc;window.FORGE.PickingManager.modes=Wa;Wa.POINTER=Wa.Za;Wa.GAZE=Wa.vc;window.FORGE.HotspotMaterial.types=bc;bc.IMAGE=bc.IMAGE;bc.PLUGIN=bc.ki;bc.GRAPHICS=bc.Cd;window.FORGE.HotspotMaterial.presets=Zb;Zb.TRANSPARENT=Zb.pi;Zb.DEBUG=Zb.$h;window.FORGE.HotspotGeometryType=cc;cc.PLANE=cc.ji;cc.BOX=cc.Yh;cc.SPHERE=cc.mi;cc.CYLINDER=cc.Zh;window.FORGE.HotspotType=Tb;Tb.THREE_DIMENSIONAL=Tb.Ef;L.RADIUS=50;L.DEFAULT_CONFIG=kc;
window.FORGE.ControllerType=Bc;Bc.POINTER=Bc.Za;Bc.KEYBOARD=Bc.jf;oa.DEFAULT_CONFIG=Cc;window.FORGE.SoundType=Ga;Ga.STEREO=Ga.Jl;Ga.SPATIAL=Ga.Il;Ga.AMBISONIC=Ga.$e;window.FORGE.Action.operation=ad;ad.SET=ad.Bf;ad.ADD=ad.Xh;ad.SUBSTRACT=ad.ni;ad.MULTIPLY=ad.gi;ad.DIVIDE=ad.bi;ad.TOGGLE=ad.oi;window.FORGE.Pointer.listenerTypes=V;V.NATIVE=V.Ra;V.HAMMER=V.ka;window.FORGE.Pointer.events=U.events;U.events.TAP=U.events.Df;U.events.DOUBLE_TAP=U.events.Bd;U.events.PRESS_START=U.events.xf;
U.events.PRESS_END=U.events.wf;U.events.PAN_START=U.events.rf;U.events.PAN_MOVE=U.events.qf;U.events.PAN_END=U.events.pf;U.events.PINCH_START=U.events.vf;U.events.PINCH_MOVE=U.events.uf;U.events.PINCH_END=U.events.tf;U.events.ROTATE_START=U.events.Af;U.events.ROTATE_MOVE=U.events.zf;U.events.ROTATE_END=U.events.yf;U.events.SWIPE=U.events.Cf;U.events.ENTER=U.events.cf;U.events.LEAVE=U.events.kf;U.events.OVER=U.events.nf;U.events.OUT=U.events.mf;U.events.MOVE=U.events.lf;U.events.WHEEL=U.events.Ff;
window.FORGE.Pointer.cursors=Ed;Ed.DEFAULT=Ed.DEFAULT;Ed.POINTER=Ed.Za;Ed.GRAB=Ed.Cl;Ed.GRABBING=Ed.Dl;window.FORGE.Image.renderModes=Qd;Qd.CSS=Qd.CSS;Qd.CANVAS=Qd.Jb;ge.EMPTY_STATE_IMAGE=ie;ge.EMPTY_STATE_LABEL=je;ge.EMPTY_STATE=ke;ge.DEFAULT_STATE_IMAGE=le;ge.DEFAULT_STATE_LABEL=me;ge.DEFAULT_STATE=he;window.FORGE.VideoDash.mediaType=Ee;Ee.VIDEO=Ee.VIDEO;Ee.AUDIO=Ee.AUDIO;window.FORGE.VideoQualityMode=ne;ne.AUTO=ne.Hb;ne.MANUAL=ne.MANUAL;window.FORGE.VideoFormat=Ma;Ma.DASH=Ma.af;Ma.HTML5=Ma.Fl;
