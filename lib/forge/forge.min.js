...
e.pn=function(a){if(this.c)for(var b=0,d=this.c.passes.length;b<d;b++){var g=this.c.passes[b];if(g.uid===a)return g}if(this.f)for(b=0,d=this.f.length;b<d;b++)for(var g=this.f[b],h=0,k=g.passes.length;h<k;h++){var p=g.passes[h];if(p.uid===a)return p}return null};
...
function sb(a){function b(a,b,h,Cc,fc){if(-1===a)throw"Unknown face for cube mapping.";var E,zb=a%b/b;a=1-(1+parseInt(a/b,10))/h;if(fc)for(fc=0,h=Cc;fc<=h;fc++)for(b=0,E=Cc;b<=E;b++)d[g.next().value]=v+k*b+zb,d[g.next().value]=x+p*fc+a;else for(fc=0,h=Cc;fc<=h;h--)for(b=0,E=Cc;b<=E;E--)d[g.next().value]=v+k*E+zb,d[g.next().value]=x+p*h+a}var d=new Float32Array((a.o+1)*(a.o+1)*12),g=d.keys(),h=a.I.split(""),k=1/1.01*(1/a.m.x/a.o),p=1/1.01*(1/a.m.y/a.o),v=1/a.m.x*.005,x=1/a.m.y*.005;b(h.indexOf("R"),
...
p,v,x=0;for(g=0;g<h;g++){p=Cb(this.Ia.prop[g],this.B.data);v=Cb(this.Ia.prop[g],this.u.data);d=b[g];p=p[0][p[1]];v=v[0][v[1]];if(this.Ia.Ta&&this.Ia.Ta[g]){var E=this.Ia.Ta[g][0],zb=this.Ia.Ta[g][1],x=Math.abs(E-zb)/2;Math.abs(p-v)>x?(p=G.Ta(p+x,E,zb),v=G.Ta(v+x,E,zb)):x=0}d[0][d[1]]=(1-k)*p+k*v-x}}"function"===typeof this.Ia.mj&&this.Ia.mj.call(this,a)}this.F&&this.F.D({progress:this.G/this.I})};e.Im=function(){Db(this)||this.A&&this.A.D()};
...
Object.defineProperty(Jb.prototype,"ready",{get:function(){return this.R}});Object.defineProperty(Jb.prototype,"onClick",{get:function(){this.H||(this.H=new q(this));return this.H}});Object.defineProperty(Jb.prototype,"onOver",{get:function(){this.C||(this.C=new q(this));return this.C}});Object.defineProperty(Jb.prototype,"onOut",{get:function(){this.A||(this.A=new q(this));return this.A}});Object.defineProperty(Jb.prototype,"onReady",{get:function(){this.F||(this.F=new q(this));return this.F}});
...
function Pb(a,b,d){var g=a.i.renderer.canvasResolution;d=d||{x:g.width/2,y:g.height/2};var h=a.i.renderer.camera,k=(new THREE.Vector2(d.x/g.width,1-d.y/g.height)).multiplyScalar(2).addScalar(-1),g=a.i.renderer.objects.sj();d=0;for(var p=g.length;d<p;d++)g[d].hovered=!1;d=null;a.f.setFromCamera(k,h.main);h=[];k=0;for(p=g.length;k<p;k++)h.push(g[k].mesh);for(g=a.f.intersectObjects(h);null===d&&0<g.length;){var h=g.shift(),k=h.object,v=h.uv,h=a.i.renderer.objects.pj(k);if(!1===k.material.transparent)d=
...
Object.defineProperty(ac.prototype,"sound",{get:function(){return this.c}});Object.defineProperty(ac.prototype,"onReady",{get:function(){this.f||(this.f=new q(this));return this.f}});function Zb(a){this.i=a;this.o=null;this.m="";this.f=this.c=null;this.C=1;this.u=!1;this.A=16777215;this.L=null;this.F=!1;this.j=null;l.call(this,"HotspotMaterial")}Zb.prototype=Object.create(l.prototype);Zb.prototype.constructor=Zb;
...
b,a.keyframes,"phi",a.easing,"position"),b=new yb(b+d,{position:{radius:k,theta:p,phi:h}}),g.timeline.xb(b));if(0<g.timeline.keyframes.length&&0<g.timeline.keyframes[0].time||0<d)v={position:B.clone(this.oa.position)},b=new yb(0,v),g.timeline.xb(b);this.c.push(g);this.c[0].play();this.c[1].play()};Object.defineProperty(Yb.prototype,"autoPlay",{get:function(){return this.F}});Object.defineProperty(Yb.prototype,"onProgress",{get:function(){this.m||(this.m=new q(this));return this.m}});
...
function lc(a,b){var d=Math.tan(G.da(a.upDegrees)),g=Math.tan(G.da(a.downDegrees)),h=Math.tan(G.da(a.leftDegrees)),k=Math.tan(G.da(a.rightDegrees));a=2/(h+k);var h=(h-k)*a*.5,k=2/(d+g),d=(d-g)*k*.5,g=new THREE.Matrix4,p=g.elements;p[0]=a;p[1]=0;p[2]=-h;p[3]=0;p[4]=0;p[5]=k;p[6]=d;p[7]=0;p[8]=0;p[9]=0;p[10]=b.far/(b.near-b.far);p[11]=b.far*b.near/(b.near-b.far);p[12]=0;p[13]=0;p[14]=-1;p[15]=0;g.transpose();return g}
...
typeof window.HTMLMenuItemElement};a.prototype.Gl=function(){this.Nj=/^https/i.test(window.location.protocol);try{this.$f=window.self!==window.top}catch(b){this.$f=!0}};a.prototype.Kl=function(){this.hk="undefined"!==typeof window.ontouchstart||"undefined"!==typeof window.c&&document instanceof window.c||"number"===typeof navigator.c&&0<navigator.c||"number"===typeof navigator.msMaxTouchPoints&&0<navigator.msMaxTouchPoints;if("undefined"!==typeof window.j||"undefined"!==typeof window.m)this.ik=!(!MouseEvent.f||
!MouseEvent.c);this.nj="function"===typeof navigator.f||"function"===typeof navigator.A};a.prototype.Il=function(){for(var a="requestFullscreen requestFullScreen webkitRequestFullscreen webkitRequestFullScreen mozRequestFullScreen mozRequestFullscreen msRequestFullscreen msRequestFullScreen".split(" "),d="cancelFullscreen cancelFullScreen exitFullscreen exitFullScreen webkitCancelFullscreen webkitCancelFullScreen webkitExitFullscreen webkitExitFullScreen mozCancelFullscreen mozCancelFullScreen mozExitFullscreen mozExitFullScreen msCancelFullscreen msCancelFullScreen msExitFullscreen msExitFullScreen".split(" "),
...
e.ha=function(a){this.u="boolean"===typeof a.enabled?a.enabled:!0;"undefined"!==typeof a.auto&&!0===a.auto&&""!==N.language?this.o=N.language:"string"===typeof a["default"]&&(this.o=a["default"]);if(!1===this.u)this.warn("$_LocaleManager: locale management is deactivated");else if("undefined"!==typeof a.locales){for(var b=!1,d=0,g=a.locales.length;d<g;d++){var h;h=a.locales[d];var k,p=sd(this,h.uid);-1===p?(k=new td(this.i),k.f.add(this.cm,this),p=this.c.add(k)-1):k=this.c.get(p);k.ha(h);p===this.f||
this.o.toLowerCase()===h.uid.toLowerCase()?(k.dg(),-1===this.f&&ud(this,p),h=!0):h=!1;!0===h&&(b=!0)}!1===b&&(-1===sd(this,this.o)&&(this.o=a.locales[0].uid),ud(this,sd(this,a.locales[0].uid)))}};function sd(a,b){for(var d,g=0,h=a.c.size;g<h;g++)if(d=a.c.get(g),d.uid.toLowerCase()===b.toLowerCase())return g;return-1}
...
function td(a){this.i=a;this.m="";this.f=this.j=this.c=null;l.call(this,"Locale");this.c=new kd;this.j=new q(this);this.f=new q(this)}td.prototype=Object.create(l.prototype);e=td.prototype;e.constructor=td;
...
e.Zl=function(a){if(!1!==this.j){var b=a.keyCode;this.log("keyUp "+b);b=this.f.indexOf(b);-1!==b?(this.f.splice(b,1),b=!0):b=!1;if(!0===b)a:if(b=a.keyCode,!0!==this.ag(b))for(var b=this.Rf(b),d,g=0,h=b.length;g<h;g++){d=b[g];for(var k=0,p=this.f.length;k<p;k++)if(d.Yd(this.f[k]))break a;d.kk(a);k=0;for(p=this.f.length;k<p;k++)if(d.Uf(this.f[k])){var v=new KeyboardEvent("keydown",{jo:this.f[k],ctrlKey:a.ctrlKey,shiftKey:a.shiftKey,altKey:a.altKey});xd(this,v)}}}};
...
Object.defineProperty(V.prototype,"onDisable",{get:function(){this.ba||(this.ba=new q(this));return this.ba}});Object.defineProperty(V.prototype,"onTap",{get:function(){this.M||(this.M=new q(this.L),this.M.onDestroy.ca(Ed(V.events.pf,this.Hi,W.ja),this),Dd(this,V.events.pf,this.Hi,W.ja));return this.M}});Object.defineProperty(V.prototype,"onClick",{get:function(){return this.onTap}});
Object.defineProperty(V.prototype,"onDoubleTap",{get:function(){this.o||(this.o=new q(this.L),this.o.onDestroy.ca(Ed(V.events.ud,this.ei,W.ja),this),Dd(this,V.events.ud,this.ei,W.ja));return this.o}});Object.defineProperty(V.prototype,"onDoubleClick",{get:function(){return this.onDoubleTap}});Object.defineProperty(V.prototype,"onPressStart",{get:function(){this.J||(this.J=new q(this.L),this.J.onDestroy.ca(Ed(V.events.hf,this.sh,W.ja),this),Dd(this,V.events.hf,this.sh,W.ja));return this.J}});
Object.defineProperty(V.prototype,"onDown",{get:function(){return this.onPressStart}});Object.defineProperty(V.prototype,"onPressEnd",{get:function(){this.I||(this.I=new q(this.L),this.I.onDestroy.ca(Ed(V.events.gf,this.rh,W.ja),this),Dd(this,V.events.gf,this.rh,W.ja));return this.I}});Object.defineProperty(V.prototype,"onUp",{get:function(){return this.onPressEnd}});
Object.defineProperty(V.prototype,"onPanStart",{get:function(){this.H||(this.H=new q(this.L),this.H.onDestroy.ca(Ed(V.events.bf,this.nh,W.ja),this),Dd(this,V.events.bf,this.nh,W.ja));return this.H}});Object.defineProperty(V.prototype,"onPanMove",{get:function(){this.F||(this.F=new q(this.L),this.F.onDestroy.ca(Ed(V.events.af,this.mh,W.ja),this),Dd(this,V.events.af,this.mh,W.ja));return this.F}});
Object.defineProperty(V.prototype,"onPanEnd",{get:function(){this.C||(this.C=new q(this.L),this.C.onDestroy.ca(Ed(V.events.$e,this.lh,W.ja),this),Dd(this,V.events.$e,this.lh,W.ja));return this.C}});Object.defineProperty(V.prototype,"onPinchStart",{get:function(){this.K||(this.K=new q(this.L),this.K.onDestroy.ca(Ed(V.events.ff,this.qh,W.ja),this),Dd(this,V.events.ff,this.qh,W.ja));return this.K}});
Object.defineProperty(V.prototype,"onPinchMove",{get:function(){this.G||(this.G=new q(this.L),this.G.onDestroy.ca(Ed(V.events.ef,this.ph,W.ja),this),Dd(this,V.events.ef,this.ph,W.ja));return this.G}});Object.defineProperty(V.prototype,"onPinchEnd",{get:function(){this.B||(this.B=new q(this.L),this.B.onDestroy.ca(Ed(V.events.df,this.oh,W.ja),this),Dd(this,V.events.df,this.oh,W.ja));return this.B}});
Object.defineProperty(V.prototype,"onRotateStart",{get:function(){this.U||(this.U=new q(this.L),this.U.onDestroy.ca(Ed(V.events.lf,this.Bi,W.ja),this),Dd(this,V.events.lf,this.Bi,W.ja));return this.U}});Object.defineProperty(V.prototype,"onRotateMove",{get:function(){this.R||(this.R=new q(this.L),this.R.onDestroy.ca(Ed(V.events.kf,this.Ai,W.ja),this),Dd(this,V.events.kf,this.Ai,W.ja));return this.R}});
Object.defineProperty(V.prototype,"onRotateEnd",{get:function(){this.N||(this.N=new q(this.L),this.N.onDestroy.ca(Ed(V.events.jf,this.zi,W.ja),this),Dd(this,V.events.jf,this.zi,W.ja));return this.N}});Object.defineProperty(V.prototype,"onSwipe",{get:function(){this.V||(this.V=new q(this.L),this.V.onDestroy.ca(Ed(V.events.nf,this.Fi,W.ja),this),Dd(this,V.events.nf,this.Fi,W.ja));return this.V}});
Object.defineProperty(V.prototype,"onEnter",{get:function(){this.u||(this.u=new q(this.L),this.u.onDestroy.ca(Ed(V.events.Pe,this.hi,W.Ra),this),Dd(this,V.events.Pe,this.hi,W.Ra));return this.u}});Object.defineProperty(V.prototype,"onLeave",{get:function(){this.A||(this.A=new q(this.L),this.A.onDestroy.ca(Ed(V.events.We,this.ji,W.Ra),this),Dd(this,V.events.We,this.ji,W.Ra));return this.A}});
Object.defineProperty(V.prototype,"onOver",{get:function(){this.m||(this.m=new q(this.L),this.m.onDestroy.ca(Ed(V.events.Ze,this.ti,W.Ra),this),Dd(this,V.events.Ze,this.ti,W.Ra));return this.m}});Object.defineProperty(V.prototype,"onOut",{get:function(){this.j||(this.j=new q(this.L),this.j.onDestroy.ca(Ed(V.events.Ye,this.si,W.Ra),this),Dd(this,V.events.Ye,this.si,W.Ra));return this.j}});
Object.defineProperty(V.prototype,"onMove",{get:function(){this.f||(this.f=new q(this.L),this.f.onDestroy.ca(Ed(V.events.Xe,this.mi,W.Ra),this),Dd(this,V.events.Xe,this.mi,W.Ra));return this.f}});Object.defineProperty(V.prototype,"onWheel",{get:function(){this.P||(this.P=new q(this.L),this.P.onDestroy.ca(Ed(V.events.rf,this.th,W.Ra),this),Dd(this,V.events.rf,this.th,W.Ra));return this.P}});var W={Ra:0,ja:1};V.events={};V.events.pf="tap";V.events.ud="doubletap";V.events.hf="press";V.events.gf="pressup";
...
Object.defineProperty(Td.prototype,"onLoadStart",{get:function(){this.I||(this.I=new q(this));return this.I}});Object.defineProperty(Td.prototype,"onLoadComplete",{get:function(){this.G||(this.G=new q(this));return this.G}});
...
this.rb=this.el.bind(this);this.La=this.km.bind(this);this.pc=this.Em.bind(this);this.Fb=this.qm.bind(this);this.cc=this.tm.bind(this);this.ac=this.sm.bind(this);this.Ue=this.Fm.bind(this);this.Bb=this.pm.bind(this);this.i.audio.onVolumeChange.add(this.Gh,this);this.i.audio.onDisable.add(this.Fh,this);this.B=new q(this,!0);null!==this.Oc&&this.load(this.Oc);this.i.display.register(this);Gd(this);Hd(this)};
...
function De(a,b,d,g){if(d&&g){var h=a.Xa.index,k,p,v,x,E,zb;(k=g.getCurrentRepresentationSwitch(d))&&(p=Math.round(g.getBandwidthForRepresentation(k.to,h)/1E3));if(isNaN(p)||void 0===p)p=0;b===Be.VIDEO?(v=a.Pa+1,x=a.Ha+1):b===Be.AUDIO&&(v=a.Re+1,x=a.Se+1);if(isNaN(v)||void 0===v)v=0;if(isNaN(x)||void 0===x)x=0;a=g.getMaxIndexForBufferType(b,h);if(isNaN(a)||void 0===a)a=0;b=g.getCurrentBufferLevel(d);null!==b&&(E=b.toPrecision(5));if(isNaN(E)||void 0===E)E=0;if(d=g.getCurrentDroppedFrames(d))zb=d.droppedFrames;
return{bitrate:p,index:v,Xj:x,Rj:a,Ui:E,droppedFrames:zb}}return null}e.sm=function(a){this.log("onQualityChange [readyState: "+this.j.element.readyState+"]");a.mediaType===Be.AUDIO?this.Se=this.Re=a.newQuality:a.mediaType===Be.VIDEO&&(this.Ha=this.Pa=a.newQuality,this.ka&&this.ka.D(this.Ha))};
...
function wa(a){this.i=a;l.call(this,"Loader")}wa.prototype=Object.create(l.prototype);e=wa.prototype;e.constructor=wa;e.json=function(a,b,d,g,h,k){var p=new Oe;p.type="json";p.key=a;p.url=b;p.c=d;p.f=g;p.O=h;p.j=k;Pe(this,p,"text",this.Wl,this.Xl)};
...
e.rg=function(a,b,d){for(var g=document.getElementsByTagName("head")[0],h=g.getElementsByTagName("script"),k=0,p=h.length;k<p;k++)if(h[k].src===a){this.warn("Attempt to load an already loaded script!");b.call(d);return}var v=document.createElement("script");v.type="text/javascript";v.onload=function(){v.onload=null;b.call(d)};v.src=a;g.appendChild(v)};
...
var Z={Jn:function(a,b,d){a/=255;b/=255;d/=255;var g=Math.max(a,b,d),h=Math.min(a,b,d),k,p=(g+h)/2;if(g===h)k=h=0;else{var v=g-h,h=.5<p?v/(2-g-h):v/(g+h);switch(g){case a:k=(b-d)/v+(b<d?6:0);break;case b:k=(d-a)/v+2;break;case d:k=(a-b)/v+4}k/=6}return{h:k,s:h,l:p}},xn:function(a,b,d){if(b){var g=.5>d?d*(1+b):d+b-d*b,h=2*d-g;d=Z.Zd(h,g,a+1/3);b=Z.Zd(h,g,a);a=Z.Zd(h,g,a-1/3)}else d=b=a=d;return{r:255*d,g:255*b,b:255*a}},Zd:function(a,b,d){if(!(0>d||1<d)){if(d<1/6)return a+6*(b-a)*d;if(.5>d)return b;
if(d<2/3)return a+(b-a)*(2/3-d)*6}return a},Kn:function(a,b,d){a/=255;b/=255;d/=255;var g=Math.max(a,b,d),h=Math.min(a,b,d),k,p=g-h;if(g===h)k=0;else{switch(g){case a:k=(b-d)/p+(b<d?6:0);break;case b:k=(d-a)/p+2;break;case d:k=(a-b)/p+4}k/=6}return{h:k,s:g?p/g:0,v:g}},yn:function(a,b,d){var g,h,k,p=Math.floor(6*a),v=6*a-p;a=d*(1-b);var x=d*(1-v*b);b=d*(1-(1-v)*b);switch(p%6){case 0:g=d;h=b;k=a;break;case 1:g=x;h=d;k=a;break;case 2:g=a;h=d;k=b;break;case 3:g=a;h=x;k=d;break;case 4:g=b;h=a;k=d;break;
...
window.FORGE.ActionManager=ra;window.FORGE.Plugin=R;window.FORGE.PluginEngine=dd;window.FORGE.PluginManager=pa;window.FORGE.PluginObjectFactory=S;window.FORGE.Device=N;window.FORGE.RequestAnimationFrame=la;window.FORGE.History=na;window.FORGE.EventDispatcher=q;window.FORGE.Event=rd;window.FORGE.Listener=pd;window.FORGE.LocaleManager=ma;window.FORGE.LocaleString=za;window.FORGE.Locale=td;window.FORGE.Keyboard=ua;window.FORGE.KeyBinding=P;window.FORGE.Drag=zd;window.FORGE.Pointer=V;
...
S.prototype.button=S.prototype.Tk;S.prototype.video=S.prototype.Wk;S.prototype.canvas=S.prototype.canvas;S.prototype.tween=S.prototype.Vk;S.prototype.destroyAllObjects=S.prototype.bj;S.prototype.destroy=S.prototype.destroy;la.prototype.boot=la.prototype.boot;la.prototype.start=la.prototype.start;la.prototype.stop=la.prototype.stop;la.prototype.destroy=la.prototype.destroy;na.prototype.addConfig=na.prototype.ha;na.prototype.destroy=na.prototype.destroy;q.prototype.add=q.prototype.add;
q.prototype.addOnce=q.prototype.ca;q.prototype.remove=q.prototype.remove;q.prototype.has=q.prototype.has;q.prototype.dispatch=q.prototype.D;q.prototype.destroy=q.prototype.destroy;pd.prototype.execute=pd.prototype.yb;pd.prototype.detach=pd.prototype.bh;pd.prototype.destroy=pd.prototype.destroy;ma.prototype.addConfig=ma.prototype.ha;ma.prototype.getValue=ma.prototype.Xb;ma.prototype.hasValue=ma.prototype.vb;ma.prototype.destroy=ma.prototype.destroy;za.prototype.destroy=za.prototype.destroy;
